...
from scale_egp.sdk.enums import EmbeddingModelName, ChunkUploadStatus
...
class KnowledgeBaseUploadsCollection(APIEngine):
    ...
    def create_remote_upload(
        ...
        data_source_config: Union[
            S3DataSourceConfig, SharePointDataSourceConfig, GoogleDriveDataSourceConfig
        ],
        data_source_auth_config: Optional[Union[SharePointDataSourceAuthConfig]],
