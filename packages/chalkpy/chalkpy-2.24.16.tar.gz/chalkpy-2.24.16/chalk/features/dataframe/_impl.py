...
class DataFrame(metaclass=DataFrameMeta):
    ...
    #######################
    @overload
    def __getitem__(self, item: bool) -> DataFrame:
        # Must overload bool first, so it doesn't go to the `int` overload
        # bool is likely a filter that would be parsed with the ast parser
        ...
