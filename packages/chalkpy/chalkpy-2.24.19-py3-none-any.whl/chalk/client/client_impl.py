...
from chalk.client.serialization.query_serialization import MULTI_QUERY_MAGIC_STR, _write_query_to_buffer
...
def _to_offline_query_input(
    ...
    if isinstance(input, pd.DataFrame):
        ...
        pd_dataframe = pd.DataFrame(input)  # type: ignore -- pd.DataFrame is graceful for a constructor
