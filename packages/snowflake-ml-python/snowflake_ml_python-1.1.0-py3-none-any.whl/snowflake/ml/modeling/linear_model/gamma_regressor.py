...
class GammaRegressor(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._handlers: FitPredictHandlers = HandlersImpl(class_name=GammaRegressor.__class__.__name__, subproject=_SUBPROJECT, autogenerated=True, wrapper_provider=SklearnWrapperProvider())
