...
class UserContext:
    ...
    def _initialize(self, user_identifier: str = None, password: str = None, user_JWT: str = None):
        ...
        # Populate the private data members with data we receieved from Authentication Local REST-API https://github.com/circles-zone/authentication-local-restapi-typescript-serverless-com/edit/dev/auth-restapi-serverless-com/src/services/auth-service/auth-service-impl.ts
        ...
        if UserContext._instance is None:
            ...
            if password is None:
                try:
                    ...
                    MiniLogger.error(
                        "Exception missing PRODUCT_PASSWORD in .env file - ERROE -" + str(e))
