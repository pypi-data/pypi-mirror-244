...
class PolicyObjectDto(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'insured_object_id': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
    ...
    def _from_openapi_data(cls, insured_object_id, data, *args, **kwargs):  # noqa: E501
        ...
        Args:
            insured_object_id ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Unique identifier referencing the insured object.
        ...
        Keyword Args:
            ...
            insured_object_name ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Insured object name. Human readable identifier of insured object.        Can be used instead of insuredObjectId. [optional]  # noqa: E501
