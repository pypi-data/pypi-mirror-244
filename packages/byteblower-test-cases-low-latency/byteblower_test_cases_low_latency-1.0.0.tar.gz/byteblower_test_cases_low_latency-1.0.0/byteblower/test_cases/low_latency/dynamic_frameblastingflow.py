...
from typing import Optional, Sequence, Union  # for type hinting

from byteblower_test_framework._endpoint.port import Port  # for type hinting
...
class DynamicRateFrameBlastingFlow(BaseDynamicRateFrameBlastingFlow):
    ...
    def apply(
        self, maximum_run_time: Optional[timedelta] = None, **kwargs
    ) -> None:
