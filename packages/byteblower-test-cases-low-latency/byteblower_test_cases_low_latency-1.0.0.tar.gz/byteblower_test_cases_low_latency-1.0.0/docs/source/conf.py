...
project = 'ByteBlower Low-Latency Test Case'
copyright = f'{date.today().year!s}, Excentis NV'
author = 'Excentis NV'

# The full version, including alpha/beta/rc tags
release = metadata.version('byteblower-test-cases-low-latency')
