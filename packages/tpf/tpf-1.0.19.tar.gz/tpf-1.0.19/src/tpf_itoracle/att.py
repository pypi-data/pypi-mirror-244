...
class MultiHead(nn.Module):
    ...
    def __init__(self, in_features=32, out_features=32):
        ...
        #
        self.norm = nn.LayerNorm(normalized_shape=out_features, elementwise_affine=True)
    ...
    def attention(self, Q, K, V, mask):
        ...
        # print("socre 183:",Q.shape,K.shape)  
    ...
    def forward(self, Q, K, V, mask, head_n1=4):
