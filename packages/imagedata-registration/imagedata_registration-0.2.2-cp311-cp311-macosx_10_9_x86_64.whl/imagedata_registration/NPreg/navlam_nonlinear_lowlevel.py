...
# pythran export navlam_nonlinear_lowlevel(float64[,,], float64[,,], float64[,,], float64[,,], float64[,,], float64[,,], int, float64[3], int, float64, float64, float64)
def navlam_nonlinear_lowlevel(forceu0, forceu1, forceu2, u0, u1, u2, maxniter, h, nudim, llambda, mu, dt):
    """
