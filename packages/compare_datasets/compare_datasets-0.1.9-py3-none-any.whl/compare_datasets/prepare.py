...
class PrepareForComparison:
    ...
    def __init__( self, tested: pl.DataFrame, expected: pl.DataFrame, key=None, tolerance: float = 10e-6, verbose: bool = False, progress_bar=None, low_memory=False, case_sensitive_columns=False) -> None:
