...
def _make_dynamodb_json_dataframe(
    ...
    df = df_to_online_store_msg(df, fd.id, is_batch=True, is_status=False, canary_id=None)
...
def _materialize_batch_to_online(
    ...
    if batch_params.create_online_table:
        ...
        dynamo_import_row_count = _write_dynamodb_json(spark, fd, materialization_task_params, online_store_df)
