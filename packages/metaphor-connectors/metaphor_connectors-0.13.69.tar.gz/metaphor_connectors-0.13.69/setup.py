...
['PyYAML>=6.0,<7.0',
 ...
 'metaphor-models==0.30.6',
 'pathvalidate>=3.2.0,<4.0.0',
 'pyarrow[pandas]>=10.0.1,<11.0.0',
...
{':extra == "all" or extra == "looker"': ['GitPython>=3.1.37,<4.0.0'],
 ...
 'datafactory': ['azure-identity>=1.14.0,<2.0.0',
                 'azure-mgmt-datafactory>=3.1.0,<4.0.0'],
 'kafka': ['confluent-kafka>=2.3.0,<3.0.0'],
 ...
 'power-bi': ['msal>=1.20.0,<2.0.0',
              'msgraph-beta-sdk==1.0.0',
              'sql-metadata>=2.8.0,<3.0.0'],
 'redshift': ['asyncpg>=0.27.0,<0.28.0', 'sqllineage>=1.3.8,<1.4.0'],
 ...
 'unity-catalog': ['databricks-sdk>=0.12.0,<0.13.0',
                   'databricks-sql-connector>=2.9.3,<3.0.0']}
