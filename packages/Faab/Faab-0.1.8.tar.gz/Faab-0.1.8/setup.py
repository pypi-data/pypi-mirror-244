...
# Package meta-data.
NAME = 'Faab'
DESCRIPTION = ('This tool has the capability to automatically generate API endpoints based on the provided data model '
               'or database schema, encompassing operations such as creation, retrieval, updating, and deletion ('
