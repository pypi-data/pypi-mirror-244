...
class FlightService(object):
    ...
    def Handshake(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/arrow.flight.protocol.FlightService/Handshake',
    ...
    def ListFlights(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/arrow.flight.protocol.FlightService/ListFlights',
    ...
    def GetFlightInfo(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/arrow.flight.protocol.FlightService/GetFlightInfo',
    ...
    def PollFlightInfo(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/arrow.flight.protocol.FlightService/PollFlightInfo',
            Flight__pb2.FlightDescriptor.SerializeToString,
    ...
    def GetSchema(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/arrow.flight.protocol.FlightService/GetSchema',
            Flight__pb2.FlightDescriptor.SerializeToString,
    ...
    def DoGet(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/arrow.flight.protocol.FlightService/DoGet',
    ...
    def DoPut(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/arrow.flight.protocol.FlightService/DoPut',
    ...
    def DoExchange(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/arrow.flight.protocol.FlightService/DoExchange',
            Flight__pb2.FlightData.SerializeToString,
            Flight__pb2.FlightData.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def DoAction(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/arrow.flight.protocol.FlightService/DoAction',
    ...
    def ListActions(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/arrow.flight.protocol.FlightService/ListActions',
