...
class ActionGroup:
    def __init__(
        ...
        *,
        ...
        desription: typing.Optional[builtins.str] = None,
    ) -> None:
        '''
        ...
        :param desription: Optional. Description for the action group.
        '''
        if __debug__:
            ...
            check_type(argname="argument desription", value=desription, expected_type=type_hints["desription"])
        ...
        if desription is not None:
            self._values["desription"] = desription
    ...
    @builtins.property
    def desription(self) -> typing.Optional[builtins.str]:
        '''Optional.

        Description for the action group.
        '''
        result = self._values.get("desription")
...
class BaseFieldMapping:
    def __init__(
        ...
        *,
        ...
        '''
        :param metadata_field: Required. Metadata field that you configured in your Vector DB. Bedrock will store metadata that is required to carry out souce attribution and enable data ingestion and querying for OpenSearch and Pinecone and will store raw text from your data in chunks in this field for Redis Enterprise Cloud.
...
class BedrockAgent(
    ...
    def action_groups(self) -> typing.List[ActionGroup]:
        return typing.cast(typing.List[ActionGroup], jsii.get(self, "actionGroups"))
    ...
    @builtins.property
    @jsii.member(jsii_name="bedrockAgentCustomResourceRole")
    def bedrock_agent_custom_resource_role(self) -> _aws_cdk_aws_iam_ceddda9d.Role:
        return typing.cast(_aws_cdk_aws_iam_ceddda9d.Role, jsii.get(self, "bedrockAgentCustomResourceRole"))
    ...
    @builtins.property
    @jsii.member(jsii_name="knowledgeBaseAssociations")
    def knowledge_base_associations(self) -> typing.List["KnowledgeBaseAssociation"]:
        return typing.cast(typing.List["KnowledgeBaseAssociation"], jsii.get(self, "knowledgeBaseAssociations"))
...
class BedrockKnowledgeBase(
    ...
    def __init__(
        ...
        *,
        ...
        storage_configuration: typing.Union[typing.Union["OpenSearchServerlessStorageConfiguration", typing.Dict[builtins.str, typing.Any]], typing.Union["RedisEnterpriseCloudStorageConfiguration", typing.Dict[builtins.str, typing.Any]], typing.Union["PineconeStorageConfiguration", typing.Dict[builtins.str, typing.Any]]],
        description: typing.Optional[builtins.str] = None,
        ...
        :param storage_configuration: Required. KnowledgeBase storage configuration. Has to be either ``opensearchServerlessConfiguration`` or ``pineconeConfiguration`` or ``redisEnterpriseCloudConfiguration`` and respective type field mapping.
    ...
    @builtins.property
    @jsii.member(jsii_name="bedrockKnowledgeBaseCustomResourceRole")
    def bedrock_knowledge_base_custom_resource_role(
        self,
    ) -> _aws_cdk_aws_iam_ceddda9d.Role:
        return typing.cast(_aws_cdk_aws_iam_ceddda9d.Role, jsii.get(self, "bedrockKnowledgeBaseCustomResourceRole"))

    @builtins.property
    @jsii.member(jsii_name="dataSource")
    def data_source(self) -> "DataSource":
        return typing.cast("DataSource", jsii.get(self, "dataSource"))
    ...
    def storage_configuration(
        self,
    ) -> typing.Union["OpenSearchServerlessStorageConfiguration", "RedisEnterpriseCloudStorageConfiguration", "PineconeStorageConfiguration"]:
        return typing.cast(typing.Union["OpenSearchServerlessStorageConfiguration", "RedisEnterpriseCloudStorageConfiguration", "PineconeStorageConfiguration"], jsii.get(self, "storageConfiguration"))
    ...
    def knowledge_base_configuration(
        ...
        return typing.cast(typing.Optional["KnowledgeBaseConfiguration"], jsii.get(self, "knowledgeBaseConfiguration"))
...
class BedrockKnowledgeBaseProps:
    ...
    def storage_configuration(
        ...
        return typing.cast(typing.Union["OpenSearchServerlessStorageConfiguration", "RedisEnterpriseCloudStorageConfiguration", "PineconeStorageConfiguration"], result)
