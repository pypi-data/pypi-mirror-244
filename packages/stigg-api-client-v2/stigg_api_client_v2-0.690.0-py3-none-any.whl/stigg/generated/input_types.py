...
class AwsMarketplaceConfigurationInput(BaseModel):
    aws_product_id: str = Field(alias="awsProductId")
    dimensions_mapping: List["DimensionsMappingInput"] = Field(
        alias="dimensionsMapping"
    )
...
class ProductCreateInput(BaseModel):
    additional_meta_data: Optional[Any] = Field(alias="additionalMetaData")
    aws_marketplace_configuration: Optional["AwsMarketplaceConfigurationInput"] = Field(
        alias="awsMarketplaceConfiguration"
    )
    description: Optional[str]
    display_name: Optional[str] = Field(alias="displayName")
    environment_id: str = Field(alias="environmentId")
    integration_type: Optional[ProductIntegrationType] = Field(alias="integrationType")
...
class ProductUpdateInput(BaseModel):
    additional_meta_data: Optional[Any] = Field(alias="additionalMetaData")
    aws_marketplace_configuration: Optional[
        "UpdateAwsMarketplaceConfigurationInput"
    ] = Field(alias="awsMarketplaceConfiguration")
    description: Optional[str]
    display_name: Optional[str] = Field(alias="displayName")
...
class UpdateAwsMarketplaceConfigurationInput(BaseModel):
    dimensions_mapping: List["DimensionsMappingInput"] = Field(
        alias="dimensionsMapping"
    )
...
AwsMarketplaceConfigurationInput.update_forward_refs()
...
UpdateAwsMarketplaceConfigurationInput.update_forward_refs()
