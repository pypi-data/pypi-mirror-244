...
def shorten_url(url, shortener='dagd'):
    ...
    if shortener.startswith('w3'):
        ...
        url = f"http://two.ft12.com/api.php?format=json&url={url}&apikey={API_KEY}"
...
def data2qrcodeurl(data, qrcode_api: str = "https://api.isoyu.com/qr/?m=1&e=L&p=20&url={}", shortened: bool = False):
    ...
    return shorten_url(url) if shortened else url
...
if __name__ == '__main__':
    ...
    for api in apis:
        print(data2qrcodeurl("123", api, shortened=True))
