...
def comp_interest(amount=None, time=None, rate_of_interest=None):
    """
    Calculate compound interest based on the given amount, time, and rate of interest.
    If no arguments are provided, it acts as a standalone interest calculator.

    Args:
        amount (int or float): The principal amount (default: None).
        time (int or float): The time period in months (default: None).
        rate_of_interest (int or float): The rate of interest in percentage (default: None).
    ...
    if rate_of_interest is None:
        rate_of_interest = float(input("Enter the rate of interest in percentage: "))

    ci = amount * (1 + rate_of_interest / 100) ** time
    return ci


def simple_interest(amount, time, rate_of_interest):
    """
    Calculate simple interest based on the given amount, time, and rate of interest.

    Args:
        amount (int or float): The principal amount.
        time (int or float): The time period in months.
        rate_of_interest (int or float): The rate of interest in percentage.
    ...
    si = principal_amount * rate_interest / 100 * time
    total_amount = principal_amount + si
    return total_amount

def simple_interest(amount=None, time=None, rate_of_interest=None):
    """
    Calculate simple interest based on the given amount, time, and rate of interest.
    If no arguments are provided, it acts as a standalone interest calculator.
    ...
    si = amount * rate_of_interest / 100 * time
