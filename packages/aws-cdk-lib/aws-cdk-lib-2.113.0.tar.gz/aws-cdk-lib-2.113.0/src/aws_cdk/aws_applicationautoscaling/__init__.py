    ...
    class TargetTrackingMetricDataQueryProperty:
        def __init__(
            ...
            *,
            ...
            :param metric_stat: This structure defines the CloudWatch metric to return, along with the statistic, period, and unit.
    ...
    class TargetTrackingMetricStatProperty:
        def __init__(
            ...
            *,
            ...
            :param metric: Represents a specific metric.
