...
class CfnDelivery(
    ...
    def __init__(
        ...
        *,
        ...
        :param id: Construct identifier for this resource (unique in its scope).
        :param delivery_destination_arn: Amazon Resource Names (ARNs) uniquely identify AWS resources.
        :param delivery_source_name: The value of the DeliverySourceName property for this object.
        :param tags: The value of the Tags property for this object.
        '''
        if __debug__:
...
class CfnDeliveryDestination(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: Scope in which this resource is defined.
        :param id: Construct identifier for this resource (unique in its scope).
        :param name: The unique name of the Delivery Destination.
        :param delivery_destination_policy: IAM policy that grants permissions to CloudWatch Logs to deliver logs cross-account to a specified destination in this account. The policy must be in JSON string format. Length Constraints: Maximum length of 51200
        :param destination_resource_arn: Amazon Resource Names (ARNs) uniquely identify AWS resources.
...
class CfnDeliverySource(
    ...
    def __init__(
        ...
        *,
        ...
        :param log_type: The type of logs being delivered. Only mandatory when the resourceArn could match more than one. In such a case, the error message will contain all the possible options.
...
class CfnLogGroup(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: Scope in which this resource is defined.
        :param id: Construct identifier for this resource (unique in its scope).
        :param data_protection_policy: The body of the policy document you want to use for this topic. You can only add one policy per topic. The policy must be in JSON string format. Length Constraints: Maximum length of 30720
        :param kms_key_id: The Amazon Resource Name (ARN) of the CMK to use when encrypting log data.
        :param log_group_class: The class of the log group. Possible values are: STANDARD and INFREQUENT_ACCESS, with STANDARD being the default class Default: - "STANDARD"
        ...
        :param retention_in_days: The number of days to retain the log events in the specified log group. Possible values are: 1, 3, 5, 7, 14, 30, 60, 90, 120, 150, 180, 365, 400, 545, 731, 1096, 1827, and 3653.
        :param tags: An array of key-value pairs to apply to this resource.
        '''
        if __debug__:
