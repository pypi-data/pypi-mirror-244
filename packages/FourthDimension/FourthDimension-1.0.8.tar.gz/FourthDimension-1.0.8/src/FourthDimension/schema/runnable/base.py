...
if TYPE_CHECKING:
    from FourthDimension.callbacks.manager import (
        AsyncCallbackManagerForChainRun,
        CallbackManagerForChainRun,
    )

from FourthDimension.callbacks.base import BaseCallbackManager
from FourthDimension.callbacks.tracers.log_stream import LogStreamCallbackHandler, RunLogPatch
from FourthDimension.load.dump import dumpd
from FourthDimension.doc.document import Serializable
from FourthDimension.schema.runnable.config import (
    RunnableConfig,
...
from FourthDimension.schema.runnable.utils import (
    Input,
    Output,
    accepts_config,
    accepts_run_manager,
...
from FourthDimension.utils.aiter import atee, py_anext
from FourthDimension.utils.iter import safetee
...
class Runnable(Generic[Input, Output], ABC):
    ...
    def with_retry(
        ...
        from FourthDimension.schema.runnable.retry import RunnableRetry
...
class RunnableWithFallbacks(Serializable, Runnable[Input, Output]):
    ...
    def batch(
        ...
        from FourthDimension.callbacks.manager import CallbackManager
    ...
    async def abatch(
        ...
        from FourthDimension.callbacks.manager import AsyncCallbackManager
