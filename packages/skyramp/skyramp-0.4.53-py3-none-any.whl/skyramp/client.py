...
class _Client:
    ...
    def mocker_apply_v1(
        ...
        if isinstance(responses, list):
            mock_description = self.get_mock_description_v1(responses)
    ...
    def get_mock_description_v1(self, responses: List[_ResponseValue]) -> _MockDescription:
        """
        ...
        for response in responses:
            if isinstance(response, _ResponseValue):
                response_dict[response.name] = response.to_json()
    ...
    def deploy_target(
        ...
        """
        this function is used to deploy a target
        """
