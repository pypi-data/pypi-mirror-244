...
class PronunciationDictionaryClient:
    ...
    def post_v_1_pronunciation_dictionaries_add_from_file(
    ...
    def get_v_1_pronunciation_dictionaries(
...
class AsyncPronunciationDictionaryClient:
    ...
    async def post_v_1_pronunciation_dictionaries_add_from_file(
        self, *, file: typing.IO, name: str, description: str
    ) -> AddPronunciationDictionaryResponseModel:
        """
        Creates a new pronunciation dictionary from a lexicon .PLS file
    ...
    async def get_v_1_pronunciation_dictionaries(
        self, pronunciation_dictionary_id: str
    ) -> GetPronunciationDictionaryMetadataResponseModel:
        """
        Get metadata for a pronunciation dictionary
