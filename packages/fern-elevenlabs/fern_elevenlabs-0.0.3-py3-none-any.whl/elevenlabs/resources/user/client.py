...
class UserClient:
    ...
    def get_v_1_user_subscription(self) -> ExtendedSubscriptionResponseModel:
        """
    ...
    def get_v_1_user(self) -> UserResponseModel:
        """
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(UserResponseModel, _response.json())  # type: ignore
        if _response.status_code == 422:
            raise UnprocessableEntityError(pydantic.parse_obj_as(HttpValidationError, _response.json()))  # type: ignore
        try:
            _response_json = _response.json()
...
class AsyncUserClient:
    ...
    async def get_v_1_user_subscription(self) -> ExtendedSubscriptionResponseModel:
        """
        Gets extended information about the users subscription
        """
    ...
    async def get_v_1_user(self) -> UserResponseModel:
        """
        Gets information about the user
        """
        _response = await self._client_wrapper.httpx_client.request(
