...
from ...types.history_item_response_model import HistoryItemResponseModel
...
class HistoryClient:
    ...
    def get_v_1_history(self, history_item_id: str) -> HistoryItemResponseModel:
        """
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(HistoryItemResponseModel, _response.json())  # type: ignore
        if _response.status_code == 422:
            raise UnprocessableEntityError(pydantic.parse_obj_as(HttpValidationError, _response.json()))  # type: ignore
        try:
            _response_json = _response.json()
    ...
    def delete_v_1_history(self, history_item_id: str) -> typing.Any:
        """
    ...
    def get_v_1_history_audio(self, history_item_id: str) -> None:
        """
        ...
        client.history.get_v_1_history_audio(
    ...
    def post_v_1_history_download(self, *, history_item_ids: typing.List[str]) -> None:
        """
        ...
        client.history.post_v_1_history_download(
            history_item_ids=[],
        )
        """
        _response = self._client_wrapper.httpx_client.request(
...
class AsyncHistoryClient:
    ...
    async def get_v_1_history(self, history_item_id: str) -> HistoryItemResponseModel:
        """
        Returns information about an history item by its ID.
    ...
    async def delete_v_1_history(self, history_item_id: str) -> typing.Any:
        """
        Delete a history item by its ID
    ...
    async def get_v_1_history_audio(self, history_item_id: str) -> None:
        """
        Returns the audio of an history item.
        ...
        await client.history.get_v_1_history_audio(
            history_item_id="history-item-id",
        )
        """
        _response = await self._client_wrapper.httpx_client.request(
    ...
    async def post_v_1_history_download(self, *, history_item_ids: typing.List[str]) -> None:
        """
        Download one or more history items. If one history item ID is provided, we will return a single audio file. If more than one history item IDs are provided, we will provide the history items packed into a .zip file.
        ...
        await client.history.post_v_1_history_download(
            history_item_ids=[],
        )
        """
        _response = await self._client_wrapper.httpx_client.request(
