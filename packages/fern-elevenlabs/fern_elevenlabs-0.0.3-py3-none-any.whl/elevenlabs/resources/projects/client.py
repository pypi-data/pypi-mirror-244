...
class ProjectsClient:
    ...
    def get_v_1_all_projects(self) -> GetProjectsResponseModel:
        """
        ...
        client.projects.get_v_1_all_projects()
        """
    ...
    def get_v_1_projects(self, project_id: str) -> ProjectExtendedResponseModel:
        """
    ...
    def delete_v_1_projects(self, project_id: str) -> typing.Any:
        """
    ...
    def post_v_1_projects_convert(self, project_id: str) -> typing.Any:
        """
    ...
    def get_v_1_projects_snapshots(self, project_id: str) -> ProjectSnapshotsResponseModel:
        """
        ...
        client.projects.get_v_1_projects_snapshots(
    ...
    def post_v_1_projects_snapshots_stream(self, project_id: str, project_snapshot_id: str) -> None:
        """
        ...
        client.projects.post_v_1_projects_snapshots_stream(
            project_id="project-id",
            project_snapshot_id="project-snapshot-id",
        )
        """
        _response = self._client_wrapper.httpx_client.request(
            "POST",
    ...
    def get_v_1_project_all_chapters(self, project_id: str) -> GetChaptersResponseModel:
        """
        ...
        client.projects.get_v_1_project_all_chapters(
            project_id="project-id",
        )
        """
        _response = self._client_wrapper.httpx_client.request(
    ...
    def get_v_1_projects_chapters(self, project_id: str, chapter_id: str) -> ChapterResponseModel:
        """
    ...
    def delete_v_1_projects_chapters(self, project_id: str, chapter_id: str) -> typing.Any:
        """
    ...
    def post_v_1_projects_chapters_convert(self, project_id: str, chapter_id: str) -> typing.Any:
        """
    ...
    def get_v_1_projects_chapters_snapshots(self, project_id: str, chapter_id: str) -> ChapterSnapshotsResponseModel:
        """
        ...
        client.projects.get_v_1_projects_chapters_snapshots(
            project_id="project-id",
    ...
    def post_v_1_projects_chapters_snapshots_stream(
        self, project_id: str, chapter_id: str, chapter_snapshot_id: str
    ) -> None:
        """
        ...
        client.projects.post_v_1_projects_chapters_snapshots_stream(
            project_id="project-id",
            chapter_id="chapter-id",
    ...
    def post_v_1_projects_update_pronunciation_dictionaries(
        self,
        project_id: str,
        *,
...
class AsyncProjectsClient:
    ...
    async def get_v_1_all_projects(self) -> GetProjectsResponseModel:
        """
        Returns a list of your projects together and its metadata.
        ...
        await client.projects.get_v_1_all_projects()
        """
    ...
    async def post_v_1_projects_add(
        self,
        *,
        name: str,
        from_url: str,
    ...
    async def get_v_1_projects(self, project_id: str) -> ProjectExtendedResponseModel:
        """
        Returns information about a specific project. This endpoint returns more detailed information about a project than GET api.elevenlabs.io/v1/projects.
    ...
    async def delete_v_1_projects(self, project_id: str) -> typing.Any:
        """
        Delete a project by its project_id.
    ...
    async def post_v_1_projects_convert(self, project_id: str) -> typing.Any:
        """
        Starts conversion of a project and all of its chapters.
    ...
    async def get_v_1_projects_snapshots(self, project_id: str) -> ProjectSnapshotsResponseModel:
        """
        Gets the snapshots of a project.
        ...
        await client.projects.get_v_1_projects_snapshots(
            project_id="project-id",
        )
        """
        _response = await self._client_wrapper.httpx_client.request(
    ...
    async def post_v_1_projects_snapshots_stream(self, project_id: str, project_snapshot_id: str) -> None:
        """
        Stream the audio from a project snapshot.
        ...
        await client.projects.post_v_1_projects_snapshots_stream(
            project_id="project-id",
            project_snapshot_id="project-snapshot-id",
        )
        """
    ...
    async def get_v_1_project_all_chapters(self, project_id: str) -> GetChaptersResponseModel:
        """
        Returns a list of your chapters for a project together and its metadata.
        ...
        await client.projects.get_v_1_project_all_chapters(
            project_id="project-id",
        )
        """
        _response = await self._client_wrapper.httpx_client.request(
    ...
    async def get_v_1_projects_chapters(self, project_id: str, chapter_id: str) -> ChapterResponseModel:
        """
        Returns information about a specific chapter.
    ...
    async def delete_v_1_projects_chapters(self, project_id: str, chapter_id: str) -> typing.Any:
        """
        Delete a chapter by its chapter_id.
    ...
    async def post_v_1_projects_chapters_convert(self, project_id: str, chapter_id: str) -> typing.Any:
        """
        Starts conversion of a specific chapter.
    ...
    async def get_v_1_projects_chapters_snapshots(
        ...
        await client.projects.get_v_1_projects_chapters_snapshots(
            project_id="project-id",
            chapter_id="chapter-id",
        )
        """
    ...
    async def post_v_1_projects_chapters_snapshots_stream(
        self, project_id: str, chapter_id: str, chapter_snapshot_id: str
    ) -> None:
        """
        Stream the audio from a chapter snapshot. Use GET /v1/projects/{project_id}/chapters/{chapter_id}/snapshots to return the chapter snapshots of a chapter.
        ...
        await client.projects.post_v_1_projects_chapters_snapshots_stream(
            project_id="project-id",
            chapter_id="chapter-id",
            chapter_snapshot_id="chapter-snapshot-id",
        )
    ...
    async def post_v_1_projects_update_pronunciation_dictionaries(
        self,
        project_id: str,
        *,
        pronunciation_dictionary_locators: typing.List[PronunciationDictionaryVersionLocatorDbModel],
