...
class TextToSpeechClient:
    ...
    def post_v_1_text_to_speech(
        ...
        *,
        ...
        Parameters:
            ...
            - voice_settings: typing.Optional[VoiceSettingsResponseModel]. Voice settings overriding stored setttings for the given voice. They are applied only on the given request.
        """
    ...
    def post_v_1_text_to_speech_stream(
        self,
        voice_id: str,
        *,
        optimize_streaming_latency: typing.Optional[int] = None,
...
class AsyncTextToSpeechClient:
    ...
    async def post_v_1_text_to_speech(
        self,
        voice_id: str,
        *,
        optimize_streaming_latency: typing.Optional[int] = None,
    ...
    async def post_v_1_text_to_speech_stream(
        self,
        voice_id: str,
        *,
        optimize_streaming_latency: typing.Optional[int] = None,
