...
class Catalog:
    ...
    def register_shadow_dataset(
        ...
        if registered_dataset:
            ...
            dataset = self.data_storage.create_dataset_version(
                ...
                custom_column_types=shadow_dataset.custom_column_types,
            )
    ...
    def merge_datasets(
        ...
        custom_column_types = {**src.custom_column_types, **dst.custom_column_types}
