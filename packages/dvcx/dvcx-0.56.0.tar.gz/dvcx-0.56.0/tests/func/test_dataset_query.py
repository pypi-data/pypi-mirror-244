...
def test_udf(cloud_test_catalog):
    ...
    assert dataset.custom_column_types == {"name_len": {"type": "Int"}}
...
def test_udf_different_types(cloud_test_catalog):
    # TODO remove when https://github.com/iterative/dql-server/issues/244 is done
    skip_if_not_sqlite()
    catalog = cloud_test_catalog.catalog
    conf = cloud_test_catalog.client_config
    sources = [cloud_test_catalog.src_uri]
    ...
    assert dataset.custom_column_types == {
        "int_col": {"type": "Int"},
        "int_col_32": {"type": "Int32"},
        "int_col_64": {"type": "Int64"},
        "float_col": {"type": "Float"},
        "float_col_32": {"type": "Float32"},
        "float_col_64": {"type": "Float64"},
        "array_col": {"type": "Array", "item_type": {"type": "Float"}},
        "array_col_nested": {
            "type": "Array",
            "item_type": {"type": "Array", "item_type": {"type": "Float"}},
        },
        "array_col_32": {"type": "Array", "item_type": {"type": "Float32"}},
        "array_col_64": {"type": "Array", "item_type": {"type": "Float64"}},
    ...
    class Subobjects:
        ...
        def generate_subobjects(self, name, parent):
            ...
            yield DatasetRow.create(
                "subobject", size=50, parent=parent_path
