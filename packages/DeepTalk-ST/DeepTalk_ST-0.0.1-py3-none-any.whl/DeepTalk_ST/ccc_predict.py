...
def Predict(
    args, attr_graph, no_batches, pretrained_node_embedding, ent2id, rel2id, model_path
):
    ...
    fl_ = os.path.join(model_path, "finetune_{}.model".format(9))
...
def run_predict(data_name='Apoe_Grm5',data_path='./Test/single-cell/data/',
    ...
    pretrained_embeddings='./Test/single-cell/data/data_pca.emd', model_path = './Test/single-cell/data'):
    ...
    (
        ...
        args, attr_graph, ft_num_batches, pretrained_node_embedding, ent2id, rel2id, model_path
    )
