...
class OqtantOutput(BaseModel):
    ...
    def plot_tof(
        ...
        Args:
            ...
            gridon (bool, optional): Flag to show grid lines or not in the plot
    ...
    def plot_it(
        self, file_name: str = None, figsize: tuple[int, int] = (12, 12)
    ) -> None:
        """Method to ??? #TODO
        ...
        IT_plot = plt.imshow(
            IT_OD, origin="upper", cmap="viridis", extent=[-256, 256, -74, 74]
        )
