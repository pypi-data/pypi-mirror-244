...
from commonroad.scenario.state import CustomState, State, InitialState
...
class SumoSimulation:
    ...
    def _get_cr_obstacles_at_time(self, time_step: int,
        ...
        for veh_id, state in vehicle_dict.items():
            ...
            dynamic_obstacle = DynamicObstacle(
                ...
                initial_state=InitialState(state.time_step, state.position, state.orientation, state.velocity,
                                           state.acceleration),
    ...
    def _get_cr_obstacles_all(self) -> List[DynamicObstacle]:
        ...
        for veh_id, time_dict in veh_state.items():
            ...
            obstacle_shape = self.obstacle_shapes[veh_id]
            obstacle_type = self.obstacle_types[veh_id]
            initial_state = state_list[0]  # TODO writing an InitialState object to state_list[0] would be more clean
