...
model.con10 = Constraint(rule=simple_constraint_rule(model.q * (model.y**2) == 0))
model.con11 = Constraint(rule=simple_constraint_rule(model.q * model.y * model.x == 0))
...
model.con16 = Constraint(rule=simple_constraint_rule(model.q * model.y == 0))
