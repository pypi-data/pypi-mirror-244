...
class TestInvalidPiecewise(unittest.TestCase):
    ...
    def test_dlog_bad_length(self):
        ...
        try:
            ...
            self.fail(
                "Piecewise should fail when initialized "
    ...
    def test_unsorted_pw_pts(self):
        ...
        try:
            ...
            self.fail(
                "Piecewise should fail when initialized with unsorted domain points."
            )
    ...
    def test_bad_warning_tol(self):
        ...
        try:
            ...
            self.fail(
                "Piecewise should fail when initialized with invalid warning_tol."
            )
