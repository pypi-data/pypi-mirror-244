...
class OptConvertDebug(unittest.TestCase):
    ...
    def test_nl_nl1(self):
        ...
        ans = pyomo.opt.convert_problem(
            ("test4.nl",), None, [pyomo.opt.ProblemFormat.nl]
        )
    ...
    def test_nl_nl2(self):
        """Convert from NL to NL"""
        ans = pyomo.opt.convert_problem(
            ("test4.nl", "tmp.nl"), None, [pyomo.opt.ProblemFormat.nl]
        )
    ...
    def test_error1(self):
        ...
        try:
            pyomo.opt.convert_problem(
                ("test4.nl", "tmp.nl"), pyomo.opt.ProblemFormat.nl, []
            )
    ...
    def test_error2(self):
        ...
        try:
            pyomo.opt.convert_problem(
                ("test4.nl", "tmp.nl"),
                pyomo.opt.ProblemFormat.nl,
                [pyomo.opt.ProblemFormat.mps],
            )
            self.fail("Expected pyomo.opt.ConverterError exception")
        except pyomo.opt.ConverterError:
            pass
    ...
    def test_error4(self):
        ...
        try:
            pyomo.opt.convert_problem(
                ("prob.foo",), None, [pyomo.opt.ProblemFormat.mps]
            )
            self.fail("Expected pyomo.opt.ConverterError exception")
        except pyomo.opt.ConverterError:
            pass
    ...
    def test_error5(self):
        ...
        try:
            pyomo.opt.convert_problem(
                ("prob.lp",), pyomo.opt.ProblemFormat.nl, [pyomo.opt.ProblemFormat.nl]
            )
            self.fail("Expected pyomo.opt.ConverterError exception")
        except pyomo.opt.ConverterError:
            pass
    ...
    def test_error6(self):
        ...
        try:
            ans = pyomo.opt.convert_problem(
                (currdir + "test4.nl", "foo"), None, [pyomo.opt.ProblemFormat.cpxlp]
            )
            self.fail("Expected pyomo.opt.ConverterError exception")
        except pyomo.opt.ConverterError:
            pass
    ...
    def test_error8(self):
        ...
        try:
            ans = pyomo.opt.convert_problem(
                (currdir + "unknown.nl",), None, [pyomo.opt.ProblemFormat.cpxlp]
            )
            self.fail("Expected pyomo.opt.ConverterError exception")
        except ApplicationError:
            if pyomo.common.Executable("pico_convert"):
                self.fail(
                    "Expected ApplicationError because pico_convert is not available"
                )
            return
        except pyomo.opt.ConverterError:
            pass
    ...
    def test_error9(self):
        ...
        try:
            ans = pyomo.opt.convert_problem(
                (currdir + "test4.nl",), None, [pyomo.opt.ProblemFormat.cpxlp]
            )
    ...
    def test_error10(self):
        ...
        try:
            arg = MockArg3()
            ans = pyomo.opt.convert_problem(
                (arg, pyomo.opt.ProblemFormat.cpxlp, arg),
                None,
                [pyomo.opt.ProblemFormat.cpxlp],
            )
    ...
    def test_error11(self):
        ...
        try:
            ans = pyomo.opt.convert_problem(
                (currdir + "test3.mod", currdir + "test5.dat"),
                None,
                [pyomo.opt.ProblemFormat.cpxlp],
            )
            self.fail(
                "Expected pyomo.opt.ConverterError exception because we provided a MOD file with a 'data;' declaration"
            )
        except ApplicationError:
