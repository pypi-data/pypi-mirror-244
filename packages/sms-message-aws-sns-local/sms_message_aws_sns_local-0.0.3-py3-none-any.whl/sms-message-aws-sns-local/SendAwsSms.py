...
class SmsMessageAwsSns(SMSMessage):
...
def send_sms_using_aws_sms_using_api_getaway(self, phone_number, message):
        ...
        example_instance=APIManagmentLocal.InDirect
        ...
        while True:
                ...
                if arr==None:
                        ...
                        if api_check!= MORE_THAN_HARD_LIMIT:   
                                ...
                                x=APIManagmentLocal.seconds_to_sleep_after_passing_the_hard_limit(api_type_id=api_type_id)
                                if x>0:
