...
def loadTRC(path: str) -> nimblephysics_libs._nimblephysics.biomechanics.OpenSimTRC:
    pass
def moveOsimMarkers(inputPath: nimblephysics_libs._nimblephysics.common.Uri, bodyScales: dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]], markerOffsets: dict[str, tuple[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], outputPath: str) -> None:
    pass
...
def replaceOsimInertia(inputPath: nimblephysics_libs._nimblephysics.common.Uri, skel: nimblephysics_libs._nimblephysics.dynamics.Skeleton, outputPath: str) -> None:
    pass
def replaceOsimMarkers(inputPath: nimblephysics_libs._nimblephysics.common.Uri, markers: dict[str, tuple[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], isAnatomical: dict[str, bool], outputPath: str) -> None:
    pass
def saveIDMot(skel: nimblephysics_libs._nimblephysics.dynamics.Skeleton, outputPath: str, timestamps: list[float], forcePlates: numpy.ndarray[numpy.float64, _Shape[m, n]]) -> None:
    pass
def saveMot(skel: nimblephysics_libs._nimblephysics.dynamics.Skeleton, path: str, timestamps: list[float], poses: numpy.ndarray[numpy.float64, _Shape[m, n]]) -> None:
    pass
def saveOsimInverseDynamicsProcessedForcesXMLFile(subjectName: str, contactBodies: list[nimblephysics_libs._nimblephysics.dynamics.BodyNode], grfForcePath: str, forcesOutputPath: str) -> None:
    pass
def saveOsimInverseDynamicsRawForcesXMLFile(subjectName: str, skel: nimblephysics_libs._nimblephysics.dynamics.Skeleton, poses: numpy.ndarray[numpy.float64, _Shape[m, n]], forcePlates: list[nimblephysics_libs._nimblephysics.biomechanics.ForcePlate], grfForcePath: str, forcesOutputPath: str) -> None:
    pass
...
def saveOsimScalingXMLFile(subjectName: str, skel: nimblephysics_libs._nimblephysics.dynamics.Skeleton, massKg: float, heightM: float, osimInputPath: str, osimInputMarkersPath: str, osimOutputPath: str, scalingInstructionsOutputPath: str) -> None:
    pass
def saveProcessedGRFMot(outputPath: str, timestamps: list[float], bodyNodes: list[nimblephysics_libs._nimblephysics.dynamics.BodyNode], groundLevel: float, wrenches: numpy.ndarray[numpy.float64, _Shape[m, n]]) -> None:
    pass
def saveRawGRFMot(outputPath: str, timestamps: list[float], forcePlates: list[nimblephysics_libs._nimblephysics.biomechanics.ForcePlate]) -> None:
    pass
def saveTRC(path: str, timestamps: list[float], markerTimestamps: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None:
    pass
