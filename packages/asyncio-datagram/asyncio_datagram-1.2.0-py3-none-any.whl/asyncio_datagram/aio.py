...
__all__ = ("TransportClosed", "DatagramStream", "bind", "connect", "from_socket", "DatagramClient")
...
async def connect(
    ...
    @param local_addr - Local address for socket binding
    ...
    @param allow_broadcast - tells the kernel to allow this endpoint to send
