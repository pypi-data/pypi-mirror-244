...
class FeatureCreationRequest(abc.ABC):
    ...
    @classmethod
    def json_schema(cls) -> FeatureCreationRequest:
    ...
    @classmethod
    def from_json(cls, data: dict) -> FeatureCreationRequest:
...
class EventFeatureCreationRequest(FeatureCreationRequest):
    ...
    @classmethod
    def from_json(cls, data: dict) -> EventFeatureCreationRequest:
...
class RowFeatureCreationRequest(FeatureCreationRequest):
    ...
    @classmethod
    def from_json(cls, data: dict) -> RowFeatureCreationRequest:
