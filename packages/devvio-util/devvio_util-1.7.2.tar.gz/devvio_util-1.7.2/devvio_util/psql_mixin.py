...
class PsqlMixin:
    ...
    def select_single_record(self, relation: str, select_props: List[str],  # noqa: C901
        ...
        counter = 0
        if not select_props:
            raise DBError('Missing select_props argument in PsqlMixin.select_single_record()')
    ...
    def select_all_records(self, relation: str, select_props: List[str],  # noqa: C901
        ...
        counter = 0
        if not select_props:
            raise DBError('Missing select_props argument in PsqlMixin.select_all_record()')
        for k in select_props:
            if counter > 0:
                stmt += ", "
            counter += 1
