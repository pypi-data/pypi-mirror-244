/*
 * Type definitions for libfcrypto
 *
...
#if !defined( _LIBFCRYPTO_TYPES_H )
#define _LIBFCRYPTO_TYPES_H
...
#define __USE_UNIX98
#define LIBFCRYPTO_DEFINITION_UNIX98
#endif

#include <wchar.h>

#if defined( LIBFCRYPTO_DEFINITION_UNIX98 )
#undef __USE_UNIX98
#undef LIBFCRYPTO_DEFINITION_UNIX98
#endif
...
#endif /* !defined( _LIBFCRYPTO_TYPES_H ) */
