...
if (DFT == '_QE/'): esc_ions_tipo = 0

if (len(inputs) == 0 and esc_ions_tipo == 0):
   print ("##############################################################")
...
if (len(inputs) == 0 and esc_ions_tipo == 1):
   print ("##############################################################")
   print ("To define a REGION to be projected in the band structure, you ") 
   print ("must enter limits for the Cartesian coordinates (kx|ky|kz  in ")
   print ("angstrom) selected below:                                     ")
   print ("==============================================================")
   print ("Examples:                                                     ")
   print ("kx_min kx_max: 0.0 14.0                                       ")  
   print ("ky_min ky_max: 5.0 10.0                                       ")
   print ("kz_min kz_max: 7.0 7.5                                        ")
   print ("##############################################################")
   print(" ")
...
if (len(inputs) == 0 and esc_ions_tipo == 1):
   ...
   #------------------------------------------------------
   k_min = [-9999.0]*3; k_max = [+9999.0]*3
   #-----------------------------------------------------------------------
   print ("##############################################################")
   print ("What coordinates do you want to limit?                        ")
   print ("--------------------------------------------------------------")
   print ("[1] (kx)          [2] (ky)       [3] (kz)                     ")
   print ("[4] (kx,ky)       [5] (kx,kz)    [6] (ky,kz)                  ")
   print ("[7] (kx,ky,kz)                                                ")
   print ("##############################################################")
   ...
   #--------------------------- 
       ...
       if (esc_ions_tipo == 1):       
           ...
           if (esc_limit == 1 or esc_limit == 4 or esc_limit == 5 or esc_limit == 7):
              print ("##############################################################")
              print ("Enter the limits of the kx coordinate (in Angstrom): =========")
              print ("##############################################################")
              k_range = input ("kx_min kx_max: "); selected_k = k_range.split()
              k_min[0] = float(selected_k[0]); k_max[0] = float(selected_k[1])
              print (" ")
           if (esc_limit == 2 or esc_limit == 4 or esc_limit == 6 or esc_limit == 7):
              print ("##############################################################")
              print ("Enter the limits of the ky coordinate (in Angstrom): =========")
              print ("##############################################################")
              k_range = input ("ky_min ky_max: "); selected_k = k_range.split()
              k_min[1] = float(selected_k[0]); k_max[1] = float(selected_k[1])
              print (" ")
           if (esc_limit == 3 or esc_limit == 5 or esc_limit == 6 or esc_limit == 7):
              print ("##############################################################")
              print ("Enter the limits of the kz coordinate (in Angstrom): =========")
              print ("##############################################################")
              k_range = input ("kz_min kz_max: "); selected_k = k_range.split()
              k_min[2] = float(selected_k[0]); k_max[2] = float(selected_k[1])
              print (" ") 
           #-----------------------------------------------------------------------
           reg_ion = ''
           for ii in range(ni):
               if (ni_coord[ii][0] >= k_min[0] and ni_coord[ii][0] <= k_max[0]):
                  if (ni_coord[ii][1] >= k_min[1] and ni_coord[ii][1] <= k_max[1]):
                     if (ni_coord[ii][2] >= k_min[2] and ni_coord[ii][2] <= k_max[2]):
                        iion = ii+1; reg_ion += str(iion) + '* '
           #-------------------------------------------------------------------------------------
           selected_ions = reg_ion.replace(':', ' ').replace('-', ' ').replace('*', ' *').split()
...
label_ii = ''; ni_tip = ''
for i in range(1,(n_reg+1)):
    nii = 0; label_ii += 'A' + str(i) + ' '
    for j in range(1,(ni+1)):
        if (ion_orb[i][j][1] == 1): nii += 1
    ni_tip += str(nii) + ' '        
new_contcar.write(f'{label_ii} \n')
new_contcar.write(f'{ni_tip} \n')
#-------------------------------------------
new_contcar.write(f'Cartesian \n')
#-------------------------------------------
for i in range(1,(n_reg+1)):
    for j in range(1,(ni+1)):
        if (ion_orb[i][j][1] == 1):
           new_contcar.write(f'{ni_coord[j-1][0]/Parametro} {ni_coord[j-1][1]/Parametro} {ni_coord[j-1][2]/Parametro} \n')
#------------------------------------------
new_contcar.close()
#===========================================
