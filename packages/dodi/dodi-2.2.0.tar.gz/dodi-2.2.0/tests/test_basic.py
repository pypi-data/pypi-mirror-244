...
assert_equal(get_response(dodi.static_url('app_static_ace_truck_small.jpg', '')).status_code, 200)
...
image = get_response_image(dodi.static_url('ace_truck_200_100.jpg', 'crop_left=0.2;crop_right=0.1;crop_top=0.2;crop_bottom=0.1'))
