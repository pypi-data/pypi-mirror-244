...
def add_dependency(operand, token, *, loc=None, ip=None) -> _SubClassValueT:
...
def all_reduce(result, operands_, replica_groups, *, channel_handle=None, use_global_device_ids=None, loc=None, ip=None) -> _SubClassValueT:
...
def all_to_all(operand, replica_groups, *, split_dimension=None, concat_dimension=None, split_count=None, channel_handle=None, loc=None, ip=None) -> _SubClassValueT:
...
def async_done(bundle, called_computation, execution_thread, *, group_id=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(AsyncDoneOp(bundle=bundle, called_computation=called_computation, execution_thread=execution_thread, group_id=group_id, loc=loc, ip=ip))
...
def async_start(result, inputs, called_computation, execution_thread, *, group_id=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(AsyncStartOp(result=result, inputs=inputs, called_computation=called_computation, execution_thread=execution_thread, group_id=group_id, loc=loc, ip=ip))
...
def async_update(bundle, called_computation, execution_thread, *, group_id=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(AsyncUpdateOp(bundle=bundle, called_computation=called_computation, execution_thread=execution_thread, group_id=group_id, loc=loc, ip=ip))
...
def bitcast(result, operand, *, loc=None, ip=None) -> _SubClassValueT:
...
def concatenate(val, dimension, *, loc=None, ip=None) -> _SubClassValueT:
...
def copy(operand, *, cross_program_prefetch_index=None, loc=None, ip=None) -> _SubClassValueT:
  ...
  def __init__(self, result, inputs, call_target_name, *, has_side_effect=None, backend_config=None, api_version=None, called_computations=None, custom_call_schedule=None, operand_layouts=None, result_layouts=None, output_operand_aliases=None, loc=None, ip=None):
    ...
    if backend_config is not None: attributes["backend_config"] = (backend_config if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_690')) else
          _ods_ir.AttrBuilder.get('anonymous_690')(backend_config, context=_ods_context))
    ...
    if output_operand_aliases is not None: attributes["output_operand_aliases"] = (output_operand_aliases if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_697')) else
          _ods_ir.AttrBuilder.get('anonymous_697')(output_operand_aliases, context=_ods_context))
    results.extend(result)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
def custom_call(result, inputs, call_target_name, *, has_side_effect=None, backend_config=None, api_version=None, called_computations=None, custom_call_schedule=None, operand_layouts=None, result_layouts=None, output_operand_aliases=None, loc=None, ip=None) -> _SubClassValueT:
...
def domain(operand, kind, entry_metadata, exit_metadata, *, loc=None, ip=None) -> _SubClassValueT:
  ...
  def __init__(self, results_, inputs, *, fusion_kind=None, output_operand_aliases=None, loc=None, ip=None):
    ...
    if output_operand_aliases is not None: attributes["output_operand_aliases"] = (output_operand_aliases if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_732')) else
          _ods_ir.AttrBuilder.get('anonymous_732')(output_operand_aliases, context=_ods_context))
...
def fusion(results_, inputs, *, fusion_kind=None, output_operand_aliases=None, loc=None, ip=None) -> _SubClassValueT:
...
def stochastic_convert(result, operand, random, *, loc=None, ip=None) -> _SubClassValueT:
...
def topk(operand, k, *, largest=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def xla_rng_get_and_update_state(delta, *, loc=None, ip=None) -> _SubClassValueT:
