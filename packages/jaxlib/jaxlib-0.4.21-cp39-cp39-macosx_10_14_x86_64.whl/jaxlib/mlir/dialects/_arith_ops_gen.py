...
def addi(lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(AddIOp(lhs=lhs, rhs=rhs, loc=loc, ip=ip))
...
def cmpf(predicate, lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(CmpFOp(predicate=predicate, lhs=lhs, rhs=rhs, loc=loc, ip=ip))
...
def muli(lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(MulIOp(lhs=lhs, rhs=rhs, loc=loc, ip=ip))
...
def subi(lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(SubIOp(lhs=lhs, rhs=rhs, loc=loc, ip=ip))
