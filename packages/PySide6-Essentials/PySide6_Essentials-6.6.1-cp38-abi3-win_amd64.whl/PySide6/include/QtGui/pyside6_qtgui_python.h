...
enum : int {
    ...
    SBK_QTGUI_QLIST_QPERSISTENTMODELINDEX_IDX                = 68, // QList<QPersistentModelIndex>
    SBK_QTGUI_QHASH_INT_QBYTEARRAY_IDX                       = 69, // QHash<int,QByteArray>
    SBK_QTGUI_QLIST_QVARIANT_IDX                             = 70, // QList<QVariant>
    SBK_QTGUI_QLIST_QSTRING_IDX                              = 71, // QList<QString>
    SBK_QTGUI_QMAP_QSTRING_QVARIANT_IDX                      = 72, // QMap<QString,QVariant>
    SBK_QtGui_CONVERTERS_IDX_COUNT                           = 73
};
