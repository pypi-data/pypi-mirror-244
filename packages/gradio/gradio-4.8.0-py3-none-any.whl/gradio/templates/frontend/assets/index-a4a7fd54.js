...
const ENTRY_CSS = "./assets/index-5b29a666.css";
let FONTS;
FONTS = [];
let IndexComponent;
let _res;
...
async function get_index() {
  IndexComponent = (await __vitePreload(() => import('./Index-1fd72dbe.js').then(n => n.I),true?["./Index-1fd72dbe.js","./Index-235ebd01.css"]:void 0,import.meta.url)).default;
  _res();
}
...
//# sourceMappingURL=index-a4a7fd54.js.map
