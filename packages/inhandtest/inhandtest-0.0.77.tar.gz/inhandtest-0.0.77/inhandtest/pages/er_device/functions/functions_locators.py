        ...
        return [
            ('uplink_table',
             {'table': [
                 ...
                 (
                 'sim1_service_type', {'locator': {'default': self.page.locator('#sim1_network_type')}, 'type': 'select',
                 ...
                 ('sim2_dialing_parameters',
                  {'locator': {'default': self.page.locator('#sim2_dialingParameters')}, 'type': 'select',
                   'param': {'auto': self.locale.auto, 'manual': self.locale.manual}}),
                 (
                 'sim2_service_type', {'locator': {'default': self.page.locator('#sim2_network_type')}, 'type': 'select',
