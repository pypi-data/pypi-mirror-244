...
class OSOEnergySession:
    ...
    def start_session(self, config: dict = {}) -> dict[str, list[OSOEnergyWaterHeaterData | OSOEnergySensorData]]:
    ...
    def create_devices(self) -> dict[str, list[OSOEnergyWaterHeaterData | OSOEnergySensorData]]:
