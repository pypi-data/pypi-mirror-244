...
from hivesda.test import main_single
import os
...
img_auc, pix_auc, img_scores = main_single(device,gpu,input_size,val_list,run_model_path,save_heatmap,save_heatmap_path)
