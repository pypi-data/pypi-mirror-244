...
class ConfigDiscoverRequest(_message.Message):
    ...
    group: str
    revision: str
    def __init__(self, type: _Optional[_Union[ConfigDiscoverRequest.ConfigDiscoverRequestType, str]] = ..., namespace: _Optional[str] = ..., group: _Optional[str] = ..., revision: _Optional[str] = ...) -> None: ...
