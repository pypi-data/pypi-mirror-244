...
class PhilipsAnnotationReader(Base):
    ...
    def get_standard_AH_events(self, type='AHI3', od_eps=45, aro_eps=6):
        ...
        filter = AHEventFilter(self.respiratory_events, self.OD_events, self.arousal_events)
        res_H_with_machine = filter.get_filtered_AH_events(type=type, od_eps=od_eps, aro_eps=aro_eps)
        return merge_drop_duplicates_sort(res_H_with_machine, self.respiratory_events_H_with_no_machine)
    ...
    def get_standard_AH_events_H_with_no_machine(self):
        ...
        respiratory_events_H_with_no_machine = pd.DataFrame.from_dict(respiratory_events_dic)
        self.respiratory_events_H_with_no_machine = respiratory_events_H_with_no_machine
        return respiratory_events_H_with_no_machine
...
if __name__ == '__main__':
    ...
    res = anno.get_standard_AH_events()
