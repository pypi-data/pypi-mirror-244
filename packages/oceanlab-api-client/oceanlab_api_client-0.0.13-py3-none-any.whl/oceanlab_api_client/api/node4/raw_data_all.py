...
from ...models.raw_data_all_response_200 import RawDataAllResponse200
...
) -> Optional[RawDataAllResponse200]:
    if response.status_code == HTTPStatus.OK:
        response_200 = RawDataAllResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[RawDataAllResponse200]:
    return Response(
