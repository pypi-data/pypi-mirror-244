...
from ...models.metadata_response_200 import MetadataResponse200
...
def _get_kwargs() -> Dict[str, Any]:
    ...
    return {
        "method": "get",
        "url": "/v0/services/metadata",
    }


def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Optional[MetadataResponse200]:
    if response.status_code == HTTPStatus.OK:
        response_200 = MetadataResponse200.from_dict(response.json())
