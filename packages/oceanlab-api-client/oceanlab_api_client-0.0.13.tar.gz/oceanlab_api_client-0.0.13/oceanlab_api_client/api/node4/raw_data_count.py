...
from ...models.raw_data_count_response_200 import RawDataCountResponse200
...
) -> Optional[RawDataCountResponse200]:
    if response.status_code == HTTPStatus.OK:
        response_200 = RawDataCountResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[RawDataCountResponse200]:
    return Response(
