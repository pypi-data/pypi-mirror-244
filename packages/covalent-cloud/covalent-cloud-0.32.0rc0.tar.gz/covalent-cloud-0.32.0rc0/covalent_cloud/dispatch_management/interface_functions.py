...
def dispatch(
    ...
    Args:
        ...
        dispatch_id: [optional] The dispatch ID to use. If None, a new dispatch ID will be generated.
    ...
    def wrapper(*args, **kwargs) -> str:
        ...
        try:
            ...
            new_dispatch_id = register(
                lattice, volume=volume, settings=settings, dispatch_id=dispatch_id
            )(*args, **kwargs)
            return start(new_dispatch_id, settings)
