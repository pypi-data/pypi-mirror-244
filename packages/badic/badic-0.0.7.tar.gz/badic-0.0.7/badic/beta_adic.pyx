...
cdef class BetaBase:
    ...
    def Proj(self, DetAutomaton a, DetAutomaton b, t=0, arel=None, int algo_inter=1, bint only_aut=True):
        self.m.a = a
        return self.m.proj(b, t=-t, arel=arel, aut=only_aut, algo_inter=algo_inter)
...
#        return orbit_points
    ...
    def relations_automaton(self, t=0, bint isvide=False, list Ad=None, list A=None, list B=None,
                             bint couples=False, bint ext=False, bint mirror=False,
                             bint prune=True, int nhash=1000003, int prec=53, int algo=3, int coeff=1, bint verb=False):
        r"""
...
#        return (log(len(S)) / (niter * abs(log(m))))
    ...
    def reduced_words_automaton(self, bint full=False, int step=100,
                                bint mirror=False, int algo_rel=3, int algo_inter=1, int verb=False):
        r"""
    ...
    def proj(self, a, t=0, DetAutomaton arel=None, int algo=3, int algo_inter=1, bint pref=False, bint simplify=True, bint aut=False):
        r"""
        Project the translation by t of self on the zero and prefix completion of a.
...
#
    ...
    def domain_exchange(self, n=None, int algo=1, int algo_rel=3, int algo_inter=1, bint test_Pisot=True,
        ...
        for t in it:
            ...
            if not mia.has_empty_language():
                ...
                r.append((t, mi))
                a = a.intersection(mi.a.complementary(), algo=algo_inter)
                if a.has_empty_language():
                    return r
            n -= 1
            if n == 0:
    ...
    def substitution(self, DetAutomaton ap=None,
                              np=None, list lt=None, bint need_included=True,
        ...
        lt = [(m.Proj(a, ap, algo_inter=algo_inter), t) for a, t in lt]
        if verb:
