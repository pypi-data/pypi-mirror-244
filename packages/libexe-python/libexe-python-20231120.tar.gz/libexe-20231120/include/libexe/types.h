...
#if !defined( _LIBEXE_TYPES_H )
#define _LIBEXE_TYPES_H
...
#define __USE_UNIX98
#define LIBEXE_DEFINITION_UNIX98
#endif

#include <wchar.h>

#if defined( LIBEXE_DEFINITION_UNIX98 )
#undef __USE_UNIX98
#undef LIBEXE_DEFINITION_UNIX98
#endif
