...
def damping(ops, xDamp1=0.05, xDamp2=0.05, T1=0.0, T2=0.0, factor_betaK=0.0, factor_betaKinit=0.0, factor_betaKcomm=1.0,
    ...
    xDamp2: Damping ratio for second mode.(Optional, default value is 0.05)
    ...
    Tn = [T1, T2]
    if T1 == 0 or T2 == 0:
        lambdaN_, omega_, Tn_ = eigen(ops, 2, solver=solver)
        if T1 == 0:
            Tn[0] = Tn_[0]
        if T2 == 0:
            Tn[1] = Tn_[1]
