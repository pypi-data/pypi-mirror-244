...
class Bunch6dT(object):
    ...
    get_lost_particles = _swig_new_instance_method(_RF_Track.Bunch6dT_get_lost_particles)
    get_lost_particles_mask = _swig_new_instance_method(_RF_Track.Bunch6dT_get_lost_particles_mask)
...
class Bunch6d(object):
    ...
    get_lost_particles = _swig_new_instance_method(_RF_Track.Bunch6d_get_lost_particles)
    get_lost_particles_mask = _swig_new_instance_method(_RF_Track.Bunch6d_get_lost_particles_mask)
