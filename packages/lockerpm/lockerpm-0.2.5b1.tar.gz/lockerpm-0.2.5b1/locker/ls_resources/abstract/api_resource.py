...
class APIResource(LSObject):
    ...
    def retrieve(cls, id, access_key_id=None, access_key_secret=None, **params):
        instance = cls(id, access_key_id, access_key_secret, **params)
        instance.refresh()
        return instance
    ...
    def _call_and_refresh(
        ...
        api_base=None,
        api_version=None,
        asjson=True, shell=True, timeout=30, params=None
    ):
        obj = LSObject._call(
            self,
            cli, access_key_id, access_key_secret, api_base, api_version,
    ...
    def _static_call(
        ...
        access_key_secret = util.read_special_variable(params, "access_key_secret", access_key_secret)
        ...
        return util.convert_to_ls_object(
            res_data, access_key_id, access_key_secret, api_base, api_version, params
        )
