...
class IntervalSet(object):
    ...
    def issuperset(self, other: 'IntervalSet', /) -> bool:
        """Return whether self is super set of other.
    ...
    def issubset(self, other: 'IntervalSet', /) -> bool:
        """Return whether self is sub set of other.
    ...
    def __contains__(self, item: Union[Interval, list], /):
        ...
        if isinstance(item, Interval):
            item = item.arr
        return IntervalSet([item]).difference(self).is_empty()
