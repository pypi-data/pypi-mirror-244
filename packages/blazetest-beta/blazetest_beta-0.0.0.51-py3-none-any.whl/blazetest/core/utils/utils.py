...
def combine_tags(config_tags: Any, session_uuid: str, tags: str = None) -> dict:
    """
    Combines tags from CLI, config file and adds session UUID as a tag into one dictionary

    Args:
        tags: string of tags from CLI in the format of 'key1=value1,key2=value2'
        config_tags: tags from BlazetestConfig object
        session_uuid: string of session UUID

    Returns:
        dictionary with all tags in one dictionary
    """
