        ...
        _obj = cls.model_validate(
            {
                ...
                "bassManagement": BassManagement.from_dict(obj.get("bassManagement"))
                ...
                "roomCompensation": RoomCompensation.from_dict(
                    obj.get("roomCompensation")
                )
                if obj.get("roomCompensation") is not None
                else None,
                "spatialEnvelopment": SpatialEnvelopment.from_dict(
                    obj.get("spatialEnvelopment")
                )
                if obj.get("spatialEnvelopment") is not None
                else None,
                "spatialHeight": SpatialHeight.from_dict(obj.get("spatialHeight"))
                if obj.get("spatialHeight") is not None
                else None,
                "spatialProcessing": SpatialProcessing.from_dict(
                    obj.get("spatialProcessing")
                )
                if obj.get("spatialProcessing") is not None
                else None,
                "spatialSurround": SpatialSurround.from_dict(obj.get("spatialSurround"))
                if obj.get("spatialSurround") is not None
                else None,
                "spatialWidth": SpatialWidth.from_dict(obj.get("spatialWidth"))
                if obj.get("spatialWidth") is not None
                else None,
                "speechEnhance": SpeechEnhance.from_dict(obj.get("speechEnhance"))
                if obj.get("speechEnhance") is not None
                else None,
                "toneTouch": ToneTouch.from_dict(obj.get("toneTouch"))
