...
class WebSocketEventHdmiVideoFormatSignal(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WebSocketEventHdmiVideoFormatSignal from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of WebSocketEventHdmiVideoFormatSignal from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "eventData": HdmiVideoFormat.from_dict(obj.get("eventData"))
