...
class SpatialHeightRange(BaseModel):
    ...
    default: SpatialHeight
    range: List[SpatialHeight] = Field(description="spatial-height range")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SpatialHeightRange from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SpatialHeightRange from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "default": SpatialHeight.from_dict(obj.get("default"))
                if obj.get("default") is not None
                else None,
                "range": [SpatialHeight.from_dict(_item) for _item in obj.get("range")]
