...
class WebSocketEventActiveHdmiInputSignal(BaseModel):
    ...
    event_data: Optional[HdmiInput] = Field(default=None, alias="eventData")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WebSocketEventActiveHdmiInputSignal from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of WebSocketEventActiveHdmiInputSignal from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "eventData": HdmiInput.from_dict(obj.get("eventData"))
