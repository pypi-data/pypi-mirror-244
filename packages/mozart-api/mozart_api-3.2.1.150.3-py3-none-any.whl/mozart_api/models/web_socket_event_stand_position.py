...
class WebSocketEventStandPosition(BaseModel):
    ...
    event_data: Optional[StandPosition] = Field(default=None, alias="eventData")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WebSocketEventStandPosition from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of WebSocketEventStandPosition from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "eventData": StandPosition.from_dict(obj.get("eventData"))
