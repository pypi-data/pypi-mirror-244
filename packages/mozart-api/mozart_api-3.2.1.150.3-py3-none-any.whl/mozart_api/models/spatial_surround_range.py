...
class SpatialSurroundRange(BaseModel):
    ...
    range: List[SpatialSurround] = Field(description="spatial-surround range")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SpatialSurroundRange from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SpatialSurroundRange from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "default": SpatialSurround.from_dict(obj.get("default"))
                if obj.get("default") is not None
                else None,
                "range": [
                    SpatialSurround.from_dict(_item) for _item in obj.get("range")
                ]
