...
class WebSocketEventButton(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WebSocketEventButton from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of WebSocketEventButton from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "eventData": ButtonEvent.from_dict(obj.get("eventData"))
