...
class TvState(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["integration", "soundSettings", "tvInfo"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "soundSettings": TvSoundSettings.from_dict(obj.get("soundSettings"))
                if obj.get("soundSettings") is not None
                else None,
                "tvInfo": TvProperties.from_dict(obj.get("tvInfo"))
