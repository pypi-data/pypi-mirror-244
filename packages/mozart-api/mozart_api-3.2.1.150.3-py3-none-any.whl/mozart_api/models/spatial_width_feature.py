...
class SpatialWidthFeature(BaseModel):
    ...
    range: List[SpatialWidth] = Field(description="spatial-width range")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SpatialWidthFeature from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SpatialWidthFeature from a dict"""
        if obj is None:
            return None
