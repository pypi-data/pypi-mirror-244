...
class BassRange(BaseModel):
    ...
    default: Bass
    range: List[Bass] = Field(description="Product and role specific bass range")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of BassRange from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of BassRange from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "default": Bass.from_dict(obj.get("default"))
                if obj.get("default") is not None
                else None,
                "range": [Bass.from_dict(_item) for _item in obj.get("range")]
