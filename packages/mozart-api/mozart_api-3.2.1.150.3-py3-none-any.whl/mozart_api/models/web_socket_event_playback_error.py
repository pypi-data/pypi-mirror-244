...
class WebSocketEventPlaybackError(BaseModel):
    ...
    event_data: Optional[PlaybackError] = Field(default=None, alias="eventData")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WebSocketEventPlaybackError from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of WebSocketEventPlaybackError from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "eventData": PlaybackError.from_dict(obj.get("eventData"))
