...
class ToneTouchTypeRange(BaseModel):
    ...
    range: List[ToneTouchType] = Field(
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ToneTouchTypeRange from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ToneTouchTypeRange from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "default": ToneTouchType.from_dict(obj.get("default"))
                if obj.get("default") is not None
                else None,
                "range": [ToneTouchType.from_dict(_item) for _item in obj.get("range")]
