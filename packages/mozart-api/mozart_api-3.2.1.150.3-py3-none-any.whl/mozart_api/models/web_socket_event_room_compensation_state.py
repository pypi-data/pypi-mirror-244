...
class WebSocketEventRoomCompensationState(BaseModel):
    ...
    event_data: Optional[RoomCompensationStateValue] = Field(
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WebSocketEventRoomCompensationState from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of WebSocketEventRoomCompensationState from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "eventData": RoomCompensationStateValue.from_dict(obj.get("eventData"))
