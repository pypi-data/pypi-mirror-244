...
class WebSocketEventCurtains(BaseModel):
    ...
    event_data: Optional[ProductCurtainStatus] = Field(default=None, alias="eventData")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WebSocketEventCurtains from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of WebSocketEventCurtains from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "eventData": ProductCurtainStatus.from_dict(obj.get("eventData"))
