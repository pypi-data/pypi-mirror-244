...
class SoundSettings(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["adjustments", "roomCompensation", "toneTouch"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "roomCompensation": RoomCompensationInfo.from_dict(
                    obj.get("roomCompensation")
                )
                if obj.get("roomCompensation") is not None
                else None,
                "toneTouch": SoundToneTouch.from_dict(obj.get("toneTouch"))
