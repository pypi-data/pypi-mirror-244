...
class BassManagementRange(BaseModel):
    ...
    default: BassManagement
    range: List[BassManagement] = Field(description="bass-management range")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of BassManagementRange from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of BassManagementRange from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "default": BassManagement.from_dict(obj.get("default"))
                if obj.get("default") is not None
                else None,
                "range": [BassManagement.from_dict(_item) for _item in obj.get("range")]
