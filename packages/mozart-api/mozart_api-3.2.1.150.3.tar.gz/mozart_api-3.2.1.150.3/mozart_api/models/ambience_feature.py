...
class AmbienceFeature(BaseModel):
    ...
    value: Union[StrictFloat, StrictInt] = Field(description="Selected ambience value")
    default: Ambience
    range: List[Ambience] = Field(
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "value": obj.get("value"),
                "default": Ambience.from_dict(obj.get("default"))
                if obj.get("default") is not None
                else None,
                "range": [Ambience.from_dict(_item) for _item in obj.get("range")]
