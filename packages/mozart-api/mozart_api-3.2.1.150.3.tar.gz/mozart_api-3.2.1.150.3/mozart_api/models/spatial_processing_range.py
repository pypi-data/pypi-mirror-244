...
class SpatialProcessingRange(BaseModel):
    ...
    range: List[SpatialProcessing] = Field(description="spatial-processing range")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SpatialProcessingRange from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SpatialProcessingRange from a dict"""
        if obj is None:
            return None
