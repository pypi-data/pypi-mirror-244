...
class SpeechEnhanceRange(BaseModel):
    ...
    default: SpeechEnhance
    range: List[SpeechEnhance] = Field(description="speech-enhance range")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SpeechEnhanceRange from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SpeechEnhanceRange from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "default": SpeechEnhance.from_dict(obj.get("default"))
                if obj.get("default") is not None
                else None,
                "range": [SpeechEnhance.from_dict(_item) for _item in obj.get("range")]
