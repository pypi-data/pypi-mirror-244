...
class WebSocketEventActiveListeningMode(BaseModel):
    ...
    event_data: Optional[ListeningModeProps] = Field(default=None, alias="eventData")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WebSocketEventActiveListeningMode from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of WebSocketEventActiveListeningMode from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "eventData": ListeningModeProps.from_dict(obj.get("eventData"))
