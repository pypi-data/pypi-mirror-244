        ...
        _obj = cls.model_validate(
            {
                ...
                "queueItem": PlayQueueItem.from_dict(obj.get("queueItem"))
                if obj.get("queueItem") is not None
                else None,
                "queueSettings": PlayQueueSettings.from_dict(obj.get("queueSettings"))
                ...
                "standPosition": StandPosition.from_dict(obj.get("standPosition"))
