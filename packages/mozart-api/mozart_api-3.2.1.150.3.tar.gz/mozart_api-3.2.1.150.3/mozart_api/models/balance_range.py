...
class BalanceRange(BaseModel):
    ...
    default: Balance
    range: List[Balance] = Field(description="balance range")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of BalanceRange from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of BalanceRange from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "default": Balance.from_dict(obj.get("default"))
                if obj.get("default") is not None
                else None,
                "range": [Balance.from_dict(_item) for _item in obj.get("range")]
