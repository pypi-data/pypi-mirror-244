...
class CompressionRange(BaseModel):
    ...
    default: Compression
    range: List[Compression] = Field(description="compression range")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "default": Compression.from_dict(obj.get("default"))
                if obj.get("default") is not None
                else None,
                "range": [Compression.from_dict(_item) for _item in obj.get("range")]
