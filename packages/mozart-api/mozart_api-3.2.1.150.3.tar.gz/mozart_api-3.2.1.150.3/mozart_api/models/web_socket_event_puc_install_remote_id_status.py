...
class WebSocketEventPucInstallRemoteIdStatus(BaseModel):
    ...
    event_data: Optional[InstallRecordIdState] = Field(default=None, alias="eventData")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WebSocketEventPucInstallRemoteIdStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of WebSocketEventPucInstallRemoteIdStatus from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "eventData": InstallRecordIdState.from_dict(obj.get("eventData"))
