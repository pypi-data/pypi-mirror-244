...
class WebSocketEventSoftwareUpdateState(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WebSocketEventSoftwareUpdateState from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of WebSocketEventSoftwareUpdateState from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "eventData": SoftwareUpdateState.from_dict(obj.get("eventData"))
