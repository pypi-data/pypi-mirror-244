...
class OverlayPlayRequestFromUsb(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["fromUsb"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of OverlayPlayRequestFromUsb from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of OverlayPlayRequestFromUsb from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "fromUsb": OverlayPlayRequestFromUsbFromUsb.from_dict(
                    obj.get("fromUsb")
                )
