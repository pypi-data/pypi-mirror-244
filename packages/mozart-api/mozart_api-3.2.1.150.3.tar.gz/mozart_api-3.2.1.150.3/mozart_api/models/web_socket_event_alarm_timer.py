...
class WebSocketEventAlarmTimer(BaseModel):
    ...
    event_data: Optional[AlarmTimerEventData] = Field(default=None, alias="eventData")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WebSocketEventAlarmTimer from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of WebSocketEventAlarmTimer from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "eventData": AlarmTimerEventData.from_dict(obj.get("eventData"))
