...
def x_hexahedron_volume(corners, ndim, presision):
    return _cxtgeo.x_hexahedron_volume(corners, ndim, presision)
...
def grd3d_scan_eclbinary(fc, swig_out_char_msize, swig_np_int_aout_v1, swig_np_lng_aout_v1, swig_np_lng_aout_v2):
    return _cxtgeo.grd3d_scan_eclbinary(fc, swig_out_char_msize, swig_np_int_aout_v1, swig_np_lng_aout_v1, swig_np_lng_aout_v2)
...
def grd3d_ecl_tsteps(fc, seqnums, day, mon, year, nmax):
    return _cxtgeo.grd3d_ecl_tsteps(fc, seqnums, day, mon, year, nmax)
...
def grdcp3d_cellvol(ncol, nrow, nlay, swig_np_dbl_inplaceflat_v1, swig_np_flt_inplaceflat_v1, swig_np_int_inplaceflat_v1, swig_np_dbl_inplaceflat_v2, precision, option):
    return _cxtgeo.grdcp3d_cellvol(ncol, nrow, nlay, swig_np_dbl_inplaceflat_v1, swig_np_flt_inplaceflat_v1, swig_np_int_inplaceflat_v1, swig_np_dbl_inplaceflat_v2, precision, option)
