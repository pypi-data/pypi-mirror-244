...
class ProductCreateInput(sgqlc.types.Input):
    __schema__ = schema
    __field_names__ = ('additional_meta_data', 'aws_marketplace_configuration', 'description', 'display_name', 'environment_id', 'integration_type', 'multiple_subscriptions', 'ref_id')
    additional_meta_data = sgqlc.types.Field(JSON, graphql_name='additionalMetaData')
...
class ProductUpdateInput(sgqlc.types.Input):
    __schema__ = schema
    __field_names__ = ('additional_meta_data', 'aws_marketplace_configuration', 'description', 'display_name', 'multiple_subscriptions', 'product_settings')
    additional_meta_data = sgqlc.types.Field(JSON, graphql_name='additionalMetaData')
