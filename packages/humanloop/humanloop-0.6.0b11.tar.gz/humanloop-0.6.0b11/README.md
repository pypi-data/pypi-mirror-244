...
[![PyPI](https://img.shields.io/badge/PyPI-v0.6.0beta.11-blue)](https://pypi.org/project/humanloop/0.6.0-beta.11)
...
```sh
pip install humanloop==0.6.0-beta.11
```
...
Deserialize a model config from a .prompt file format from a request.
