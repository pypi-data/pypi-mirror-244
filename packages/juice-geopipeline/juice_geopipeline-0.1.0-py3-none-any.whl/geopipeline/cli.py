...
from .science_planning import jupiter_tour_flip_zaxis_windows
from .geometry_finder import jovian_system_occultations
from .geometry_support import jupiter_altitude_limit
...
def cli_jupiter_tour_flip_zaxis_windows():
    ...
    if args.mission_phase and args.crema_version and (args.utc_start or args.utc_end):
        print('MISSION_PHASE and CREMA_VERSION provided; no use for UTC_START or UTC_END')
        return
...
def cli_jovian_system_occultations():
    ...
    parser.add_argument('-s','--system', type=str, default=['JUPITER', 'IO', 'EUROPA', 'GANYMEDE', 'CALLISTO', 'RINGS'],
                        help="List of the bodies that form the Jovian System specified with their SPICE names"
