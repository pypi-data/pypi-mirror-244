...
class TerraformStateBackend(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: -
        :param id: -
        :param bucket_name: (experimental) The name of the bucket to create.
        :param table_name: (experimental) The name of the DynamoDB table to create.
        :param table_deletion_protection: (experimental) Whether to protect the created DynamoDB table from being accidentally deleted. Default: false
...
class TerraformStateBackendProperties:
    ...
    def bucket_name(self) -> builtins.str:
        '''(experimental) The name of the bucket to create.
    ...
    def table_name(self) -> builtins.str:
        '''(experimental) The name of the DynamoDB table to create.
    ...
    def table_deletion_protection(self) -> typing.Optional[builtins.bool]:
        '''(experimental) Whether to protect the created DynamoDB table from being accidentally deleted.
