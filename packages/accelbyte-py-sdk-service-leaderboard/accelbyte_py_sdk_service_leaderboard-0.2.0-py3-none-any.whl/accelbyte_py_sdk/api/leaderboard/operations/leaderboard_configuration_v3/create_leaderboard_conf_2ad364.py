...
# AccelByte Gaming Services Leaderboard Service (2.26.5)
...
class CreateLeaderboardConfigurationAdminV3(Operation):
    ...
    body: ModelsLeaderboardConfigReqV3  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ModelsLeaderboardConfigReqV3
    ) -> CreateLeaderboardConfigurationAdminV3:
        self.body = value
        return self

    def with_namespace(self, value: str) -> CreateLeaderboardConfigurationAdminV3:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelsLeaderboardConfigReqV3()
    ...
    @classmethod
    def create(
        cls, body: ModelsLeaderboardConfigReqV3, namespace: str, **kwargs
    ) -> CreateLeaderboardConfigurationAdminV3:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelsLeaderboardConfigReqV3.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelsLeaderboardConfigReqV3()
