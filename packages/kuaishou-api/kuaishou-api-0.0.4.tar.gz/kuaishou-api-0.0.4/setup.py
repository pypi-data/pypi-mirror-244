...
"""
pip install -U kuaishou-api
pip --no-cache-dir install -U kuaishou-api
...
setup(
    ...
    # keywords = ("test", "xxx"),
    # 简单描述
    description="快手官方开放接口",
    # 详细描述
    # long_description="快手开放平台接口",
    ...
    # 官网地址
    url="https://github.com/ldsxp/kuaishou-api",
    # 程序的下载地址
    download_url="https://pypi.org/project/kuaishou-api",
    # 作者
    author="lds",
    # 作者的邮箱地址
