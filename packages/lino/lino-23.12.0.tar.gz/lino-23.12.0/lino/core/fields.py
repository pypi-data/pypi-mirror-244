...
class PriceField(models.DecimalField):
    ...
    <https://docs.djangoproject.com/en/4.1/ref/models/fields/#decimalfield>`_
...
class PriceRange(ParameterPanel):
    def __init__(self, field_name, verbose_name=_("Price"), **kwargs):
        ...
        kwargs["start_"+field_name] = PriceField(
            verbose_name=format_lazy(_("{} from"), verbose_name),
    ...
    def get_title_tags(self, ar):
        ...
        if start_value:
            if end_value:
                yield _("{} {}...{}").format(
                    self.verbose_name, start_value, end_value)
            else:
...
class QuantityField(models.CharField):
    ...
    def to_python(self, value):
        ...
        <https://docs.djangoproject.com/en/4.1/howto/custom-model-fields/#converting-values-to-python-objects>`__:
    ...
    def clean(self, raw_value, obj):
        if len(str(raw_value)) > self.max_length:
            ...
            raise ValidationError("Cannot accept quantity {} "
                "because max_length is {}".format(raw_value, self.max_length))
...
class TableRow(object):
    ...
    def as_paragraph(self, ar):
        """Return a rich text that represents the given row as a list item.
...
def pointer_factory(cls, othermodel, *args, **kw):
    ...
    - Explicitly sets the default value for `on_delete
      <https://docs.djangoproject.com/en/4.1/ref/models/fields/#django.db.models.ForeignKey.on_delete>`__
...
def make_remote_field(model, name):
    ...
    for n in parts:
        ...
        if isinstance(fld, (models.OneToOneRel, models.OneToOneField, models.ForeignKey)):
            editable = True
            ...
            for i, fld in enumerate(field_chain):
                ...
                if isinstance(fld, (models.OneToOneRel, models.ForeignKey)):
                    ...
                    if reltarget is None:
                        ...
                        reltarget.save_new_instance(fld.related_model.get_default_table().request())
