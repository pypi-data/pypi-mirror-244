...
class BooleanStoreField(StoreField):
    ...
    `BooleanField <https://docs.djangoproject.com/en/4.1/ref/models/fields/#booleanfield>`__.
...
class AutoStoreField(StoreField):
    ...
    """A :class:`StoreField` for
    `AutoField <https://docs.djangoproject.com/en/4.1/ref/models/fields/#autofield>`__
