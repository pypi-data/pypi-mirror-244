...
spec_input_namespace_filename = "ndx-pinto-metadata.namespace.yaml"

# Name of the default namespace in the file
spec_input_default_namespace = "ndx-pinto-metadata"
...
spec_output_dir = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "_format_auto_docs"
)
