...
from vllm.utils import random_uuid
import uuid
from bixi.conversation import get_conv_template
...
class CompletionModelWorker(ABC):
    ...
    def __init__(
            ...
            conversation_template_name: str,
    ):
        ...
        self.conversation_template = get_conv_template(conversation_template_name.lower())
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="/workspace/models/Qwen-14B-Chat")
    parser.add_argument(
        "--model-names",
    ...
    parser.add_argument(
        "--conv-template", type=str, default="Qwen-Chat", help="Conversation prompt template."
    )
    ...
    worker = CompletionModelWorker(
        ...
        conversation_template_name=args.conv_template,
    )
