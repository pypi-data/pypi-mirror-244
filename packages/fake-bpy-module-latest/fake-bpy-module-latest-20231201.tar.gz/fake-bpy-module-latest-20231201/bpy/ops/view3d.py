...
def edit_mesh_extrude_individual_move(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Extrude each individual face separately along local normals :File: `startup/bl_operators/view3d.py\:23 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/view3d.py#L23>`__
