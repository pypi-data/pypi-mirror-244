...
from .redirect import HttpUrlRedirectMiddleware
class AIRequest:
...
class Sarya:
    ...
    def _set_app(self):
        self.app = FastAPI()
        self.app.add_middleware(HttpUrlRedirectMiddleware)
    ...
    async def _hmas(self, request:Request, call_next):
        ...
        if sign:
            ...
            return JSONResponse({"error":"request was not sign correctly"}, status_code=401)