...
class CreatePolicyRequestDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, product_version_id, account_code, policy_objects, *args, **kwargs):  # noqa: E501
        """CreatePolicyRequestDto - a model defined in OpenAPI

        Args:
            product_version_id (float): Unique identifier referencing the Product version.
            account_code (str): Unique identifier of the account code that this object belongs to.
        ...
        Keyword Args:
            ...
            holder (str): Policy holder name.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, product_version_id, account_code, policy_objects, *args, **kwargs):  # noqa: E501
        """CreatePolicyRequestDto - a model defined in OpenAPI
