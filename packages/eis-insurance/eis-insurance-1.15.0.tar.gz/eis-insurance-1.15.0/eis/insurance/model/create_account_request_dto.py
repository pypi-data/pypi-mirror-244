...
class CreateAccountRequestDto(ModelNormal):
    ...
    def _from_openapi_data(cls, first_name, last_name, email, gender, street, zip_code, city, house_number, phone, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            birth_date (datetime): Customer birth date.. [optional]  # noqa: E501
            ...
            company_name (str): The account's company name (Required for account of type org).. [optional]  # noqa: E501
