...
import traceback
from contextvars import ContextVarimport asyncio, uuid, os, warnings
from pkg_resources import parse_version
from importlib.metadata import version, PackageNotFoundError
import traceback
    ...
    def sync_wrapper(*args, **kwargs):
        with tracer.start_as_current_span(uuid.uuid4()) as run:
            ...
            if kwargs.get("stream") == True:
                return stream_handler(fn, run_id, name or parsed_input["name"], type, *args, **kwargs) 
            ...
            try:
                ...
                track_event(
                    ...
                    "end",
                    run_id,
                    name=name or parsed_input["name"], # Need name in case need to compute tokens usage server side
