...
from bsonschema.exceptions import UndefinedTypeCheck
...
def is_double(checker, instance):
...
def is_long(checker, instance):
    return isinstance(instance, bson.Int64)
...
def is_oid(checker, instance):
    return isinstance(instance, bson.ObjectId)

def is_string(checker, instance):
    return isinstance(instance, str)

def is_timestamp(checker, instance):
    return isinstance(instance, datetime.datetime)
...
class TypeChecker:
    ...
    def is_type(self, instance, type: str) -> bool:
        ...
        Raises:
            ...
            `bsonschema.exceptions.UndefinedTypeCheck`:
