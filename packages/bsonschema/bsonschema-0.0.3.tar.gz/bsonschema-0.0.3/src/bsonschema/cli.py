...
from bsonschema.exceptions import SchemaError
from bsonschema.validators import _RefResolver, validator_for

warnings.warn(
    (
        "The bsonschema CLI is deprecated and will be removed in a future "
        "version. Please use check-bsonschema instead, which can be installed "
        "from https://pypi.org/project/check-bsonschema/"
    ),
    DeprecationWarning,
    stacklevel=2,
)
...
parser.add_argument(
    ...
    help="""
        ...
        validators that are registered with bsonschema, simply the name
        of the class.
    """,
)
parser.add_argument(
...
parser.add_argument(
    "--version",
    action="version",
    version=metadata.version("bsonschema"),
)
parser.add_argument(
    "schema",
