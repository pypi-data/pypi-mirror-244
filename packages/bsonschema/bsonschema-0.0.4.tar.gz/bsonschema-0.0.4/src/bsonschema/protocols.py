"""
typing.Protocol classes for bsonschema interfaces.
"""
...
# it needs to see names like `bsonschema.TypeChecker`
# therefore, only import at type-checking time (to avoid circular references),
# but use `bsonschema` for any types which will otherwise not be resolvable
if TYPE_CHECKING:
...
class Validator(Protocol):
    ...
    Arguments:
        ...
        format_checker:
            ...
            *no* format validation is done, and the presence of format
            ...
            against instances. Ensure you've installed `bsonschema` with
    ...
    #: A `bsonschema.TypeChecker` that will be used when validating
    #: :kw:`type` keywords in JSON schemas.
    TYPE_CHECKER: ClassVar[bsonschema.TypeChecker]

    #: A `bsonschema.FormatChecker` that will be used when validating
    ...
    def __init__(
        self,
        schema: Mapping | bool,
        registry: referencing.bsonschema.SchemaRegistry,
    ...
    def is_type(self, instance: Any, type: str) -> bool:
        ...
        Raises:
            ...
            `bsonschema.exceptions.UnknownType`:
    ...
    def evolve(self, **kwargs) -> Validator:
        ...
        >>> validator.evolve(
        ...     schema={"$schema": Draft3Validator.META_SCHEMA["$id"]}
        ... )
        Draft3Validator(schema=..., format_checker=None)
        """
