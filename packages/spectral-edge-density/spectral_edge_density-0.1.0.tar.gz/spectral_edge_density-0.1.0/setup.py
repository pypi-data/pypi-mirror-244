...
setup(
    ...
    url='https://github.com/Metaverse-Crowdsource/EEG-Chaos-Kuramoto-Neural-Net/blob/main/Higuchi_Fractal_Dimension_files/Higuchi%20Fractal%20Dimension.ipynb',  # Optional
    packages=['spectral_edge_density'],
    install_requires=[
        'numpy',
