...
class rest:
    ...
    def create_entity_raw(self, project, type, name, fields, crs):
        ...
        url_parameters = f"{self.VFAPIURL_ENTITY}?{urllib3.request.urlencode(params)}"               
    ...
    def create_entity_processed(self, project, type, name, fields, crs, callback=None, update_type = None):
        ...
        url_parameters = f"{self.VFAPIURL_EVENT}?{urllib3.request.urlencode(params)}"               
    ...
    def attach_files(self, project, id, files):
        ...
        url_parameters = f"{self.VFAPIURL_FILE}?{urllib3.request.urlencode(params)}"  
...
#region AAD_Credentials
    ...
    def get_token(self, ressource=None):
        ...
        if (self.aad_credentials["TENANT"] != None):
            ...
            request = self.HTTPSession.request(method="POST", url=authority, body=urllib3.request.urlencode(data), headers=headers)
            #HTTPSession.close()
