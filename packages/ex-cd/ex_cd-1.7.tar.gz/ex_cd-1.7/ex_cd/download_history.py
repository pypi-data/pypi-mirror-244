...
from .depercate import _depercat_gallery_history
...
def download_gallery_history(url, gallery_dir, config, logger):
    ...
    _depercat_gallery_history(parent_url, parent_gallery_dir, url, gallery_dir, config, logger)  # depercat from parent
