...
class Segment(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["angle", b"angle", "final", b"final", "radius_override", b"radius_override", "start", b"start", "tag", b"tag", "tool_index", b"tool_index", "velocity", b"velocity"]) -> None: ...
