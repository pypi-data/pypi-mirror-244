...
setup(
    ...
    package_data={
        ...
        f"{package}.macOS_service.LetMeDoIt Files.workflow": ["*.*"],
        f"{package}.macOS_service.LetMeDoIt Files.workflow.Contents": ["*.*"],
        f"{package}.macOS_service.LetMeDoIt Files.workflow.Contents.QuickLook": ["*.*"],
        f"{package}.macOS_service.LetMeDoIt Text.workflow": ["*.*"],
        f"{package}.macOS_service.LetMeDoIt Text.workflow.Contents": ["*.*"],
        f"{package}.macOS_service.LetMeDoIt Text.workflow.Contents.QuickLook": ["*.*"],
    },
