...
def createShortcuts():
    ...
    if thisOS == "Windows":
        ...
        shortcutCommand1 = f'''powershell.exe -NoExit -Command "python '{config.letMeDoItFile}'"'''
...
{sys.executable} {config.letMeDoItFile} "$selected_text"'''
        work_with_text_script_path = os.path.expanduser(f"{storage}/{first_name}")
...
/usr/bin/gnome-terminal --command "{sys.executable} {config.letMeDoItFile} -f {storage}/selected_files.txt"'''
        ...
        file1 = os.path.join(config.letMeDoItAIFolder, "macOS_service/LetMeDoIt Text.workflow/Contents/document.wflow")
        file2 = os.path.join(config.letMeDoItAIFolder, "macOS_service/LetMeDoIt Files.workflow/Contents/document.wflow")
        ...
        file1 = os.path.join(config.letMeDoItAIFolder, "macOS_service/LetMeDoIt Files.workflow/Contents/Info.plist")
        file2 = os.path.join(config.letMeDoItAIFolder, "macOS_service/LetMeDoIt Text.workflow/Contents/Info.plist")
        for i in (file1, file2):
            with open(i, "r", encoding="utf-8") as fileObj:
                content = fileObj.read()
            ...
            with open(i, "w", encoding="utf-8") as fileObj:
                fileObj.write(content)
        folder1 = os.path.join(config.letMeDoItAIFolder, "macOS_service", "LetMeDoIt Files.workflow")
        ...
        folder2 = os.path.join(config.letMeDoItAIFolder, "macOS_service", "LetMeDoIt Text.workflow")
