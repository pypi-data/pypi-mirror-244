...
def create_driver(tiny_profile=False, profile=None, window_size=None, user_agent=None, proxy=None, is_eager=False, headless=False, lang=None, block_images=False, beep=False):
