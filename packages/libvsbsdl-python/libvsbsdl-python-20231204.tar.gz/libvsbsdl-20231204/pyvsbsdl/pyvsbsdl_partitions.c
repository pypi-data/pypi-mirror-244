...
PySequenceMethods pyvsbsdl_partitions_sequence_methods = {
	/* sq_length */
	(lenfunc) pyvsbsdl_partitions_len,
	/* sq_concat */
	0,
	/* sq_repeat */
	0,
	/* sq_item */
	(ssizeargfunc) pyvsbsdl_partitions_getitem,
	/* sq_slice */
	0,
	/* sq_ass_item */
	0,
...
PyTypeObject pyvsbsdl_partitions_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyvsbsdl.partitions",
	/* tp_basicsize */
	sizeof( pyvsbsdl_partitions_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyvsbsdl_partitions_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	0,
	/* tp_as_sequence */
	&pyvsbsdl_partitions_sequence_methods,
	/* tp_as_mapping */
	0,
	/* tp_hash */
	0,
	...
	/* tp_doc */
	"pyvsbsdl sequence and iterator object of partitions",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_iter */
	(getiterfunc) pyvsbsdl_partitions_iter,
	/* tp_iternext */
	(iternextfunc) pyvsbsdl_partitions_iternext,
	/* tp_methods */
	0,
	/* tp_members */
	0,
	...
	0,
	/* tp_init */
	(initproc) pyvsbsdl_partitions_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
...
PyObject *pyvsbsdl_partitions_new(
           ...
           int number_of_items )
{
	pyvsbsdl_partitions_t *sequence_object = NULL;
	static char *function                  = "pyvsbsdl_partitions_new";
	...
	sequence_object = PyObject_New(
	                   ...
	                   &pyvsbsdl_partitions_type_object );
...
{
	static char *function = "pyvsbsdl_partitions_init";
      ...
      pyvsbsdl_partitions_t *sequence_object )
{
	...
	static char *function       = "pyvsbsdl_partitions_free";
...
Py_ssize_t pyvsbsdl_partitions_len(
            pyvsbsdl_partitions_t *sequence_object )
{
	static char *function = "pyvsbsdl_partitions_len";
           ...
           Py_ssize_t item_index )
{
	...
	static char *function      = "pyvsbsdl_partitions_getitem";
...
PyObject *pyvsbsdl_partitions_iter(
           pyvsbsdl_partitions_t *sequence_object )
{
	static char *function = "pyvsbsdl_partitions_iter";
...
{
	PyObject *partition_object = NULL;
	static char *function      = "pyvsbsdl_partitions_iternext";
