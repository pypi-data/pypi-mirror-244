...
{
	static char *function = "libvsbsdl_notify_set_stream";
...
int libvsbsdl_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libvsbsdl_notify_stream_open";
...
int libvsbsdl_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libvsbsdl_notify_stream_close";
