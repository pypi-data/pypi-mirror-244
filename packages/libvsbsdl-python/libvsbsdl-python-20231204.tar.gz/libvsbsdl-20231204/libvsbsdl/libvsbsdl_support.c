...
#include "libvsbsdl_libclocale.h"
#include "libvsbsdl_support.h"
...
const char *libvsbsdl_get_version(
             void )
{
	return( (const char *) LIBVSBSDL_VERSION_STRING );
}
...
int libvsbsdl_get_access_flags_read(
     void )
{
	return( (int) LIBVSBSDL_ACCESS_FLAG_READ );
}
...
int libvsbsdl_get_access_flags_read_write(
     void )
{
	return( (int) ( LIBVSBSDL_ACCESS_FLAG_READ | LIBVSBSDL_ACCESS_FLAG_WRITE ) );
}
...
int libvsbsdl_get_access_flags_write(
     void )
{
	return( (int) LIBVSBSDL_ACCESS_FLAG_WRITE );
}
...
{
	static char *function = "libvsbsdl_get_codepage";
...
int libvsbsdl_set_codepage(
     ...
     libcerror_error_t **error )
{
	static char *function = "libvsbsdl_set_codepage";
     ...
     libcerror_error_t **error )
{
	...
	static char *function            = "libvsbsdl_check_volume_signature";
...
{
	libbfio_handle_t *file_io_handle = NULL;
	static char *function            = "libvsbsdl_check_volume_signature_wide";
	size_t filename_length           = 0;
	int result                       = 0;
     ...
     libcerror_error_t **error )
{
	...
	static char *function      = "libvsbsdl_check_volume_signature_file_io_handle";
