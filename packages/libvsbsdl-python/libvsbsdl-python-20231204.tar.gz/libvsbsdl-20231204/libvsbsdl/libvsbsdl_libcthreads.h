...
#if !defined( _LIBVSBSDL_LIBCTHREADS_H )
#define _LIBVSBSDL_LIBCTHREADS_H

#include <common.h>

#if defined( HAVE_MULTI_THREAD_SUPPORT ) && !defined( HAVE_LOCAL_LIBVSBSDL )
#define HAVE_LIBVSBSDL_MULTI_THREAD_SUPPORT
#endif
...
#endif /* defined( HAVE_LIBVSBSDL_MULTI_THREAD_SUPPORT ) */

#endif /* !defined( _LIBVSBSDL_LIBCTHREADS_H ) */
