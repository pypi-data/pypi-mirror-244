...
#if !defined( _VSBSDLTOOLS_GETOPT_H )
#define _VSBSDLTOOLS_GETOPT_H
...
#define vsbsdltools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t vsbsdltools_getopt(
                  int argument_count,
...
#endif /* !defined( _VSBSDLTOOLS_GETOPT_H ) */
