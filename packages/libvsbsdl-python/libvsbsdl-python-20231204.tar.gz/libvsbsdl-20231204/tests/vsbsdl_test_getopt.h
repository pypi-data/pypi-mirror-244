...
#if !defined( _VSBSDL_TEST_GETOPT_H )
#define _VSBSDL_TEST_GETOPT_H
...
#define vsbsdl_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t vsbsdl_test_getopt(
                  int argument_count,
...
#endif /* !defined( _VSBSDL_TEST_GETOPT_H ) */
