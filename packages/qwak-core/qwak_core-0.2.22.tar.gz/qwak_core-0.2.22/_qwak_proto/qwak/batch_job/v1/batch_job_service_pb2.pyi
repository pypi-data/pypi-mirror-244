...
class TaskExecutionDetails(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["end_time", b"end_time", "filename", b"filename", "num_of_records", b"num_of_records", "start_time", b"start_time", "status", b"status", "task_id", b"task_id"]) -> None: ...
