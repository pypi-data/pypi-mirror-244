...
"""
    ...
    def test_magic_comment_key_value(self):
        (key, value) = magic_comment_key_value("<!--- div:proof --->")
        self.assertEqual(key, "div")
        self.assertEqual(value, "proof")
        (key, value) = magic_comment_key_value("  \n <!--- div:proof --->  ")
        self.assertEqual(key, "div")
        self.assertEqual(value, "proof")
...
The end."""
        ...
        self.assertEqual(format_divs(md, {"proof": "Proof", "complexity": "Complexity analysis"}), md_expected)
