...
#include "qpywidgets_qaction_helpers.h"
...
void qpywidgets_post_init()
{
    ...
    sipExportSymbol("pyqt6_qaction_menu", (void *)qpywidgets_qaction_menu);
    sipExportSymbol("pyqt6_qaction_set_menu",
            (void *)qpywidgets_qaction_set_menu);
}
