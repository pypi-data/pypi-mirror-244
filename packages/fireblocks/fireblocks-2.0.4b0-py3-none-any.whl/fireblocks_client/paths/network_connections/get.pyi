...
class SchemaFor200ResponseBody(
    ...
    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['NetworkConnectionResponse'], typing.List['NetworkConnectionResponse']],
    ...
    def __getitem__(self, i: int) -> 'NetworkConnectionResponse':
...
class BaseApi(api_client.Api):
    ...
    def _get_network_connections_oapg(self, request_options: RequestOptions = None):
        """
...
class GetNetworkConnections(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def get_network_connections(self , request_options: RequestOptions = None):
        return self._get_network_connections_oapg(request_options)
