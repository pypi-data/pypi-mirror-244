...
class BaseApi(api_client.Api):
    ...
    def _resend_webhooks_oapg(self, request_options: RequestOptions = None):
        """
...
class ResendWebhooks(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def resend_webhooks(self , request_options: RequestOptions = None):
        return self._resend_webhooks_oapg(request_options)


class ApiForpost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names

    def post(self , request_options: RequestOptions = None):
        return self._resend_webhooks_oapg(request_options)
