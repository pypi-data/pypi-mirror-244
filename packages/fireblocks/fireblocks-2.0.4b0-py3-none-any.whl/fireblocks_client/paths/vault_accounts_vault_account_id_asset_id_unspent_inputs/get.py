...
class SchemaFor200ResponseBody(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['UnspentInputsResponse']:
            return UnspentInputsResponse

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['UnspentInputsResponse'], typing.List['UnspentInputsResponse']],
    ...
    def __getitem__(self, i: int) -> 'UnspentInputsResponse':
...
class BaseApi(api_client.Api):
    ...
    def _get_vault_account_asset_unspent_inputs_oapg(self, params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class GetVaultAccountAssetUnspentInputs(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def get_vault_account_asset_unspent_inputs(self , params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        return self._get_vault_account_asset_unspent_inputs_oapg(params, request_options)
