...
SchemaFor200ResponseBody = GasStationPropertiesResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_gas_station_by_asset_id_oapg(self, params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class GetGasStationByAssetId(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def get_gas_station_by_asset_id(self , params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        return self._get_gas_station_by_asset_id_oapg(params, request_options)
