...
class BaseApi(api_client.Api):
    ...
    def _unhide_vault_account_oapg(self, params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class UnhideVaultAccount(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def unhide_vault_account(self , params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        return self._unhide_vault_account_oapg(params, request_options)
