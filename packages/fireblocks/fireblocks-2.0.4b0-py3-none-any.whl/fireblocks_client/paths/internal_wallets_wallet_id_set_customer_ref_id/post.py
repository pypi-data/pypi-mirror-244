...
class BaseApi(api_client.Api):
    ...
    def _set_customer_ref_id_for_internal_wallet_oapg(self, params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class SetCustomerRefIdForInternalWallet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def set_customer_ref_id_for_internal_wallet(self , params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
        return self._set_customer_ref_id_for_internal_wallet_oapg(params, request_options)
