...
request_path_tx_hash = api_client.PathParameter(
    name="txHash",
...
# body param
SchemaForRequestBodyApplicationJson = SetConfirmationsThresholdRequest


request_body_set_confirmations_threshold_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBody = SetConfirmationsThresholdResponse
...
class BaseApi(api_client.Api):
    ...
    def _set_confirmation_threshold_for_transaction_by_hash_oapg(self, params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
        """
        Set confirmation threshold by transaction hash
        """
        path_params = {}
        for parameter in (
            request_path_tx_hash,
        ):
        ...
        _fields = None
        _body = None
        serialized_data = request_body_set_confirmations_threshold_request.serialize(params, "application/json")
...
class SetConfirmationThresholdForTransactionByHash(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def set_confirmation_threshold_for_transaction_by_hash(self , params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
        return self._set_confirmation_threshold_for_transaction_by_hash_oapg(params, request_options)
