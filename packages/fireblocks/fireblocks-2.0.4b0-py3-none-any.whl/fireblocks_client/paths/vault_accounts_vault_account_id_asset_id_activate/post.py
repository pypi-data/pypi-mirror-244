...
class BaseApi(api_client.Api):
    ...
    def _activate_asset_for_vault_account_oapg(self, params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class ActivateAssetForVaultAccount(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def activate_asset_for_vault_account(self , params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        return self._activate_asset_for_vault_account_oapg(params, request_options)
