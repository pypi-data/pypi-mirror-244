...
SchemaFor200ResponseBody = EstimatedTransactionFeeResponse
...
class BaseApi(api_client.Api):
    ...
    def _estimate_transaction_fee_oapg(self, params: typing.Union[SchemaForRequestBodyApplicationJson,] = None, request_options: RequestOptions = None):
        """
...
class EstimateTransactionFee(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def estimate_transaction_fee(self , params: typing.Union[SchemaForRequestBodyApplicationJson,] = None, request_options: RequestOptions = None):
        return self._estimate_transaction_fee_oapg(params, request_options)
