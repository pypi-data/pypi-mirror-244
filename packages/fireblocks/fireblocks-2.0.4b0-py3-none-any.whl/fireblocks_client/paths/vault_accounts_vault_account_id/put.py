...
class BaseApi(api_client.Api):
    ...
    def _update_vault_account_oapg(self, params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class UpdateVaultAccount(BaseApi):
    ...
    def update_vault_account(self , params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
