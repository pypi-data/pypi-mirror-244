...
class BaseApi(api_client.Api):
    ...
    def _delete_internal_wallet_asset_oapg(self, params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class DeleteInternalWalletAsset(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def delete_internal_wallet_asset(self , params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        return self._delete_internal_wallet_asset_oapg(params, request_options)
