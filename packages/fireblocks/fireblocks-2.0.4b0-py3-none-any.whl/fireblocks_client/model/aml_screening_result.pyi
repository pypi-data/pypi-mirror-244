...
class AmlScreeningResult(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["provider", "payload", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["provider", "payload", ], str]):
