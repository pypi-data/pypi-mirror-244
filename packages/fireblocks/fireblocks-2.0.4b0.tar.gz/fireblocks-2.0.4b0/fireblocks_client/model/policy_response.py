...
class PolicyResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["rules", "metadata", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["rules", "metadata", ], str]):
