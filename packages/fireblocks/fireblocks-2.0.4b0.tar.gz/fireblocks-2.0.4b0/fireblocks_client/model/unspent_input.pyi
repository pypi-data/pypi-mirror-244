...
class UnspentInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["txHash", "index", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["txHash", "index", ], str]):
