...
class SetConfirmationsThresholdResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["success", "transactions", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["success", "transactions", ], str]):
