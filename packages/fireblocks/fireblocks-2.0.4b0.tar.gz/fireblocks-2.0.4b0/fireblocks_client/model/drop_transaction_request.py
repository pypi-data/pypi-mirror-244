...
class DropTransactionRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["txId", "feeLevel", "gasPrice", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["txId", "feeLevel", "gasPrice", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        txId: typing.Union[MetaOapg.properties.txId, str, schemas.Unset] = schemas.unset,
