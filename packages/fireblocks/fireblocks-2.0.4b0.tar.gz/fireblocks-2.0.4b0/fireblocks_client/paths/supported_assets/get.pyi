...
class SchemaFor200ResponseBody(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['AssetTypeResponse']:
            return AssetTypeResponse

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['AssetTypeResponse'], typing.List['AssetTypeResponse']],
    ...
    def __getitem__(self, i: int) -> 'AssetTypeResponse':
...
class BaseApi(api_client.Api):
    ...
    def _get_supported_assets_oapg(self, request_options: RequestOptions = None):
        """
...
class GetSupportedAssets(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def get_supported_assets(self , request_options: RequestOptions = None):
        return self._get_supported_assets_oapg(request_options)
