...
class SchemaFor200ResponseBody(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['VaultWalletAddress']:
            return VaultWalletAddress

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['VaultWalletAddress'], typing.List['VaultWalletAddress']],
    ...
    def __getitem__(self, i: int) -> 'VaultWalletAddress':
...
class BaseApi(api_client.Api):
    ...
    def _get_vault_account_asset_addresses_oapg(self, params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        """
        Get asset addresses
        """
        path_params = {}
...
class GetVaultAccountAssetAddresses(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def get_vault_account_asset_addresses(self , params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        return self._get_vault_account_asset_addresses_oapg(params, request_options)
