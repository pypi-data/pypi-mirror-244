...
class BaseApi(api_client.Api):
    ...
    def _get_internal_wallet_asset_oapg(self, params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class GetInternalWalletAsset(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def get_internal_wallet_asset(self , params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        return self._get_internal_wallet_asset_oapg(params, request_options)
