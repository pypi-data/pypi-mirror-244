...
SchemaFor200ResponseBodyApplicationJson = XBSettlementGetFlowResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_xb_settlement_flow_by_id_oapg(self, params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class GetXbSettlementFlowById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def get_xb_settlement_flow_by_id(self , params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        return self._get_xb_settlement_flow_by_id_oapg(params, request_options)
