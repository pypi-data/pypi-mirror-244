...
# Query params
AccountNamePrefixSchema = schemas.StrSchema
AccountNameSuffixSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'accountNamePrefix': typing.Union[AccountNamePrefixSchema, str, ],
        'accountNameSuffix': typing.Union[AccountNameSuffixSchema, str, ],
    },
    total=False
)
...
request_query_account_name_prefix = api_client.QueryParameter(
    name="accountNamePrefix",
    style=api_client.ParameterStyle.FORM,
    schema=AccountNamePrefixSchema,
    explode=True,
)
request_query_account_name_suffix = api_client.QueryParameter(
    name="accountNameSuffix",
    style=api_client.ParameterStyle.FORM,
    schema=AccountNameSuffixSchema,
    explode=True,
)
