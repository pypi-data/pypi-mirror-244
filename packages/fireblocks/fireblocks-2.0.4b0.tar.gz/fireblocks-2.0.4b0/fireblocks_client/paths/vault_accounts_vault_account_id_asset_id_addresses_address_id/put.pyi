...
class BaseApi(api_client.Api):
    ...
    def _update_vault_account_asset_address_oapg(self, params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class UpdateVaultAccountAssetAddress(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def update_vault_account_asset_address(self , params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
        return self._update_vault_account_asset_address_oapg(params, request_options)
