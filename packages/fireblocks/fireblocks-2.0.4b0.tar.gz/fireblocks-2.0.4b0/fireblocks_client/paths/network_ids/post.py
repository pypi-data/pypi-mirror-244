...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "routingPolicy", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "routingPolicy", ], str]):
...
SchemaFor201ResponseBody = NetworkIdResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_network_id_oapg(self, params: typing.Union[SchemaForRequestBodyApplicationJson,] = None, request_options: RequestOptions = None):
        """
...
class CreateNetworkId(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def create_network_id(self , params: typing.Union[SchemaForRequestBodyApplicationJson,] = None, request_options: RequestOptions = None):
        return self._create_network_id_oapg(params, request_options)
