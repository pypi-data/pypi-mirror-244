...
class BaseApi(api_client.Api):
    ...
    def _get_external_wallet_by_id_oapg(self, params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class GetExternalWalletById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def get_external_wallet_by_id(self , params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        return self._get_external_wallet_by_id_oapg(params, request_options)
