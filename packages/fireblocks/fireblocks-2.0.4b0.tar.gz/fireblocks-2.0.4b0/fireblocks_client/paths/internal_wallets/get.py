...
class BaseApi(api_client.Api):
    ...
    def _get_internal_wallets_oapg(self, request_options: RequestOptions = None):
        """
...
class GetInternalWallets(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def get_internal_wallets(self , request_options: RequestOptions = None):
        return self._get_internal_wallets_oapg(request_options)
