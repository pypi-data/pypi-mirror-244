...
SchemaFor200ResponseBody = CancelTransactionResponse
...
class BaseApi(api_client.Api):
    ...
    def _cancel_transaction_oapg(self, params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class CancelTransaction(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def cancel_transaction(self , params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        return self._cancel_transaction_oapg(params, request_options)
