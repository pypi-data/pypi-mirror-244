...
SchemaFor200ResponseBody = UsersGroupsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_user_groups_oapg(self, request_options: RequestOptions = None):
        """
        List users groups
        """
...
class GetUserGroups(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def get_user_groups(self , request_options: RequestOptions = None):
        return self._get_user_groups_oapg(request_options)
