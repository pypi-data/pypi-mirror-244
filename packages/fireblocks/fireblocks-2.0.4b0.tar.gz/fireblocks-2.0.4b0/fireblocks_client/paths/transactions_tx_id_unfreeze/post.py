...
SchemaFor200ResponseBody = UnfreezeTransactionResponse
...
class BaseApi(api_client.Api):
    ...
    def _unfreeze_transaction_oapg(self, params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class UnfreezeTransaction(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def unfreeze_transaction(self , params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        return self._unfreeze_transaction_oapg(params, request_options)
