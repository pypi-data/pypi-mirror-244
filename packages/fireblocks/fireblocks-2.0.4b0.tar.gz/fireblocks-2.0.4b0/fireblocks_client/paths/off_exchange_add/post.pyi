...
class BaseApi(api_client.Api):
    ...
    def _add_off_exchange_oapg(self, params: typing.Union[SchemaForRequestBodyApplicationJson,] = None, request_options: RequestOptions = None):
        """
        add collateral
        """
        ...
        _fields = None
        _body = None
        serialized_data = request_body_add_collateral_request_body.serialize(params, "application/json")
...
class AddOffExchange(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def add_off_exchange(self , params: typing.Union[SchemaForRequestBodyApplicationJson,] = None, request_options: RequestOptions = None):
        return self._add_off_exchange_oapg(params, request_options)
