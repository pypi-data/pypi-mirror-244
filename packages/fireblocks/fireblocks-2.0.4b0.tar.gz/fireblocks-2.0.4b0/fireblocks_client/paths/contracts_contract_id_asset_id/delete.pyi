...
class BaseApi(api_client.Api):
    ...
    def _remove_asset_from_contract_oapg(self, params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class RemoveAssetFromContract(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def remove_asset_from_contract(self , params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        return self._remove_asset_from_contract_oapg(params, request_options)
