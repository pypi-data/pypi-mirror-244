...
class DispatchPayoutResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["payoutId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["payoutId", ], str]):
