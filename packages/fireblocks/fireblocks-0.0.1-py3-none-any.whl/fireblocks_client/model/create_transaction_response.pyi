...
class CreateTransactionResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "status", "systemMessages", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "status", "systemMessages", ], str]):
