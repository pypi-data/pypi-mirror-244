...
class SchemaFor200ResponseBody(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['FiatAccount']:
            return FiatAccount

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['FiatAccount'], typing.List['FiatAccount']],
    ...
    def __getitem__(self, i: int) -> 'FiatAccount':
...
class BaseApi(api_client.Api):
    ...
    def _get_fiat_accounts_oapg(self, request_options: RequestOptions = None):
        """
        List fiat accounts
        """
...
class GetFiatAccounts(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def get_fiat_accounts(self , request_options: RequestOptions = None):
        return self._get_fiat_accounts_oapg(request_options)
