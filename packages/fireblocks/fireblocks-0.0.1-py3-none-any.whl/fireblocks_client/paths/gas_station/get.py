...
class BaseApi(api_client.Api):
    ...
    def _get_gas_station_oapg(self, request_options: RequestOptions = None):
        """
...
class GetGasStation(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def get_gas_station(self , request_options: RequestOptions = None):
        return self._get_gas_station_oapg(request_options)
