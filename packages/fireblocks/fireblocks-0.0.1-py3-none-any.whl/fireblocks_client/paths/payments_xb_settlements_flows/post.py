...
class BaseApi(api_client.Api):
    ...
    def _create_xb_settlement_flow_oapg(self, params: typing.Union[SchemaForRequestBodyApplicationJson,] = None, request_options: RequestOptions = None):
        """
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xb_settlement_create_flow_request_body.serialize(params, "application/json")
...
class CreateXbSettlementFlow(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def create_xb_settlement_flow(self , params: typing.Union[SchemaForRequestBodyApplicationJson,] = None, request_options: RequestOptions = None):
        return self._create_xb_settlement_flow_oapg(params, request_options)
