...
class BaseApi(api_client.Api):
    ...
    def _set_routing_policy_for_network_connection_oapg(self, params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class SetRoutingPolicyForNetworkConnection(BaseApi):
    ...
    def set_routing_policy_for_network_connection(self , params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
