...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["autoFuel", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["autoFuel", ], str]):
...
class BaseApi(api_client.Api):
    ...
    def _set_auto_fuel_for_vault_account_oapg(self, params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class SetAutoFuelForVaultAccount(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def set_auto_fuel_for_vault_account(self , params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
        return self._set_auto_fuel_for_vault_account_oapg(params, request_options)
