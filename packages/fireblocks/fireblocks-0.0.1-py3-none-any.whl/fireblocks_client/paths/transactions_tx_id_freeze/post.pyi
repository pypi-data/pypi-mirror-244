...
SchemaFor200ResponseBody = FreezeTransactionResponse
...
class BaseApi(api_client.Api):
    ...
    def _freeze_transaction_oapg(self, params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class FreezeTransaction(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def freeze_transaction(self , params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        return self._freeze_transaction_oapg(params, request_options)
