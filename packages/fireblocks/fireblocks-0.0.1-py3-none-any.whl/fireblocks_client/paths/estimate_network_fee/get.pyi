...
SchemaFor200ResponseBody = EstimatedNetworkFeeResponse
...
class BaseApi(api_client.Api):
    ...
    def _estimate_network_fee_oapg(self, params: typing.Union[ RequestQueryParams,] = None, request_options: RequestOptions = None):
        """
...
class EstimateNetworkFee(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def estimate_network_fee(self , params: typing.Union[ RequestQueryParams,] = None, request_options: RequestOptions = None):
        return self._estimate_network_fee_oapg(params, request_options)
