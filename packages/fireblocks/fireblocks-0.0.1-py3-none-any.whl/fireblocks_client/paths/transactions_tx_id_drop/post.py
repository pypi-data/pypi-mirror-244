...
# body param
SchemaForRequestBodyApplicationJson = DropTransactionRequest


request_body_drop_transaction_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBody = DropTransactionResponse
...
class BaseApi(api_client.Api):
    ...
    def _drop_transaction_oapg(self, params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
        """
        ...
        _fields = None
        _body = None
        serialized_data = request_body_drop_transaction_request.serialize(params, "application/json")
...
class DropTransaction(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def drop_transaction(self , params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
        return self._drop_transaction_oapg(params, request_options)
