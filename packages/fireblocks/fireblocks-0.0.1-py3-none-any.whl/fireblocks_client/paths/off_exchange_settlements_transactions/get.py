...
# Query params
MainExchangeAccountIdSchema = schemas.StrSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'mainExchangeAccountId': typing.Union[MainExchangeAccountIdSchema, str, ],
    }
)
...
request_query_main_exchange_account_id = api_client.QueryParameter(
    name="mainExchangeAccountId",
    style=api_client.ParameterStyle.FORM,
    schema=MainExchangeAccountIdSchema,
    required=True,
    explode=True,
)
SchemaFor200ResponseBody = SettlementResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_off_exchange_settlement_transactions_oapg(self, params: typing.Union[ RequestQueryParams,] = None, request_options: RequestOptions = None):
        """
        ...
        for parameter in (
            request_query_main_exchange_account_id,
        ):
...
class GetOffExchangeSettlementTransactions(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def get_off_exchange_settlement_transactions(self , params: typing.Union[ RequestQueryParams,] = None, request_options: RequestOptions = None):
        return self._get_off_exchange_settlement_transactions_oapg(params, request_options)
