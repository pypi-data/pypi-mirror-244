...
SchemaFor200ResponseBody = ExchangeAsset
...
class BaseApi(api_client.Api):
    ...
    def _get_exchange_account_asset_oapg(self, params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class GetExchangeAccountAsset(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def get_exchange_account_asset(self , params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        return self._get_exchange_account_asset_oapg(params, request_options)
