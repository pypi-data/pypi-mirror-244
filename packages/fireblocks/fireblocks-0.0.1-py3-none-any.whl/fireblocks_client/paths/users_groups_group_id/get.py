...
class BaseApi(api_client.Api):
    ...
    def _get_user_group_oapg(self, params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        """
        Get users group
        """
        path_params = {}
...
class GetUserGroup(BaseApi):
    ...
    def get_user_group(self , params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        return self._get_user_group_oapg(params, request_options)
