...
class BaseApi(api_client.Api):
    ...
    def _publish_policy_rules_oapg(self, params: typing.Union[SchemaForRequestBodyApplicationJson,] = None, request_options: RequestOptions = None):
        """
...
class PublishPolicyRules(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def publish_policy_rules(self , params: typing.Union[SchemaForRequestBodyApplicationJson,] = None, request_options: RequestOptions = None):
        return self._publish_policy_rules_oapg(params, request_options)
