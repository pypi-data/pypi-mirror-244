...
class SchemaForRequestBodyApplicationJson(
    ...
    isDiscoverable: MetaOapg.properties.isDiscoverable
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["isDiscoverable", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["isDiscoverable"]) -> MetaOapg.properties.isDiscoverable: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["isDiscoverable", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        isDiscoverable: typing.Union[MetaOapg.properties.isDiscoverable, bool, ],
...
class BaseApi(api_client.Api):
    ...
    def _set_discoverability_for_network_id_oapg(self, params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class SetDiscoverabilityForNetworkId(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def set_discoverability_for_network_id(self , params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
        return self._set_discoverability_for_network_id_oapg(params, request_options)
