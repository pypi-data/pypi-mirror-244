...
class BaseApi(api_client.Api):
    ...
    def _get_asset_in_contract_oapg(self, params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class GetAssetInContract(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def get_asset_in_contract(self , params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        return self._get_asset_in_contract_oapg(params, request_options)
