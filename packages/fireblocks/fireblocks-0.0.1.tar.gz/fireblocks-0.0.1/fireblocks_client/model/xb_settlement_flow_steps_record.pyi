...
class XBSettlementFlowStepsRecord(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        @staticmethod
        def additional_properties() -> typing.Type['XBSettlementFlowSetupStep']:
    ...
    @typing.overload
    def __getitem__(self, name: str) -> 'XBSettlementFlowSetupStep': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union['XBSettlementFlowSetupStep', schemas.Unset]: ...
    ...
    def __new__(
        ...
        **kwargs: 'XBSettlementFlowSetupStep',
