...
class BaseApi(api_client.Api):
    ...
    def _add_asset_to_contract_oapg(self, params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class AddAssetToContract(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def add_asset_to_contract(self , params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
        return self._add_asset_to_contract_oapg(params, request_options)
