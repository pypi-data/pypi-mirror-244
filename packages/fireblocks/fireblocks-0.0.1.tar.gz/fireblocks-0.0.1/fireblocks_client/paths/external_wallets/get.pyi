...
class BaseApi(api_client.Api):
    ...
    def _get_external_wallets_oapg(self, request_options: RequestOptions = None):
        """
...
class GetExternalWallets(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def get_external_wallets(self , request_options: RequestOptions = None):
        return self._get_external_wallets_oapg(request_options)
