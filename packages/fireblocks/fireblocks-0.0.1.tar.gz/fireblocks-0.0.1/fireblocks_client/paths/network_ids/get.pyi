...
class BaseApi(api_client.Api):
    ...
    def _get_network_ids_oapg(self, request_options: RequestOptions = None):
        """
...
class GetNetworkIds(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def get_network_ids(self , request_options: RequestOptions = None):
        return self._get_network_ids_oapg(request_options)
