...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["eosAccountName", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["eosAccountName", ], str]):
...
SchemaFor200ResponseBody = CreateVaultAssetResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_vault_account_asset_oapg(self, params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
        """
        Create a new wallet
        """
        path_params = {}
...
class CreateVaultAccountAsset(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def create_vault_account_asset(self , params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
        return self._create_vault_account_asset_oapg(params, request_options)
