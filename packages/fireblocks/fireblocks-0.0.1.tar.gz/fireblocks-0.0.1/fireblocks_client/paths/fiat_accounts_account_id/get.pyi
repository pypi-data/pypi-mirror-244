...
SchemaFor200ResponseBody = FiatAccount
...
class BaseApi(api_client.Api):
    ...
    def _get_fiat_account_by_id_oapg(self, params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class GetFiatAccountById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def get_fiat_account_by_id(self , params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        return self._get_fiat_account_by_id_oapg(params, request_options)
