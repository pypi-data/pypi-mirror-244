...
# Path params
ExternalTxIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'externalTxId': typing.Union[ExternalTxIdSchema, str, ],
    }
)
...
request_path_external_tx_id = api_client.PathParameter(
    name="externalTxId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ExternalTxIdSchema,
    required=True,
)
XRequestIDSchema = schemas.StrSchema
SchemaFor200ResponseBody = TransactionResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_transaction_by_external_id_oapg(self, params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        """
        Find a specific transaction by external transaction ID
        """
        path_params = {}
        for parameter in (
            request_path_external_tx_id,
        ):
...
class GetTransactionByExternalId(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def get_transaction_by_external_id(self , params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        return self._get_transaction_by_external_id_oapg(params, request_options)
