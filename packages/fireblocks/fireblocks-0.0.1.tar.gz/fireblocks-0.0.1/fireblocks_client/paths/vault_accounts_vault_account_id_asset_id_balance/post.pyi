...
class BaseApi(api_client.Api):
    ...
    def _update_vault_account_asset_balance_oapg(self, params: typing.Union[SchemaForRequestBody, RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class UpdateVaultAccountAssetBalance(BaseApi):
    ...
    def update_vault_account_asset_balance(self , params: typing.Union[SchemaForRequestBody, RequestPathParams] = None, request_options: RequestOptions = None):
...
class ApiForpost(BaseApi):
    ...
    def post(self , params: typing.Union[SchemaForRequestBody, RequestPathParams] = None, request_options: RequestOptions = None):
        return self._update_vault_account_asset_balance_oapg(params, request_options)
