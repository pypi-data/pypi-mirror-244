...
class BaseApi(api_client.Api):
    ...
    def _delete_network_id_oapg(self, params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class DeleteNetworkId(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def delete_network_id(self , params: typing.Union[ RequestPathParams] = None, request_options: RequestOptions = None):
        return self._delete_network_id_oapg(params, request_options)
