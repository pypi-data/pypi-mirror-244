...
class BaseApi(api_client.Api):
    ...
    def _set_customer_ref_id_for_vault_account_oapg(self, params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class SetCustomerRefIdForVaultAccount(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def set_customer_ref_id_for_vault_account(self , params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
        return self._set_customer_ref_id_for_vault_account_oapg(params, request_options)
