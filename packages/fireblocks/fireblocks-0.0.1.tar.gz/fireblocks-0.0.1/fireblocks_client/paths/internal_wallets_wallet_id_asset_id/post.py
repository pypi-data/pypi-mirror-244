...
SchemaFor200ResponseBody = WalletAsset
...
class BaseApi(api_client.Api):
    ...
    def _create_internal_wallet_asset_oapg(self, params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class CreateInternalWalletAsset(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def create_internal_wallet_asset(self , params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
        return self._create_internal_wallet_asset_oapg(params, request_options)
