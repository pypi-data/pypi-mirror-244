...
class BaseApi(api_client.Api):
    ...
    def _redeem_funds_to_linked_dda_oapg(self, params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
        """
        Redeem funds to DDA
        """
        path_params = {}
...
class RedeemFundsToLinkedDda(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def redeem_funds_to_linked_dda(self , params: typing.Union[SchemaForRequestBodyApplicationJson, RequestPathParams] = None, request_options: RequestOptions = None):
        return self._redeem_funds_to_linked_dda_oapg(params, request_options)
