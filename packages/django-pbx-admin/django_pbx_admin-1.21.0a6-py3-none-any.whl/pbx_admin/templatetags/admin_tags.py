...
def fieldset(context, fieldset, form=None, formset=None, nested_list=None):
    # TODO sprawdzić sygnature czy opcjonalne są gdzie uzywane
    from pbx_admin.render_fields import RenderField
    ...
    if nested_list:
        ...
        # todo może to nazwać inaczej niż nested_fields, np render_fields,
        # tylko trzeba wszędzie zmienić
        # teraz nie można przełądować RenderFielda dla nested fieldsów
