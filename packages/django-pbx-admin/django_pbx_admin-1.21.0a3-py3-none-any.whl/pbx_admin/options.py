...
class ModelAdmin:
    ...
    def get_list_display(self, request=None, fields=None):
        fields_names = fields or self.list_display
        return [RenderField(field_name=field_name, admin=self) for field_name in fields_names]
