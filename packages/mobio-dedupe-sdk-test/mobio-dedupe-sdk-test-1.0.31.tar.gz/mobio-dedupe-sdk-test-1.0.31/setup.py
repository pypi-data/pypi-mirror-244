...
class Requirements(object):
    ...
    def get():
        ...
        requirements = ['m-singleton', 'asv', 'black', 'coverage[toml]', 'coveralls', 'flake8', 'mock', 'mypy',
                        ...
                        'dedupe-Levenshtein-search==1.4.5', 'pylbfgs',
                        ...
                        'python-dateutil==2.8.2', 'scikit-learn==1.2.2', 'scipy==1.10.1',
    ...
    def get_link():
        ...
        :return:
        """
        requirements = ['git+https://github.com/fzimmermann89/pylbfgs.git@fzimmermann89-cython#egg=pylbfgs']
        return requirements


version_dev='1.0.31'  # Giữ nguyên định dạng không được format file có khoảng trống theo Pycharm (version_dev = '1.0.9' là file run.sh sẽ không bắt được current_version)
...
setup(
    ...
    version='1.0.31',  # Required, Phần này cũng không được format file.
