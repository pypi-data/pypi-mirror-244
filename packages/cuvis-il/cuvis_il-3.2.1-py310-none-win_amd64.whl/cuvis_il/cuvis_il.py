...
class cuvis_mesu_metadata_t(object):
    ...
    distance = property(_cuvis_pyil.cuvis_mesu_metadata_t_distance_get, _cuvis_pyil.cuvis_mesu_metadata_t_distance_set)
...
class cuvis_export_general_settings_t(object):
    ...
    blend_opacity = property(_cuvis_pyil.cuvis_export_general_settings_t_blend_opacity_get, _cuvis_pyil.cuvis_export_general_settings_t_blend_opacity_set)
...
class cuvis_viewer_settings_t(object):
    ...
    blend_opacity = property(_cuvis_pyil.cuvis_viewer_settings_t_blend_opacity_get, _cuvis_pyil.cuvis_viewer_settings_t_blend_opacity_set)
...
class cuvis_worker_settings_t(object):
    ...
    worker_queue_hard_limit = property(_cuvis_pyil.cuvis_worker_settings_t_worker_queue_hard_limit_get, _cuvis_pyil.cuvis_worker_settings_t_worker_queue_hard_limit_set)
    worker_queue_soft_limit = property(_cuvis_pyil.cuvis_worker_settings_t_worker_queue_soft_limit_get, _cuvis_pyil.cuvis_worker_settings_t_worker_queue_soft_limit_set)
    can_drop = property(_cuvis_pyil.cuvis_worker_settings_t_can_drop_get, _cuvis_pyil.cuvis_worker_settings_t_can_drop_set)
...
def cuvis_worker_set_session_file(i_worker, i_session_file, i_SkipDroppedFrames):
    return _cuvis_pyil.cuvis_worker_set_session_file(i_worker, i_session_file, i_SkipDroppedFrames)

def cuvis_worker_ingest_mesu(i_worker, i_mesu):
    return _cuvis_pyil.cuvis_worker_ingest_mesu(i_worker, i_mesu)

def cuvis_worker_query_session_progress(i_worker, o_frames_read, o_frames_total):
    return _cuvis_pyil.cuvis_worker_query_session_progress(i_worker, o_frames_read, o_frames_total)
...
def cuvis_worker_get_queue_limits(i_worker, o_pHardLimit, o_pSoftLimit):
    return _cuvis_pyil.cuvis_worker_get_queue_limits(i_worker, o_pHardLimit, o_pSoftLimit)
...
def cuvis_worker_set_queue_limits(i_worker, i_HardLimit, i_SoftLimit):
    return _cuvis_pyil.cuvis_worker_set_queue_limits(i_worker, i_HardLimit, i_SoftLimit)

def cuvis_worker_set_drop_behavior(i_worker, i_CanDrop):
    return _cuvis_pyil.cuvis_worker_set_drop_behavior(i_worker, i_CanDrop)

def cuvis_worker_get_drop_behavior(i_worker, o_pCanDrop):
    return _cuvis_pyil.cuvis_worker_get_drop_behavior(i_worker, o_pCanDrop)
