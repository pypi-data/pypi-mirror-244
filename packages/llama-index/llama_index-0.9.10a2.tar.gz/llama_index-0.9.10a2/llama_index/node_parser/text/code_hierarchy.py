...
from llama_index.node_parser.text.code_hierarchy_utils import (
    _COMMENT_OPTIONS,
        ...
        **kwargs: Any,
        ...
        for node in nodes_with_progress:
            ...
            if (
                ...
                # Chunk the code
                _chunks = self._chunk_node(tree.root_node, text)
                ...
                if self.code_splitter:
                    ...
                    for original_node in chunks:
                        ...
                        for i, new_split_node in enumerate(new_split_nodes[:-1]):
                            new_split_node.set_content(
                                (
                                    new_split_node.get_content(
