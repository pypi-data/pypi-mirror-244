...
__all__ = ['guard', 'tset', 'tlist', 'tdict', 'ttype', 'ttuple', 'tunion', 'tliteral', 'tgeneric', 'tclassvar', 'eqtype',
           'eqlist', 'eqtuple', 'equnion', 'eqliteral', 'checknan', 'trychecks', 'tryiter', 'isstrbytes', 'notstrbytes',
           'isstrq', 'notiterstr', 'isallsame', 'aliascheck']
...
def aliascheck(obj, types, attrs: dict = dict()):
    ...
    '''
    found = False
    comps = [lambda t: f(obj, t) for f in (isinstance, eqlist, eqtuple, equnion, eqliteral)]
