...
class Requirements(object):
    ...
    def get():
        ...
        :return:
        """
        requirements = ["marshmallow>=3.6.0", "python-dateutil>=2.8.2", "pytz>=2021.1", "phonenumbers>=8.12.53", "m-singleton>=0.3", "requests>=2.31.0", "m-caching>=0.1.14", "mobio-admin-sdk>=1.0.6"]
        return requirements
