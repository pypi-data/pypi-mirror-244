...
from mobio.libs.profiling_mf.profiling_data.job_data import df_get_job_data


class MergeJob(BaseMerge):
    def serialize_data(
        self,
        suggest_data,
        profile_data,
    ...
    def merge_data(self, target_data, source_data, is_master_data=False):
        if source_data:
            ...
            if suggest and value is not None:
                ...
                if job:
                    target_data[self.field_key] = job
