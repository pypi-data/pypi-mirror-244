...
class HTTPClient(DownloadFromBase):
    ...
    def __init__(
        ...
        self.use_async: bool = kwargs.pop('use_async', False)
        self._proxies: list = []
    ...
    async def async_request(self, url, method: str = 'GET', data: dict = None):
        """
        async_request.
    ...
    async def request(self, url, method: str = 'GET', data: dict = None):
        """
        request.
            connect to an http source using python requests.
        """
        result = []
        error = {}
        auth = None
