...
class DvpCatStats(Component):
    """A DvpCatStats component.
...
- variable (string; optional):
    ...
    _type = 'DvpCatStats'
    @_explicitize_args
    def __init__(self, data=Component.UNDEFINED, variable=Component.UNDEFINED, groupBy=Component.UNDEFINED, missingValues=Component.UNDEFINED, id=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, alias=Component.UNDEFINED, labels=Component.UNDEFINED, pagination=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'alias', 'className', 'data', 'groupBy', 'labels', 'missingValues', 'pagination', 'style', 'variable']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'alias', 'className', 'data', 'groupBy', 'labels', 'missingValues', 'pagination', 'style', 'variable']
        ...
        super(DvpCatStats, self).__init__(**args)
