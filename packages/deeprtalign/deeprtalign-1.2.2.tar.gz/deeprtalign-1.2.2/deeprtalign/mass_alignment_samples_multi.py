...
def mass_alignment(mass_folder,file,result_folder,total_fraction_number,total_sample_number,max_mz,max_time,max_log_intensity,percent,done_mass_folder,max_sample_number):
...
def run_alignment(processing_number,max_mz,max_time,max_log_intensity,percent,max_sample_number):
