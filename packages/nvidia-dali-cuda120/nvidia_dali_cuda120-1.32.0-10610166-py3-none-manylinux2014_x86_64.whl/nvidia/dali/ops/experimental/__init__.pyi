...
class AudioResample:
    ...
    .. warning::
       ...
       This operator is now deprecated. Use :meth:`AudioResample` instead.
    ...
    def __init__(
        ...
        *,
        ...
        in_rate: Union[DataNode, float, None] = None,
        out_length: Union[DataNode, int, None] = None,
        out_rate: Union[DataNode, float, None] = None,
        preserve: Union[bool, None] = False,
        quality: Union[float, None] = 50.0,
        scale: Union[DataNode, float, None] = None,
...
class Debayer:
    ...
    def __init__(
        ...
        /,
        *,
        blue_position: Union[DataNode, Sequence[int], int, None] = None,
    ...
    def __call__(
        ...
        *,
        ...
        Args
        ----
        `data` : TensorList ('HW', 'HWC', 'FHW', 'FHWC')
...
class Equalize:
    ...
    def __call__(
        ...
        *,
        ...
        Args
        ----
        `data` : TensorList ('HW', 'HWC', 'CHW', 'FHW', 'FHWC', 'FCHW')
            Input to the operator.
...
class Filter:
    ...
    def __init__(
        ...
        /,
        *,
        anchor: Union[DataNode, Sequence[int], int, None] = [-1],
    ...
    def __call__(
        ...
        __data: DataNode,
        __filter: DataNode,
        __fill_value: Union[DataNode, None] = None,
        /,
        *,
        anchor: Union[DataNode, Sequence[int], int, None] = [-1],
        border: Union[str, None] = "reflect_101",
...
class Inflate:
    ...
    def __init__(
        ...
        /,
        *,
        shape: Union[DataNode, Sequence[int], int, None] = None,
        algorithm: Union[str, None] = "LZ4",
        bytes_per_sample_hint: Union[Sequence[int], int, None] = [0],
        chunk_offsets: Union[DataNode, Sequence[int], int, None] = None,
        chunk_sizes: Union[DataNode, Sequence[int], int, None] = None,
        dtype: Union[DALIDataType, None] = DALIDataType.UINT8,
        layout: Union[str, None] = "",
        preserve: Union[bool, None] = False,
        seed: Union[int, None] = -1,
        sequence_axis_name: Union[str, None] = "F",
        device: Union[str, None] = None,
        name: Union[str, None] = None,
    ) -> None: ...
    def __call__(
...
class MedianBlur:
    ...
    def __init__(
        ...
        *,
        ...
        preserve: Union[bool, None] = False,
        seed: Union[int, None] = -1,
        window_size: Union[DataNode, Sequence[int], int, None] = [3, 3],
        device: Union[str, None] = None,
        name: Union[str, None] = None,
    ) -> None: ...
    def __call__(
        ...
        *,
        ...
        Args
        ----
        `input` : TensorList ('HWC', 'FHWC', 'CHW', 'FCHW')
...
class TensorResize:
    ...
    def __init__(
        ...
        /,
        *,
        alignment: Union[DataNode, Sequence[float], float, None] = [0.5],
        antialias: Union[bool, None] = True,
        axes: Union[Sequence[int], int, None] = None,
        axis_names: Union[str, None] = None,
        bytes_per_sample_hint: Union[Sequence[int], int, None] = [0],
        dtype: Union[DALIDataType, None] = None,
        interp_type: Union[DataNode, DALIInterpType, None] = DALIInterpType.INTERP_LINEAR,
        mag_filter: Union[DataNode, DALIInterpType, None] = DALIInterpType.INTERP_LINEAR,
        max_size: Union[Sequence[float], float, None] = None,
        min_filter: Union[DataNode, DALIInterpType, None] = DALIInterpType.INTERP_LINEAR,
        minibatch_size: Union[int, None] = 32,
        mode: Union[str, None] = "default",
        preserve: Union[bool, None] = False,
        roi_end: Union[DataNode, Sequence[float], float, None] = None,
        roi_relative: Union[bool, None] = False,
        roi_start: Union[DataNode, Sequence[float], float, None] = None,
        scales: Union[DataNode, Sequence[float], float, None] = None,
        seed: Union[int, None] = -1,
        size_rounding: Union[str, None] = "round",
        sizes: Union[DataNode, Sequence[float], float, None] = None,
