...
class TestAlbums(unittest.TestCase):
    ...
    def test_date_formatting(self):
        ...
        album_profile = export.Album.get_profile('https://www.metal-archives.com/albums/Panopticon/The_Rime_of_Memory/1163524')
    ...
    def test_release_date_formatting(self):
        ...
        releases = export.Album.get_range(datetime(2023, 11, 29), datetime(2023, 11, 29))
    ...
    def test_release_fields(self):
        ...
        releases = export.Album.get_range(date.today(), date.today() + timedelta(days=2), 
                                          verbose=True)
    ...
    def test_release_report(self):
        ...
        releases = metalarchivist.get_albums(date.today(), date.today() + timedelta(days=2), 
                                             verbose=True)
