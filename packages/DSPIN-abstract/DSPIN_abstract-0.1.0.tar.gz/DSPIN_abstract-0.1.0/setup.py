...
version = "0.1.0"  # You can manage versioning in a more sophisticated way if needed
...
setup(
    name="DSPIN_abstract",
    version=version,
    description="Short description of DSPIN-abstract",
    author="Your Name",
    ...
    url="https://github.com/YingyGong/DSPIN-abstract",  # Replace with your repository URL
    download_url="https://github.com/YingyGong/DSPIN-abstract/archive/v{}.tar.gz".format(
        version
    ),
    keywords=[
        "keyword1",
