...
import lfpreviewer.thread as thread
import lfpreviewer.files as files
import lfpreviewer.xutil as xutil
import lfpreviewer.parser as parser
import lfpreviewer.ui as ui
import lfpreviewer.batch as batch
import lfpreviewer.action as action
import lfpreviewer.tmux_util as tmux_util
import lfpreviewer.geometry as geometry
import lfpreviewer.loading as loading
import lfpreviewer.X as X
...
def setup_tmux_hooks():
    ...
    lock_directory_path = pathlib.PosixPath(tempfile.gettempdir()) / 'lfpreviewer'
    lock_file_path = lock_directory_path / tmux_util.get_session_id()
    own_pid = str(os.getpid())
    command_template = 'lfpreviewer query_windows '
