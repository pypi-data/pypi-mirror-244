    ...
    def _add_parser_arguments(self):  # pylint: disable=too-many-statements
        ...
        self.parser.add_argument(
            *CLI_ARGUMENTS[DELETE_JOB],
            action="store_true",
            help="Delete job records and job files from Fovus for a job or list of jobs. Requires one of the following parameter: "
        ...
        self.parser.add_argument(
            *CLI_ARGUMENTS[POST_PROCESSING_WALLTIME_HOURS],
            ...
            help="The maximum time each task is allowed to run Post Processing Task. A task will be terminated without a condition "
            + "once the walltime timer expires. Format: Real (e.g., 1.5). Range: >0. "
            + USED_FOR_OVERRIDING_JOB_CONFIG_VALUES,
        )
        ...
        self.parser.add_argument(
            *CLI_ARGUMENTS[POST_PROCESSING_RUN_COMMAND],
            ...
            help="Specify the command lines to launch post processing task. The same command lines will be executed under the "
        ...
        self.parser.add_argument(
            *CLI_ARGUMENTS[POST_PROCESSING_TASK_NAME],
            ...
            help="Specify the folder name of post processing task. "
            + USED_FOR_OVERRIDING_JOB_CONFIG_VALUES,
        )
