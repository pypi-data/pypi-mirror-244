...
class ModelInference(BaseModelInference):
    ...
    **Example**
    ...
    def __init__(self,
        ...
        elif self.model_id is None and self.deployment_id is None:
            raise InvalidMultipleArguments(params_names_list=["model_id", "deployment_id"],
        ...
        if credentials:
            self._client = APIClient(credentials, verify=verify)  # TODO: Is the self_client needed here?
        elif api_client:
