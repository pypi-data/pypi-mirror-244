...
def pre_init(self, *, is_new_object: bool, kwargs: dict[str, Any]) -> None:  # type: ignore[no-untyped-def]  # noqa: ARG001
    ...
    from amsdal_framework.contrib.auth.errors import AuthenticationError
    from amsdal_framework.contrib.auth.settings import auth_settings
