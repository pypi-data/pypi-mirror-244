...
class AuthAppConfig(AppConfig):
    def on_ready(self) -> None:
        from amsdal_framework.contrib.auth.lifecycle.consumer import AuthenticateUserConsumer
        from amsdal_framework.contrib.auth.lifecycle.consumer import CheckAndCreateSuperUserConsumer
        from amsdal_framework.contrib.auth.lifecycle.consumer import CheckPermissionConsumer
