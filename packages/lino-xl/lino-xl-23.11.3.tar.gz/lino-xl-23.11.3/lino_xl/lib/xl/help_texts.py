...
(auto_type ) has changed."""),
    'lino_xl.lib.cal.Event._get_calendar' : _("""Returns the Calendar which contains this entry, or
...
item for which it was called."""),
    ...
    'lino_xl.lib.google.GoogleCalendarSynchronized.modified' : _("""Keeps the timestamp of the last modification of the
Calendar as an entry."""),
...
that are not stored in Google or should be updated."""),
    'lino_xl.lib.google.GoogleCalendarSynchronized.delete_google_calendar' : _("""This method deletes a Calendar at
...
which are not stored in Google or should be updated."""),
    ...
    'lino_xl.lib.google.GoogleCalendarEventSynchronized.insert_or_update_google_event' : _("""Inserts or updates a calendar entry and related
Room and Guest 's."""),
    'lino_xl.lib.google.GoogleContactSynchronized' : _("""A subclass of GoogleSynchronized."""),
    'lino_xl.lib.google.GoogleContactSynchronized.delete_google_contact' : _("""This method deletes a Contact at sync time
...
subscription is the primary calendar for the user in Google."""),
    ...
    'lino_xl.lib.google.DeletedEntry' : _("""Keeps a record of the natively deleted Calendar or Event for
...
an Event."""),
    'lino_xl.lib.google.DeletedEntry.event_id' : _("""Takes the value of the Event.google_id when the deleted record is an
Event otherwise an empty string."""),
    ...
    'lino_xl.lib.google.DeletedContact' : _("""Keeps meta information of a deleted contact to sync with google upon next
synchronization."""),
    ...
    'lino_xl.lib.google.FailedForeignItem.item_class' : _("""A ForeignKey pointing to the related database model (contenttypes.ContentType)
specifying the item synchronization class."""),
    ...
    'lino_xl.lib.google.FailedEntries.calendars' : _("""Contains reference to the Calendar
instance(s) that failed to sync with Google."""),
    'lino_xl.lib.google.FailedEntries.events' : _("""Contains reference to the Event
instance(s) that failed to sync with Google."""),
    'lino_xl.lib.google.FailedEntries.contacts' : _("""Contains reference to the Contact instance(s) that failed to
sync with Google."""),
    ...
    'lino_xl.lib.google.Synchronizer._failed_entries' : _("""Keeps reference to the database objects that failed to sync with google
from the last sync() call."""),
    'lino_xl.lib.google.Synchronizer.failed_entries' : _("""Keeps reference to the database objects that failed to sync with google
in the running sync() call."""),
    'lino_xl.lib.google.Synchronizer.user' : _("""The User, whose records should be
synchronized."""),
