...
if __name__ == '__main__':
    # 更新
    results = BigMomStrategy("20231020", "20231031").update_portfolio(
        "20231031", "20231031")
    ...
    # save_30_minutes_data_to_csv(weight, "20230920", "20231025")
    # calc_signal_matrix(weight, "20200720", "20231025", type="monthly")