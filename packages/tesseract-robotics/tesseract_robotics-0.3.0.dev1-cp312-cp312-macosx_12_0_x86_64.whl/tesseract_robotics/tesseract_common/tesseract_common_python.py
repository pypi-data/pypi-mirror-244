...
@_swig_add_metaclass(_SwigNonDynamicMeta)
class PluginInfoContainer(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __setattr__ = _swig_setattr_nondynamic_instance_variable(object.__setattr__)
    __repr__ = _swig_repr
...
@_swig_add_metaclass(_SwigNonDynamicMeta)
class KinematicsPluginInfo(object):
...
@_swig_add_metaclass(_SwigNonDynamicMeta)
class ContactManagersPluginInfo(object):
...
@_swig_add_metaclass(_SwigNonDynamicMeta)
class TaskComposerPluginInfo(object):
    r""" The task composer plugin information structure"""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __setattr__ = _swig_setattr_nondynamic_instance_variable(object.__setattr__)
    __repr__ = _swig_repr
    search_paths = property(_tesseract_common_python.TaskComposerPluginInfo_search_paths_get, _tesseract_common_python.TaskComposerPluginInfo_search_paths_set, doc=r""" A list of paths to search for plugins""")
    search_libraries = property(_tesseract_common_python.TaskComposerPluginInfo_search_libraries_get, _tesseract_common_python.TaskComposerPluginInfo_search_libraries_set, doc=r""" A list of library names without the prefix or suffix that contain plugins""")
    executor_plugin_infos = property(_tesseract_common_python.TaskComposerPluginInfo_executor_plugin_infos_get, _tesseract_common_python.TaskComposerPluginInfo_executor_plugin_infos_set, doc=r""" A map of name to task composer executor plugin information""")
    task_plugin_infos = property(_tesseract_common_python.TaskComposerPluginInfo_task_plugin_infos_get, _tesseract_common_python.TaskComposerPluginInfo_task_plugin_infos_set, doc=r""" A map of name to task composer task plugin information""")

    def insert(self, other):
        r""" Insert the content of an other TaskComposerPluginInfo"""
        return _tesseract_common_python.TaskComposerPluginInfo_insert(self, other)

    def clear(self):
        r""" Clear the contents"""
        return _tesseract_common_python.TaskComposerPluginInfo_clear(self)

    def empty(self):
        r""" Check if structure is empty"""
        return _tesseract_common_python.TaskComposerPluginInfo_empty(self)

    def __eq__(self, rhs):
        return _tesseract_common_python.TaskComposerPluginInfo___eq__(self, rhs)

    def __ne__(self, rhs):
        return _tesseract_common_python.TaskComposerPluginInfo___ne__(self, rhs)

    def __init__(self):
        _tesseract_common_python.TaskComposerPluginInfo_swiginit(self, _tesseract_common_python.new_TaskComposerPluginInfo())
    __swig_destroy__ = _tesseract_common_python.delete_TaskComposerPluginInfo

# Register TaskComposerPluginInfo in _tesseract_common_python:
_tesseract_common_python.TaskComposerPluginInfo_swigregister(TaskComposerPluginInfo)
@_swig_add_metaclass(_SwigNonDynamicMeta)
...
def isWithinPositionLimits(joint_positions, position_limits):
    r"""
...
def satisfiesPositionLimits(*args):
    r"""
    *Overload 1:*
