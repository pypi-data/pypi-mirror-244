...
if TYPE_CHECKING:
    ...
    from ..models.update_flow_json_body_value_modules_item_suspend_user_groups_required_type_0 import (
        UpdateFlowJsonBodyValueModulesItemSuspendUserGroupsRequiredType0,
    )
    from ..models.update_flow_json_body_value_modules_item_suspend_user_groups_required_type_1 import (
        UpdateFlowJsonBodyValueModulesItemSuspendUserGroupsRequiredType1,
    )
...
class UpdateFlowJsonBodyValueModulesItemSuspend:
    ...
    Attributes:
        ...
        user_groups_required (Union['UpdateFlowJsonBodyValueModulesItemSuspendUserGroupsRequiredType0',
            'UpdateFlowJsonBodyValueModulesItemSuspendUserGroupsRequiredType1', Unset]):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.user_groups_required, UpdateFlowJsonBodyValueModulesItemSuspendUserGroupsRequiredType0):
            user_groups_required = UNSET
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, UpdateFlowJsonBodyValueModulesItemSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        UpdateFlowJsonBodyValueModulesItemSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[Unset, UpdateFlowJsonBodyValueModulesItemSuspendUserGroupsRequiredType1]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    UpdateFlowJsonBodyValueModulesItemSuspendUserGroupsRequiredType1.from_dict(
