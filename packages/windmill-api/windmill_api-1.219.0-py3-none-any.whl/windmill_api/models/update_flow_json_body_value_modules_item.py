...
if TYPE_CHECKING:
    ...
    from ..models.update_flow_json_body_value_modules_item_sleep_type_0 import (
        UpdateFlowJsonBodyValueModulesItemSleepType0,
    )
    from ..models.update_flow_json_body_value_modules_item_sleep_type_1 import (
...
class UpdateFlowJsonBodyValueModulesItem:
    ...
    Attributes:
        ...
        sleep (Union['UpdateFlowJsonBodyValueModulesItemSleepType0', 'UpdateFlowJsonBodyValueModulesItemSleepType1',
            Unset]):
    ...
    sleep: Union[
        "UpdateFlowJsonBodyValueModulesItemSleepType0", "UpdateFlowJsonBodyValueModulesItemSleepType1", Unset
    ] = UNSET
