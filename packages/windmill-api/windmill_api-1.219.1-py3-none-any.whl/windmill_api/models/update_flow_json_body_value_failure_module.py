...
class UpdateFlowJsonBodyValueFailureModule:
    ...
    Attributes:
        ...
        sleep (Union['UpdateFlowJsonBodyValueFailureModuleSleepType0', 'UpdateFlowJsonBodyValueFailureModuleSleepType1',
            Unset]):
    ...
    sleep: Union[
        "UpdateFlowJsonBodyValueFailureModuleSleepType0", "UpdateFlowJsonBodyValueFailureModuleSleepType1", Unset
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        from ..models.update_flow_json_body_value_failure_module_suspend import (
            UpdateFlowJsonBodyValueFailureModuleSuspend,
        )
