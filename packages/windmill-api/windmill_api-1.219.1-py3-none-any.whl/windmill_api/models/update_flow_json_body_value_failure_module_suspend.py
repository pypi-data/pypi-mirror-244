...
if TYPE_CHECKING:
    ...
    from ..models.update_flow_json_body_value_failure_module_suspend_user_groups_required_type_0 import (
        UpdateFlowJsonBodyValueFailureModuleSuspendUserGroupsRequiredType0,
    )
    from ..models.update_flow_json_body_value_failure_module_suspend_user_groups_required_type_1 import (
        UpdateFlowJsonBodyValueFailureModuleSuspendUserGroupsRequiredType1,
    )
...
class UpdateFlowJsonBodyValueFailureModuleSuspend:
    ...
    Attributes:
        ...
        user_groups_required (Union['UpdateFlowJsonBodyValueFailureModuleSuspendUserGroupsRequiredType0',
            'UpdateFlowJsonBodyValueFailureModuleSuspendUserGroupsRequiredType1', Unset]):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.user_groups_required, UpdateFlowJsonBodyValueFailureModuleSuspendUserGroupsRequiredType0):
            user_groups_required = UNSET
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, UpdateFlowJsonBodyValueFailureModuleSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        UpdateFlowJsonBodyValueFailureModuleSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, UpdateFlowJsonBodyValueFailureModuleSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    UpdateFlowJsonBodyValueFailureModuleSuspendUserGroupsRequiredType1.from_dict(
