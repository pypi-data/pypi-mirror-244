...
from GANs.PacCGAN import PacCGAN
    ...
    def __init__(self, sampling_strategy='auto', random_state=0, **kwargs):
        ...
        self.over_samplers_ = (
            ...
            BaseSampler("Conditional GAN", "CGAN",
                        CGAN(discriminator=(128, 128), generator=(128, 256, 128), random_state=random_state)),
            BaseSampler("Conditional PAC GAN", "PACCGAN",
                        PacCGAN(discriminator=(128, 128), generator=(128, 256, 128), pac=10, random_state=random_state))
        )
