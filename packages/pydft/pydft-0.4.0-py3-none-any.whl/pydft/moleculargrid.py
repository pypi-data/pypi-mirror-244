...
class MolecularGrid:
    def __init__(self, atoms, cgfs, nspheres=32, nangpts='194', lmax=8,
                 functional='svwn5'):
        ...
        self.__lmax = lmax
        self.__nspheres = nspheres
        self.__nangpts = int(nangpts)
        self.__basis = cgfs
    ...
    def get_rho_lm_atoms(self):
        ...
        """
        rho_lm = np.ndarray((len(self.__atoms), self.__nspheres, (self.__lmax+1)**2))
    ...
    def count_electrons_from_rho_lm(self):
        ...
        ngpts = self.__nspheres * self.__nangpts # gridpoints per atom
        rho_lm = np.ndarray((len(self.__atoms), self.__nspheres, (self.__lmax+1)**2))
    ...
    def __build_molecular_grid(self):
        ...
        for atom in self.__atoms:
            self.__atomgrids.append(AtomicGrid(atom, self.__nspheres, 
                                                     self.__nangpts, 
                                                     self.__lmax))
        ...
        self.__mweights = np.zeros((len(self.__atoms), 
                                    self.__nspheres * int(self.__nangpts)))
