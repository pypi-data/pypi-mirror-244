...
cmake_api_version = 3
lowest_supported_qt_version = version.parse("6.0.0")
min_qt_version = lowest_supported_qt_version
...
def main(command_line_args: Optional[List[str]] = None) -> None:
    ...
    if min_qt_version < lowest_supported_qt_version:
        raise RuntimeError(
            f"The specified minimum Qt version {min_qt_version} is too old. "
            f"The oldest supported Qt version is {lowest_supported_qt_version}."
        )
