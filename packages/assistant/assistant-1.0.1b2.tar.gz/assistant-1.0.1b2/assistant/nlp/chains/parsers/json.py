    ...
    def parse(self, text: str) -> AgentAction | AgentFinish:
        ...
        try:
            ...
            if isinstance(json_resp, dict) and _ke != "'function'":
                ...
                if hasattr(json_resp, "final_answer"):
                    # Cannot contain function and final_answer...
                    json_resp.pop("final_answer")
                params = json_resp
                
                if func.lower().replace(" ", "_") == "final_answer":
                    # this means the agent is finished so we call AgentFinish
                    return AgentFinish({"output": params["answer"] if isinstance(params, dict) and hasattr(params, "answer") else params},
