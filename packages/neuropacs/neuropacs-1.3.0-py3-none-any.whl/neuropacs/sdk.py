...
class neuropacs:
    ...
    def upload_dataset(self, directory, connection_id, aes_key, order_id):
    ...
    def upload(self, data, orderID, connection_id, aes_key):
    ...
    def run_job(self, productID, order_id, connectionID, aes_key):
        """Run a job
    ...
    def get_results(self, format, orderID, connection_id, aes_key):
        """Get job results
