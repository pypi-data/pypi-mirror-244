...
class ModalClientBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def FunctionCallGetDataIn(self, stream: 'grpclib.server.Stream[modal_proto.api_pb2.FunctionCallGetDataRequest, google.protobuf.empty_pb2.Empty]') -> None:
        pass

    @abc.abstractmethod
    async def FunctionCallPutDataOut(self, stream: 'grpclib.server.Stream[modal_proto.api_pb2.FunctionCallPutDataRequest, modal_proto.api_pb2.DataChunk]') -> None:
        pass
...
class ModalClientStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.FunctionCallGetDataIn = grpclib.client.UnaryUnaryMethod(
            channel,
            '/modal.client.ModalClient/FunctionCallGetDataIn',
            modal_proto.api_pb2.FunctionCallGetDataRequest,
            google.protobuf.empty_pb2.Empty,
        )
        self.FunctionCallPutDataOut = grpclib.client.UnaryStreamMethod(
            channel,
