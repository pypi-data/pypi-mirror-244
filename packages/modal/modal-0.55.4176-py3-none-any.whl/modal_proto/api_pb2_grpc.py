...
class ModalClientStub(object):
    ...
    def __init__(self, channel):
        ...
        self.FunctionCallGetDataIn = channel.unary_unary(
        ...
        self.FunctionCallPutDataOut = channel.unary_stream(
...
def add_ModalClientServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'FunctionCallGetDataIn': grpc.unary_unary_rpc_method_handler(
                    servicer.FunctionCallGetDataIn,
                    request_deserializer=modal__proto_dot_api__pb2.FunctionCallGetDataRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'FunctionCallPutDataOut': grpc.unary_stream_rpc_method_handler(
...
class ModalClient(object):
    ...
    def FunctionCallGetDataIn(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/modal.client.ModalClient/FunctionCallGetDataIn',
    ...
    def FunctionCallPutDataOut(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/modal.client.ModalClient/FunctionCallPutDataOut',
