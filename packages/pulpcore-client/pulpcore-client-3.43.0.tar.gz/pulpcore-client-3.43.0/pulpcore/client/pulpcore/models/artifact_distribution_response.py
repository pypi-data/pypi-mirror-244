...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, hidden=False, pulp_labels=None, base_url=None, base_path=None, name=None, pulp_created=None, content_guard=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
