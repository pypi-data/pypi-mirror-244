...
class RpcServer:
    ...
    async def _on_message(self, message: Message) -> None:
        timings = [(f"queue.consumed by {self._app_id}", time.time())]
        ...
        if message.timestamp:
            ...
            timings.insert(0, ("queue.published", published_timestamp))
