...
from ..models.tax_code_change_report import TaxCodeChangeReport
from ..types import UNSET, Unset

T = TypeVar("T", bound="TaxCodeChangeReportReportResponse")

@attr.s(auto_attribs=True)
class TaxCodeChangeReportReportResponse:
...
See the Introduction Guide for Reports for more details
    ...
    Attributes:
        ...
        model (Union[Unset, TaxCodeChangeReport]):
        stream (Union[Unset, None, str]): byte array
    """

    type: Union[Unset, None, str] = UNSET
    content: Union[Unset, None, str] = UNSET
    model: Union[Unset, TaxCodeChangeReport] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_model,  Unset):
            ...
            model = TaxCodeChangeReport.from_dict(_model)
        ...
        tax_code_change_report_report_response = cls(
            type=type,
            content=content,
            model=model,
            stream=stream,
        ...
        return tax_code_change_report_report_response
