...
from ..models.umbrella_reconciliation_report_line import UmbrellaReconciliationReportLine
from ..types import UNSET, Unset

T = TypeVar("T", bound="UmbrellaReconciliationReport")

@attr.s(auto_attribs=True)
class UmbrellaReconciliationReport:
    """
    Attributes:
        lines (Union[Unset, None, List[UmbrellaReconciliationReportLine]]):
    ...
    lines: Union[Unset, None, List[UmbrellaReconciliationReportLine]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for lines_item_data in (_lines or []):
            lines_item = UmbrellaReconciliationReportLine.from_dict(lines_item_data)
        ...
        umbrella_reconciliation_report = cls(
            lines=lines,
            employer=employer,
        ...
        return umbrella_reconciliation_report
