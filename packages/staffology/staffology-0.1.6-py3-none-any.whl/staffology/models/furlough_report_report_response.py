...
from ..models.furlough_report import FurloughReport
from ..types import UNSET, Unset

T = TypeVar("T", bound="FurloughReportReportResponse")

@attr.s(auto_attribs=True)
class FurloughReportReportResponse:
...
See the Introduction Guide for Reports for more details
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_model,  Unset):
            ...
            model = FurloughReport.from_dict(_model)
        ...
        furlough_report_report_response = cls(
            type=type,
            content=content,
            model=model,
            stream=stream,
        ...
        return furlough_report_report_response
