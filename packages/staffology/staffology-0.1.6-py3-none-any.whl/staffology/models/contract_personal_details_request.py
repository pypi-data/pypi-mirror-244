...
T = TypeVar("T", bound="ContractPersonalDetailsRequest")

@attr.s(auto_attribs=True)
class ContractPersonalDetailsRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        contract_personal_details_request = cls(
        ...
        return contract_personal_details_request
