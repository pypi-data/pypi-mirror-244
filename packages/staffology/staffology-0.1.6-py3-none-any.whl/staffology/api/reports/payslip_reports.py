...
from ...models.payslip_report_response import PayslipReportResponse
...
def _build_response(*, response: httpx.Response) -> Response[PayslipReportResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Payslip
     ...
     Returns a single Payslip for the given PayRunEntry of a PayRun. The type of response depends on the
    accept header.
