...
from ...models.full_summary_of_pay_report_report_response import FullSummaryOfPayReportReportResponse
...
def _parse_response(*, response: httpx.Response) -> Optional[FullSummaryOfPayReportReportResponse]:
...
def _build_response(*, response: httpx.Response) -> Response[FullSummaryOfPayReportReportResponse]:
    return Response(
