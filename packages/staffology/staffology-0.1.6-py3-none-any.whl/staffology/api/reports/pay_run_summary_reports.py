...
def sync_detailed(
    ...
    *,
    ...
    """PayRunSummary
     ...
     Returns an array of PayRunSummaryLine for one or multiple periods. Similar to a PayRunJournal except
    that it can cover multiple periods.
    ...
    Args:
        ...
        include_qty (Union[Unset, None, bool]):
