...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/employers/{employerId}/reports/{taxYear}/p11d/{employeeId}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """P11D For Employee
     ...
     Gets a P11D in PDF format for the TaxYear and Employee specified. A URL is returned which points to
    the PDF file.
