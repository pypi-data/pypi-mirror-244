...
from ..models.attachment_orders_report import AttachmentOrdersReport
from ..types import UNSET, Unset

T = TypeVar("T", bound="AttachmentOrdersReportReportResponse")

@attr.s(auto_attribs=True)
class AttachmentOrdersReportReportResponse:
...
See the Introduction Guide for Reports for more details
    ...
    Attributes:
        ...
        model (Union[Unset, AttachmentOrdersReport]):
        stream (Union[Unset, None, str]): byte array
    """

    type: Union[Unset, None, str] = UNSET
    content: Union[Unset, None, str] = UNSET
    model: Union[Unset, AttachmentOrdersReport] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_model,  Unset):
            ...
            model = AttachmentOrdersReport.from_dict(_model)
        ...
        attachment_orders_report_report_response = cls(
            type=type,
            content=content,
            model=model,
            stream=stream,
        ...
        return attachment_orders_report_report_response
