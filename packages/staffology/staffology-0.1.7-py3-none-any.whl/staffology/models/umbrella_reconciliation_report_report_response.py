...
from ..models.umbrella_reconciliation_report import UmbrellaReconciliationReport
from ..types import UNSET, Unset

T = TypeVar("T", bound="UmbrellaReconciliationReportReportResponse")

@attr.s(auto_attribs=True)
class UmbrellaReconciliationReportReportResponse:
...
See the Introduction Guide for Reports for more details
    ...
    Attributes:
        ...
        model (Union[Unset, UmbrellaReconciliationReport]):
        stream (Union[Unset, None, str]): byte array
    """

    type: Union[Unset, None, str] = UNSET
    content: Union[Unset, None, str] = UNSET
    model: Union[Unset, UmbrellaReconciliationReport] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_model,  Unset):
            ...
            model = UmbrellaReconciliationReport.from_dict(_model)
        ...
        umbrella_reconciliation_report_report_response = cls(
            type=type,
            content=content,
            model=model,
            stream=stream,
        ...
        return umbrella_reconciliation_report_report_response
