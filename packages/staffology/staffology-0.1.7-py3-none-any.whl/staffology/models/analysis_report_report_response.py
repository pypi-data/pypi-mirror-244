...
T = TypeVar("T", bound="AnalysisReportReportResponse")

@attr.s(auto_attribs=True)
class AnalysisReportReportResponse:
...
See the Introduction Guide for Reports for more details
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_model,  Unset):
            ...
            model = AnalysisReport.from_dict(_model)
        ...
        analysis_report_report_response = cls(
            type=type,
            content=content,
            model=model,
            stream=stream,
        ...
        return analysis_report_report_response
