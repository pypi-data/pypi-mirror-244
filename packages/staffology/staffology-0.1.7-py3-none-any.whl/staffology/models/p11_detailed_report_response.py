...
from ..models.p11_detailed import P11Detailed
from ..types import UNSET, Unset

T = TypeVar("T", bound="P11DetailedReportResponse")

@attr.s(auto_attribs=True)
class P11DetailedReportResponse:
...
See the Introduction Guide for Reports for more details
    ...
    Attributes:
        ...
        model (Union[Unset, P11Detailed]): A more comprehensive P11 Report.
    ...
    model: Union[Unset, P11Detailed] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        model: Union[Unset, P11Detailed]
        if isinstance(_model,  Unset):
            model = UNSET
        else:
            model = P11Detailed.from_dict(_model)
        ...
        p11_detailed_report_response = cls(
            type=type,
            content=content,
            model=model,
            stream=stream,
        ...
        return p11_detailed_report_response
