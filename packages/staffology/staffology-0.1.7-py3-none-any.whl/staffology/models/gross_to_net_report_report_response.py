...
T = TypeVar("T", bound="GrossToNetReportReportResponse")

@attr.s(auto_attribs=True)
class GrossToNetReportReportResponse:
...
See the Introduction Guide for Reports for more details
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_model,  Unset):
            ...
            model = GrossToNetReport.from_dict(_model)
        ...
        gross_to_net_report_report_response = cls(
            type=type,
            content=content,
            model=model,
            stream=stream,
        ...
        return gross_to_net_report_report_response
