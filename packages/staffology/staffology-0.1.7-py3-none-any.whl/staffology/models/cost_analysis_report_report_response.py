...
from ..models.cost_analysis_report import CostAnalysisReport
from ..types import UNSET, Unset

T = TypeVar("T", bound="CostAnalysisReportReportResponse")

@attr.s(auto_attribs=True)
class CostAnalysisReportReportResponse:
...
See the Introduction Guide for Reports for more details
    ...
    Attributes:
        ...
        model (Union[Unset, CostAnalysisReport]):
        stream (Union[Unset, None, str]): byte array
    """

    type: Union[Unset, None, str] = UNSET
    content: Union[Unset, None, str] = UNSET
    model: Union[Unset, CostAnalysisReport] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_model,  Unset):
            ...
            model = CostAnalysisReport.from_dict(_model)
        ...
        cost_analysis_report_report_response = cls(
            type=type,
            content=content,
            model=model,
            stream=stream,
        ...
        return cost_analysis_report_report_response
