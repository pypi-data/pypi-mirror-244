...
from ..models.variance_report import VarianceReport
from ..types import UNSET, Unset

T = TypeVar("T", bound="VarianceReportReportResponse")

@attr.s(auto_attribs=True)
class VarianceReportReportResponse:
...
See the Introduction Guide for Reports for more details
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_model,  Unset):
            ...
            model = VarianceReport.from_dict(_model)
        ...
        variance_report_report_response = cls(
            type=type,
            content=content,
            model=model,
            stream=stream,
        ...
        return variance_report_report_response
