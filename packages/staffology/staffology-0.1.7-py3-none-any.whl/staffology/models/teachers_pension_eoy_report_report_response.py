...
from ..models.teachers_pension_eoy_report import TeachersPensionEoyReport
from ..types import UNSET, Unset

T = TypeVar("T", bound="TeachersPensionEoyReportReportResponse")

@attr.s(auto_attribs=True)
class TeachersPensionEoyReportReportResponse:
...
See the Introduction Guide for Reports for more details
    ...
    Attributes:
        ...
        model (Union[Unset, TeachersPensionEoyReport]):
        stream (Union[Unset, None, str]): byte array
    """

    type: Union[Unset, None, str] = UNSET
    content: Union[Unset, None, str] = UNSET
    model: Union[Unset, TeachersPensionEoyReport] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_model,  Unset):
            ...
            model = TeachersPensionEoyReport.from_dict(_model)
        ...
        teachers_pension_eoy_report_report_response = cls(
            type=type,
            content=content,
            model=model,
            stream=stream,
        ...
        return teachers_pension_eoy_report_report_response
