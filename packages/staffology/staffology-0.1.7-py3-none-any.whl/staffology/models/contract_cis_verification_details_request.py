...
T = TypeVar("T", bound="ContractCisVerificationDetailsRequest")

@attr.s(auto_attribs=True)
class ContractCisVerificationDetailsRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        contract_cis_verification_details_request = cls(
        ...
        return contract_cis_verification_details_request
