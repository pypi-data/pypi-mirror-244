...
from ..models.full_summary_of_pay_report import FullSummaryOfPayReport
from ..types import UNSET, Unset

T = TypeVar("T", bound="FullSummaryOfPayReportReportResponse")

@attr.s(auto_attribs=True)
class FullSummaryOfPayReportReportResponse:
...
See the Introduction Guide for Reports for more details
    ...
    Attributes:
        ...
        model (Union[Unset, FullSummaryOfPayReport]):
        stream (Union[Unset, None, str]): byte array
    """

    type: Union[Unset, None, str] = UNSET
    content: Union[Unset, None, str] = UNSET
    model: Union[Unset, FullSummaryOfPayReport] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_model,  Unset):
            ...
            model = FullSummaryOfPayReport.from_dict(_model)
        ...
        full_summary_of_pay_report_report_response = cls(
            type=type,
            content=content,
            model=model,
            stream=stream,
        ...
        return full_summary_of_pay_report_report_response
