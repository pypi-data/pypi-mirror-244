...
from ..models.p32 import P32
from ..types import UNSET, Unset

T = TypeVar("T", bound="P32ReportResponse")

@attr.s(auto_attribs=True)
class P32ReportResponse:
