...
from ..models.right_to_work_report import RightToWorkReport
from ..types import UNSET, Unset

T = TypeVar("T", bound="RightToWorkReportReportResponse")

@attr.s(auto_attribs=True)
class RightToWorkReportReportResponse:
...
See the Introduction Guide for Reports for more details
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_model,  Unset):
            ...
            model = RightToWorkReport.from_dict(_model)
        ...
        right_to_work_report_report_response = cls(
            type=type,
            content=content,
            model=model,
            stream=stream,
        ...
        return right_to_work_report_report_response
