...
from ..models.ni_letter_validation_report import NiLetterValidationReport
from ..types import UNSET, Unset

T = TypeVar("T", bound="NiLetterValidationReportReportResponse")

@attr.s(auto_attribs=True)
class NiLetterValidationReportReportResponse:
...
See the Introduction Guide for Reports for more details
    ...
    Attributes:
        ...
        model (Union[Unset, NiLetterValidationReport]):
        stream (Union[Unset, None, str]): byte array
    """

    type: Union[Unset, None, str] = UNSET
    content: Union[Unset, None, str] = UNSET
    model: Union[Unset, NiLetterValidationReport] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_model,  Unset):
            ...
            model = NiLetterValidationReport.from_dict(_model)
        ...
        ni_letter_validation_report_report_response = cls(
            type=type,
            content=content,
            model=model,
            stream=stream,
        ...
        return ni_letter_validation_report_report_response
