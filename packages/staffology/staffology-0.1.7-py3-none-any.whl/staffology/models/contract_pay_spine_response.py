...
T = TypeVar("T", bound="ContractPaySpineResponse")

@attr.s(auto_attribs=True)
class ContractPaySpineResponse:
    """
    Attributes:
        id (Union[Unset, str]): Pay Spine identifier
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        contract_pay_spine_response = cls(
            id=id,
            name=name,
        ...
        return contract_pay_spine_response
