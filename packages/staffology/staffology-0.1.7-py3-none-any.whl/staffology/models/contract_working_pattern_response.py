...
T = TypeVar("T", bound="ContractWorkingPatternResponse")

@attr.s(auto_attribs=True)
class ContractWorkingPatternResponse:
    """
    Attributes:
        title (str):
        id (Union[Unset, str]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        contract_working_pattern_response = cls(
            title=title,
            id=id,
            mon=mon,
            tue=tue,
        ...
        return contract_working_pattern_response
