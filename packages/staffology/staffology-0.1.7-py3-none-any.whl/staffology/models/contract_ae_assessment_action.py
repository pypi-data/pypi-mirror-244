...
T = TypeVar("T", bound="ContractAeAssessmentAction")

@attr.s(auto_attribs=True)
class ContractAeAssessmentAction:
    """
    Attributes:
        action (Union[Unset, AeAction]):
        employee_state (Union[Unset, AeEmployeeState]):
        action_completed (Union[Unset, bool]): Indicates whether or not the required action was successfully completed
        action_completed_message (Union[Unset, None, str]): Gives further information about the action taken or the
            reason if wasn't successfully completed
        required_letter (Union[Unset, AeStatutoryLetter]):
        pension_scheme_id (Union[Unset, str]): The PensionSchemeId that a completed action relates to
        worker_group_id (Union[Unset, str]): The WorkerGroupId that a completed action relates to
        letter_not_yet_sent (Union[Unset, bool]): Indicates whether or not any required letter has been sent
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        contract_ae_assessment_action = cls(
            action=action,
        ...
        return contract_ae_assessment_action
