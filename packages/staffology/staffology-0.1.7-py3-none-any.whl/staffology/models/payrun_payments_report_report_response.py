...
from ..models.payrun_payments_report import PayrunPaymentsReport
from ..types import UNSET, Unset

T = TypeVar("T", bound="PayrunPaymentsReportReportResponse")

@attr.s(auto_attribs=True)
class PayrunPaymentsReportReportResponse:
...
See the Introduction Guide for Reports for more details
    ...
    Attributes:
        ...
        model (Union[Unset, PayrunPaymentsReport]): After finalising a PayRun, employees need to actually be paid.
    ...
    model: Union[Unset, PayrunPaymentsReport] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        model: Union[Unset, PayrunPaymentsReport]
        if isinstance(_model,  Unset):
            model = UNSET
        else:
            model = PayrunPaymentsReport.from_dict(_model)
        ...
        payrun_payments_report_report_response = cls(
            type=type,
            content=content,
            model=model,
            stream=stream,
        ...
        return payrun_payments_report_report_response
