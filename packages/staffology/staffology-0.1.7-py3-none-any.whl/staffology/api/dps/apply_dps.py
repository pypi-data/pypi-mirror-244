...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, DpsNotice]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, DpsNotice]]:
    return Response(
