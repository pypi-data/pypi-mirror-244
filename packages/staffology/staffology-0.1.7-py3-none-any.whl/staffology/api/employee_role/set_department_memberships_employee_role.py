...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/employers/{employerId}/employees/{employeeId}/roles/{id}/departments".format(
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, List[DepartmentMembership]]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, List[DepartmentMembership]]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    client: Client,
    json_body: List[DepartmentMembership],
) -> Response[Union[Any, List[DepartmentMembership]]]:
...
def sync(
    ...
    *,
    client: Client,
    json_body: List[DepartmentMembership],
) -> Optional[Union[Any, List[DepartmentMembership]]]:
    """Set Employee Role Departments
