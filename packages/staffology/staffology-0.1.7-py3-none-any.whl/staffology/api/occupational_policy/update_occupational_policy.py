...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/employers/{employerId}/occupationalpolicies/{id}".format(client.base_url, employerId=employer_id, id=id)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, OccupationalPolicy]]:
    if response.status_code == 200:
        response_200 = OccupationalPolicy.from_dict(response.json())
