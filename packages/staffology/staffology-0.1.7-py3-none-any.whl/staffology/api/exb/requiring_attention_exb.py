...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/employers/{employerId}/rti/exb/requiringattention".format(client.base_url, employerId=employer_id)
...
def sync_detailed(
    ...
    *,
    ...
    """EXB Requiring Attention
     ...
     Returns all Expenses And Benefits submissions that have a Submission Status of NotSubmitted or
    ErrorResponse
