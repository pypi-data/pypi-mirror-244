...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/employers/{employerId}/rti/eps/requiringattention".format(client.base_url, employerId=employer_id)
...
def sync_detailed(
    ...
    *,
    ...
    """EPS Requiring Attention
     ...
     Returns all Employer Payment Summaries that have a Submission Status of NotSubmitted or
    ErrorResponse
