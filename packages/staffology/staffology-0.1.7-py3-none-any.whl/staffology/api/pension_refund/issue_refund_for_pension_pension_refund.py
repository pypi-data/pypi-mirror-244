...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/employers/{employerId}/employees/{employeeId}/pensionrefund/{pensionId}/autocalculated".format(
        client.base_url,employerId=employer_id,employeeId=employee_id,pensionId=pension_id)
