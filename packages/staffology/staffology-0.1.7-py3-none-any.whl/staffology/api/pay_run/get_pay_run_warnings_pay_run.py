...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/employers/{employerId}/payrun/{taxYear}/{payPeriod}/{periodNumber}/warnings".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get PayRun Warnings
     ...
     Returns an Item for any PayRunEntry on the payrun that has a potential issue.
