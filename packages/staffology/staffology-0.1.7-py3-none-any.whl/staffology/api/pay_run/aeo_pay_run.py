...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/employers/{employerId}/payrun/{taxYear}/{payPeriod}/{periodNumber}/aeo".format(
...
def sync_detailed(
    ...
    *,
    ...
    """List AttachmentOrders related to a PayRun
     ...
     Returns a List of Items representing any AttachmentOrders within the PayRun date range for Employees
    that are included in the given PayRun.
