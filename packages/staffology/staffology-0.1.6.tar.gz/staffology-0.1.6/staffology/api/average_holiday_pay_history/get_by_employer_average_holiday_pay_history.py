...
def _parse_response(*, response: httpx.Response) -> Optional[List[ContractPayHistoryResponse]]:
...
def _build_response(*, response: httpx.Response) -> Response[List[ContractPayHistoryResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    client: Client,
) -> Response[List[ContractPayHistoryResponse]]:
...
def sync(
    ...
    *,
    client: Client,
) -> Optional[List[ContractPayHistoryResponse]]:
    """Get AverageHolidayPayHistory for Employer
