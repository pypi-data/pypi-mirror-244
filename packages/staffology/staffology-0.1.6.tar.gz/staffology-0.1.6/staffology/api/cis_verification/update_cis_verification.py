...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        tax_year (TaxYear):
        id (str):
        json_body (CisVerification): If an Employee is marked as a CIS Subcontractor then this
            model is included ad a child of CisDetails and is used to represent the Verification
