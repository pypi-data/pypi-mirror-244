...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/employers/{employerId}/payrun/{taxYear}/{payPeriod}/{periodNumber}/leave".format(
...
def sync_detailed(
    ...
    *,
    ...
    """List Leave related to a PayRun
     ...
     Returns a List of Items representing any Leave within the PayRun date range for Employees that are
    included in the given PayRun.
    Note that if Leave was added after the PayRun was closed, but the Leave is within the PayRun period
    then it'll be returned here even though it wouldn't have been processed with the PayRun.
