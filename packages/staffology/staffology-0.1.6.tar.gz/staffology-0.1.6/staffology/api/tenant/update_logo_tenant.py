...
from ...models.update_logo_tenant_multipart_data import UpdateLogoTenantMultipartData
...
def sync_detailed(
    ...
    *,
    ...
    """Upload Logo
     ...
     Upload an image to use as your main logo. We'll upload it and set the URL on the HomeImgUrl property
    of the Tenant.
