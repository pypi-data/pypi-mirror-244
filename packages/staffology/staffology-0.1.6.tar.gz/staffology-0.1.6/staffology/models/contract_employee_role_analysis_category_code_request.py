...
T = TypeVar("T", bound="ContractEmployeeRoleAnalysisCategoryCodeRequest")

@attr.s(auto_attribs=True)
class ContractEmployeeRoleAnalysisCategoryCodeRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        contract_employee_role_analysis_category_code_request = cls(
            code=code,
            color=color,
            title=title,
            weighting=weighting,
        ...
        return contract_employee_role_analysis_category_code_request
