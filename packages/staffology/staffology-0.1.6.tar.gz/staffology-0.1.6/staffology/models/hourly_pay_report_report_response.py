...
from ..models.hourly_pay_report import HourlyPayReport
from ..types import UNSET, Unset

T = TypeVar("T", bound="HourlyPayReportReportResponse")

@attr.s(auto_attribs=True)
class HourlyPayReportReportResponse:
...
See the Introduction Guide for Reports for more details
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_model,  Unset):
            ...
            model = HourlyPayReport.from_dict(_model)
        ...
        hourly_pay_report_report_response = cls(
            type=type,
            content=content,
            model=model,
            stream=stream,
        ...
        return hourly_pay_report_report_response
