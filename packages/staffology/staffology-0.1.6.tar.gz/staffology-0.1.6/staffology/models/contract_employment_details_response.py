...
from ..models.contract_cis_details_response import ContractCisDetailsResponse
from ..models.contract_department_response import ContractDepartmentResponse
...
T = TypeVar("T", bound="ContractEmploymentDetailsResponse")

@attr.s(auto_attribs=True)
class ContractEmploymentDetailsResponse:
    """
    Attributes:
        payroll_code (str): The Employees Payroll Code. Must be unique within the Employer.
        cis (Union[Unset, ContractCisDetailsResponse]):
        department (Union[Unset, ContractDepartmentResponse]):
        continuous_employment_date (Union[Unset, None, datetime.date]):
        include_seconded_info_on_starter (Union[Unset, bool]):
    ...
    payroll_code: str
    cis: Union[Unset, ContractCisDetailsResponse] = UNSET
    department: Union[Unset, ContractDepartmentResponse] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_cis,  Unset):
            ...
            cis = ContractCisDetailsResponse.from_dict(_cis)
        ...
        if isinstance(_department,  Unset):
            ...
            department = ContractDepartmentResponse.from_dict(_department)
        ...
        contract_employment_details_response = cls(
        ...
        return contract_employment_details_response
