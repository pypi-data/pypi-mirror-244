...
T = TypeVar("T", bound="PapdisEmployerContactPostalAddress")

@attr.s(auto_attribs=True)
class PapdisEmployerContactPostalAddress:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        papdis_employer_contact_postal_address = cls(
            address1=address1,
            address2=address2,
            address3=address3,
            address4=address4,
        ...
        return papdis_employer_contact_postal_address
