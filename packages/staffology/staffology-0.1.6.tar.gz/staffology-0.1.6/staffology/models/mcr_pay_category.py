...
class McrPayCategory(str, Enum):
    MCRPENSIONABLEPAY = "McrPensionablePay"
    MCROVERTIME = "McrOvertime"
    MCRADDITIONALPENSIONABLEPAYMENTS = "McrAdditionalPensionablePayments"
