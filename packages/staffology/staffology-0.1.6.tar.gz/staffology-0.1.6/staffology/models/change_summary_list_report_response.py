...
T = TypeVar("T", bound="ChangeSummaryListReportResponse")

@attr.s(auto_attribs=True)
class ChangeSummaryListReportResponse:
...
See the Introduction Guide for Reports for more details
    ...
    Attributes:
        ...
        model (Union[Unset, None, List[ChangeSummary]]): [readonly] If the type is application.json then this will
    ...
    model: Union[Unset, None, List[ChangeSummary]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for model_item_data in (_model or []):
            model_item = ChangeSummary.from_dict(model_item_data)
        ...
        change_summary_list_report_response = cls(
            type=type,
            content=content,
            model=model,
            stream=stream,
        ...
        return change_summary_list_report_response
