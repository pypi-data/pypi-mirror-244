...
T = TypeVar("T", bound="BankPaymentInstructionReportResponse")

@attr.s(auto_attribs=True)
class BankPaymentInstructionReportResponse:
...
See the Introduction Guide for Reports for more details
    ...
    Attributes:
        ...
        model (Union[Unset, BankPaymentInstruction]):
        stream (Union[Unset, None, str]): byte array
    """

    type: Union[Unset, None, str] = UNSET
    content: Union[Unset, None, str] = UNSET
    model: Union[Unset, BankPaymentInstruction] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_model,  Unset):
            ...
            model = BankPaymentInstruction.from_dict(_model)
        ...
        bank_payment_instruction_report_response = cls(
            type=type,
            content=content,
            model=model,
            stream=stream,
        ...
        return bank_payment_instruction_report_response
