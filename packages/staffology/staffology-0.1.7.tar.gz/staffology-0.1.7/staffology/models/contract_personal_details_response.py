...
from ..models.contract_address import ContractAddress
from ..models.contract_partner_details import ContractPartnerDetails
from ..models.gender import Gender
from ..models.marital_status import MaritalStatus
from ..models.pdf_password_type import PdfPasswordType
from ..types import UNSET, Unset

T = TypeVar("T", bound="ContractPersonalDetailsResponse")

@attr.s(auto_attribs=True)
class ContractPersonalDetailsResponse:
    """
    Attributes:
        marital_status (MaritalStatus):
        date_of_birth (datetime.date):
        gender (Gender):
        state_pension_age (Union[Unset, int]): Automatically calculated.
        address (Union[Unset, ContractAddress]):
        ...
        partner_details (Union[Unset, ContractPartnerDetails]):
    """
    ...
    address: Union[Unset, ContractAddress] = UNSET
    ...
    partner_details: Union[Unset, ContractPartnerDetails] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_address,  Unset):
            ...
            address = ContractAddress.from_dict(_address)
        ...
        if isinstance(_partner_details,  Unset):
            ...
            partner_details = ContractPartnerDetails.from_dict(_partner_details)




        contract_personal_details_response = cls(
        ...
        return contract_personal_details_response
