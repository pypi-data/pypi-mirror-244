...
from ..models.employee_benefits_report import EmployeeBenefitsReport
from ..types import UNSET, Unset

T = TypeVar("T", bound="EmployeeBenefitsReportReportResponse")

@attr.s(auto_attribs=True)
class EmployeeBenefitsReportReportResponse:
...
See the Introduction Guide for Reports for more details
    ...
    Attributes:
        ...
        model (Union[Unset, EmployeeBenefitsReport]):
        stream (Union[Unset, None, str]): byte array
    """

    type: Union[Unset, None, str] = UNSET
    content: Union[Unset, None, str] = UNSET
    model: Union[Unset, EmployeeBenefitsReport] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_model,  Unset):
            ...
            model = EmployeeBenefitsReport.from_dict(_model)
        ...
        employee_benefits_report_report_response = cls(
            type=type,
            content=content,
            model=model,
            stream=stream,
        ...
        return employee_benefits_report_report_response
