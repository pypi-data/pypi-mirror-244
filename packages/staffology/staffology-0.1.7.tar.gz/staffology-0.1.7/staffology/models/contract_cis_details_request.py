...
from ..models.contract_cis_verification_details_request import ContractCisVerificationDetailsRequest
from ..types import UNSET, Unset

T = TypeVar("T", bound="ContractCisDetailsRequest")

@attr.s(auto_attribs=True)
class ContractCisDetailsRequest:
    """
    Attributes:
        verification (Union[Unset, ContractCisVerificationDetailsRequest]):
    ...
    verification: Union[Unset, ContractCisVerificationDetailsRequest] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_verification,  Unset):
            ...
            verification = ContractCisVerificationDetailsRequest.from_dict(_verification)
        ...
        contract_cis_details_request = cls(
        ...
        return contract_cis_details_request
