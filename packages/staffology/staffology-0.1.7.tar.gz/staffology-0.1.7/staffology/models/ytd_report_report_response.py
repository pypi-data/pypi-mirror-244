...
from ..models.ytd_report import YtdReport
from ..types import UNSET, Unset

T = TypeVar("T", bound="YtdReportReportResponse")

@attr.s(auto_attribs=True)
class YtdReportReportResponse:
...
See the Introduction Guide for Reports for more details
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_model,  Unset):
            ...
            model = YtdReport.from_dict(_model)
        ...
        ytd_report_report_response = cls(
            type=type,
            content=content,
            model=model,
            stream=stream,
        ...
        return ytd_report_report_response
