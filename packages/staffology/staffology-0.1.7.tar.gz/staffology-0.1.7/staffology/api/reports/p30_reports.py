...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/employers/{employerId}/reports/{taxYear}/p30/{periodEnding}".format(
...
def sync_detailed(
    ...
    *,
    ...
    If the accept header is set to \"text/csv\" then the periodEnding parameter is ignored and you'll
    receive a CSV for the entire TaxYear.
