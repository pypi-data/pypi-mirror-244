...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, ContractLondonAllowanceResponse]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, ContractLondonAllowanceResponse]]:
    return Response(
...
) -> Response[Union[Any, ContractLondonAllowanceResponse]]:
    """Get LondonAllowance

     Get LondonAllowance for an Employer and Payspine.
...
) -> Optional[Union[Any, ContractLondonAllowanceResponse]]:
    """Get LondonAllowance
