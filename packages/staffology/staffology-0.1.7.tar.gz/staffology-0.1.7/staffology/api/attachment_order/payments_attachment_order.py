...
def _parse_response(*, response: httpx.Response) -> Optional[List[AttachmentOrderPayment]]:
...
def _build_response(*, response: httpx.Response) -> Response[List[AttachmentOrderPayment]]:
    return Response(
