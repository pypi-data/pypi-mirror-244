...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/employers/{employerId}/rti/nvr/requiringattention".format(client.base_url, employerId=employer_id)
...
def sync_detailed(
    ...
    *,
    ...
    """NVR Requiring Attention
     ...
     Returns all NiNo Verification Requests that have a Submission Status of NotSubmitted or
    ErrorResponse
