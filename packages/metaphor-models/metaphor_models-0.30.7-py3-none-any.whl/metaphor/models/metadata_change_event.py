...
class Dashboard:
    ...
    def from_dict(obj: Any) -> 'Dashboard':
        ...
        return Dashboard(created_at, id, versioned_id, asset_contacts, asset_followers, asset_governed_tags, dashboard_created_at, dashboard_info, deleted_at, display_name, entity_type, entity_upstream, force_shown, dashboard_id, is_complete, is_deleted, is_non_prod, is_production, last_ingested_at, last_modified_at, logical_id, overall_data_quality, source_info, structure, system_tags, upstream, dashboard_versioned_id)
...
class Metric:
    ...
    def from_dict(obj: Any) -> 'Metric':
        ...
        return Metric(created_at, id, versioned_id, asset_contacts, asset_followers, asset_governed_tags, metric_created_at, dbt_metric, deleted_at, display_name, entity_type, force_shown, metric_id, is_complete, is_deleted, is_non_prod, is_production, last_ingested_at, last_modified_at, logical_id, metric_info, metric_versioned_id)
...
class MetadataChangeEvent:
    ...
    def from_dict(obj: Any) -> 'MetadataChangeEvent':
        ...
        return MetadataChangeEvent(dashboard, dataset, event_header, hierarchy, knowledge_card, metric, pipeline, query_attributions, query_logs, user_activity, virtual_view)
