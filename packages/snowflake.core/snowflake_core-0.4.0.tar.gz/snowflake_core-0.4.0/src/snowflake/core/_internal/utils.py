...
WARNING_TEXT = "Task and DAG APIs are in public preview. " \
                "Warehouse, Database, Schema, Table, Compute Pool, " \
                "Image Repository, and Service APIs are experimental."
...
def experimental(f: Callable[P, R]) -> Callable[P, R]:
    @wraps(f)
    def wrapper(*args: P.args, **kwargs: P.kwargs) -> R:
        warnings.warn(WARNING_TEXT, stacklevel=0)
