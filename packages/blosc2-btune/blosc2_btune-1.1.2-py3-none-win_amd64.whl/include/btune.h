...
#define BTUNE_VERSION_MINOR    1    /* for minor interface/format changes  */
#define BTUNE_VERSION_RELEASE  2    /* for tweaks, bug-fixes, or development */
#define BTUNE_VERSION_STRING "1.1.2"
