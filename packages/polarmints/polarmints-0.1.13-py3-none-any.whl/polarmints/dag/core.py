...
class DagBase:
    ...
    def ordered_exprs(self, exprs: dict | list) -> list[list[Expr]]:
    ...
    def _select(self, is_select: bool, df: DF, expr=None, *args, include_deps=False, **kwargs) -> DF:
        ...
        ordered_exprs = self.ordered_exprs(exprs)
