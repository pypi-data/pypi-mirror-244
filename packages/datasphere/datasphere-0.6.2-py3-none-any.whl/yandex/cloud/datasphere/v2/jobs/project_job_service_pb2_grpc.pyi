...
class ProjectJobServiceStub:
    ...
    Finalize: grpc.UnaryUnaryMultiCallable[
        yandex.cloud.datasphere.v2.jobs.project_job_service_pb2.FinalizeProjectJobRequest,
        yandex.cloud.datasphere.v2.jobs.project_job_service_pb2.FinalizeProjectJobResponse,
    ]
...
class ProjectJobServiceServicer(metaclass=abc.ABCMeta):
    ...
    def Finalize(
        self,
        request: yandex.cloud.datasphere.v2.jobs.project_job_service_pb2.FinalizeProjectJobRequest,
        context: _ServicerContext,
    ) -> typing.Union[yandex.cloud.datasphere.v2.jobs.project_job_service_pb2.FinalizeProjectJobResponse, collections.abc.Awaitable[yandex.cloud.datasphere.v2.jobs.project_job_service_pb2.FinalizeProjectJobResponse]]:
        """Triggers cleanup after downloading job results."""
    @abc.abstractmethod
    def ReadStdLogs(
        self,
