...
from clickzetta.dbapi.types import ParamsSequenceOrDictType, ParamsDictType, ParamsSequenceType
...
class Cursor(object):
    ...
    def executemany(self, operation: str, seq_of_parameters: Sequence[ParamsSequenceOrDictType]):
