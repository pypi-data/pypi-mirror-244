...
BINARY = _DBAPITypeObject("BINARY", "ARRAY", "STRUCT", "MAP")
...
ParamsSequenceType = Sequence[ToCZInputTypes]
ParamsDictType = Dict[str, ToCZInputTypes]
