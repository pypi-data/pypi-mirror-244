...
from simba.utils.read_write import get_fn_ext, read_df, find_video_of_file, read_frm_of_video
        ...
        for file_cnt, file_path in enumerate(self.files_found):
            ...
            if self.video_setting or self.frame_setting:
                for frm_cnt in range(len(self.data_df)):
                    ...
                    if (type(self.style_attr['bg color']) == dict) and (self.style_attr['bg color']['type']) == 'moving':
