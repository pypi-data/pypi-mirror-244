...
FANTOM_GAS_PRICE_API = ""  # Different format, see https://api.ftmscan.com/api?module=gastracker&action=gasoracle
HEDERA_GAS_PRICE_API = ""  # Static fees, see https://docs.hedera.com/hedera/networks/mainnet/fees
SWISSDLT_GAS_PRICE_API = ""  # Not supported
...
gas_station = {
    ...
    # 4002: GasStation(api=FANTOM_GAS_PRICE_API, parse_rsp=["average"]),
    # 296: GasStation(api=HEDERA_GAS_PRICE_API, parse_rsp=["average"]),
    # 999: GasStation(api=SWISSDLT_GAS_PRICE_API, parse_rsp=["average"]),
}
