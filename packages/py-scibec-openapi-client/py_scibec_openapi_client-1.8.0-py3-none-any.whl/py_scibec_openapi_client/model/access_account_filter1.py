...
class AccessAccountFilter1(
            ...
            class fields(
                ...
                class MetaOapg:
                    ...
                    class one_of_0(
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["id"], typing_extensions.Literal["readACL"], typing_extensions.Literal["writeACL"], typing_extensions.Literal["owner"], typing_extensions.Literal["createdAt"], typing_extensions.Literal["createdBy"], typing_extensions.Literal["name"], typing_extensions.Literal["read"], typing_extensions.Literal["write"], typing_extensions.Literal["remote"], typing_extensions.Literal["token"], typing_extensions.Literal["isFunctional"], ]):
                            # dict_instance[name] accessor
                            return super().__getitem__(name)
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["offset"], typing_extensions.Literal["limit"], typing_extensions.Literal["skip"], typing_extensions.Literal["order"], typing_extensions.Literal["where"], typing_extensions.Literal["fields"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["offset"], typing_extensions.Literal["limit"], typing_extensions.Literal["skip"], typing_extensions.Literal["order"], typing_extensions.Literal["where"], typing_extensions.Literal["fields"], ]):
        return super().get_item_oapg(name)
