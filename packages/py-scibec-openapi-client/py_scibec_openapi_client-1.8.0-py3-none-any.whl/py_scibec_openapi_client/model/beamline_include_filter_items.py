...
class BeamlineIncludeFilterItems(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def scope() -> typing.Type['BeamlineScopeFilter']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["scope"]) -> 'BeamlineScopeFilter': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["scope"]) -> typing.Union['BeamlineScopeFilter', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        scope: typing.Union['BeamlineScopeFilter', schemas.Unset] = schemas.unset,
