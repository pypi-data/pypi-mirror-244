...
class BeamlineWithRelations(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def accessConfig() -> typing.Type['AccessConfigWithRelations']:
                return AccessConfigWithRelations
            ...
            class experiments(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ExperimentWithRelations']:
                        return ExperimentWithRelations
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ExperimentWithRelations'], typing.List['ExperimentWithRelations']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'experiments':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'ExperimentWithRelations':
                    return super().__getitem__(i)
            __annotations__ = {
                "name": name,
                "id": id,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["accessConfig"]) -> 'AccessConfigWithRelations': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["experiments"]) -> MetaOapg.properties.experiments: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["id"], typing_extensions.Literal["readACL"], typing_extensions.Literal["writeACL"], typing_extensions.Literal["owner"], typing_extensions.Literal["createdAt"], typing_extensions.Literal["createdBy"], typing_extensions.Literal["activeExperiment"], typing_extensions.Literal["accessConfig"], typing_extensions.Literal["experiments"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["accessConfig"]) -> typing.Union['AccessConfigWithRelations', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        accessConfig: typing.Union['AccessConfigWithRelations', schemas.Unset] = schemas.unset,
