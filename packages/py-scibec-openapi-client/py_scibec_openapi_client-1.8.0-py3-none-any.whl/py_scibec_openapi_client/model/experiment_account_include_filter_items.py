...
class ExperimentAccountIncludeFilterItems(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def scope() -> typing.Type['ExperimentAccountScopeFilter']:
                return ExperimentAccountScopeFilter
            __annotations__ = {
                "relation": relation,
                "scope": scope,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["scope"]) -> 'ExperimentAccountScopeFilter': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["scope"]) -> typing.Union['ExperimentAccountScopeFilter', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        scope: typing.Union['ExperimentAccountScopeFilter', schemas.Unset] = schemas.unset,
