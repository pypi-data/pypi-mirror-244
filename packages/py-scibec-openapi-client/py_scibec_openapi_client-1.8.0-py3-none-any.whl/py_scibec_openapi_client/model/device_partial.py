...
class DevicePartial(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id"], typing_extensions.Literal["readACL"], typing_extensions.Literal["writeACL"], typing_extensions.Literal["owner"], typing_extensions.Literal["createdAt"], typing_extensions.Literal["createdBy"], typing_extensions.Literal["name"], typing_extensions.Literal["description"], typing_extensions.Literal["parentId"], typing_extensions.Literal["sessionId"], typing_extensions.Literal["enabled"], typing_extensions.Literal["enabled_set"], typing_extensions.Literal["deviceClass"], typing_extensions.Literal["deviceTags"], typing_extensions.Literal["deviceConfig"], typing_extensions.Literal["acquisitionConfig"], typing_extensions.Literal["onFailure"], typing_extensions.Literal["userParameter"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["acquisitionConfig"]) -> typing.Union[MetaOapg.properties.acquisitionConfig, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        deviceClass: typing.Union[MetaOapg.properties.deviceClass, str, schemas.Unset] = schemas.unset,
        deviceTags: typing.Union[MetaOapg.properties.deviceTags, list, tuple, schemas.Unset] = schemas.unset,
        deviceConfig: typing.Union[MetaOapg.properties.deviceConfig, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        acquisitionConfig: typing.Union[MetaOapg.properties.acquisitionConfig, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
