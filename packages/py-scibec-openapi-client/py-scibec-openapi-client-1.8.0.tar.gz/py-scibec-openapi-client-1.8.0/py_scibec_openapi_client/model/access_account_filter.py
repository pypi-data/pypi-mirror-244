...
class AccessAccountFilter(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["offset"], typing_extensions.Literal["limit"], typing_extensions.Literal["skip"], typing_extensions.Literal["order"], typing_extensions.Literal["fields"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["offset"], typing_extensions.Literal["limit"], typing_extensions.Literal["skip"], typing_extensions.Literal["order"], typing_extensions.Literal["fields"], ]):
        return super().get_item_oapg(name)
