...
class AccessConfigIncludeFilterItems(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class relation(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "beamline": "BEAMLINE",
                        "functionalAccounts": "FUNCTIONAL_ACCOUNTS",
                    }
                ...
                @schemas.classproperty
                def FUNCTIONAL_ACCOUNTS(cls):
                    return cls("functionalAccounts")
        
            @staticmethod
            def scope() -> typing.Type['AccessConfigScopeFilter']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["scope"]) -> 'AccessConfigScopeFilter': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["scope"]) -> typing.Union['AccessConfigScopeFilter', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        scope: typing.Union['AccessConfigScopeFilter', schemas.Unset] = schemas.unset,
