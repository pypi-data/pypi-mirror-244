...
class EventIncludeFilterItems(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def scope() -> typing.Type['EventScopeFilter']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["scope"]) -> 'EventScopeFilter': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["scope"]) -> typing.Union['EventScopeFilter', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        scope: typing.Union['EventScopeFilter', schemas.Unset] = schemas.unset,
