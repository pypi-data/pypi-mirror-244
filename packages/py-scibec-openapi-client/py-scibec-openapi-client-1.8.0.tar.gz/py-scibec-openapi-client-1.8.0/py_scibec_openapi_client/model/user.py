...
class User(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email"], typing_extensions.Literal["id"], typing_extensions.Literal["firstName"], typing_extensions.Literal["lastName"], typing_extensions.Literal["username"], typing_extensions.Literal["roles"], typing_extensions.Literal["location"], typing_extensions.Literal["unxGroup"], ]):
