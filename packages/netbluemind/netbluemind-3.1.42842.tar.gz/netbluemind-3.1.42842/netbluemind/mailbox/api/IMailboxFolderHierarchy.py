...
IMailboxFolderHierarchy_VERSION = "3.1.42842"
...
class IMailboxFolderHierarchy(BaseEndpoint):
    ...
    def multipleGet(self, arg0):
        ...
        response = requests.post(self.base + postUri, params=queryParams, verify=False, headers={
                                 'X-BM-ApiKey': self.apiKey, 'Accept': 'application/json', 'X-BM-ClientVersion': IMailboxFolderHierarchy_VERSION}, data=__encoded__)
