...
class __ICalendarElementSerDer__:
    ...
    def parseInternal(self, value, instance):
        ...
        instance.classification = __ICalendarElementClassificationSerDer__().parse(
            classificationValue)
        ...
        instance.attachments = serder.ListSerDer(
            __AttachedFileSerDer__()).parse(attachmentsValue)
    ...
    def encodeInternal(self, value, instance):
        ...
        from netbluemind.icalendar.api.ICalendarElementClassification import __ICalendarElementClassificationSerDer__
        classificationValue = value.classification
        instance["classification"] = __ICalendarElementClassificationSerDer__().encode(
            classificationValue)
        locationValue = value.location
        ...
        attachmentsValue = value.attachments
        instance["attachments"] = serder.ListSerDer(
            __AttachedFileSerDer__()).encode(attachmentsValue)
        sequenceValue = value.sequence
