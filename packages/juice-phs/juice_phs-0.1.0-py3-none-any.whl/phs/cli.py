...
def rpwi_langmir_probe_illumination(argv=None):
    """CLI to convert a OPL to an OTC structure."""
    parser = ArgumentParser(description=f'juice-phs-{VERSION} CLI - RPWI Langmir Probe Illumination')
    ...
    # Export CSV to QLC file
    rpwi.langmir_probe_illumination(args.utc_start, args.utc_end, plot=args.plot)
