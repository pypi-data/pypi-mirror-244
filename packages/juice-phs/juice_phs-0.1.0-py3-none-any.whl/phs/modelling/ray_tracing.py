...
def obstruction_targets(observer=''):
    ...
    targets = [
        ...
        ['JUICE_PEP_JNA', -28520, 'JUICE_PEP_JDC', 'DSK/UNPRIORITIZED', 1],
        ...
        ['JUICE_RIME+X', -28601, 'JUICE_RIME_BASE', 'DSK/UNPRIORITIZED', 1],
        ['JUICE_RIME-X', -28602, 'JUICE_RIME_BASE', 'DSK/UNPRIORITIZED', 1],
        ...
        ['JUICE_RPWI_RWI', -28740, 'JUICE_MAG_BOOM', 'DSK/UNPRIORITIZED', 1],
        ['JUICE_RPWI_SCM', -28750, 'JUICE_MAG_BOOM', 'DSK/UNPRIORITIZED', 1]
    ]
