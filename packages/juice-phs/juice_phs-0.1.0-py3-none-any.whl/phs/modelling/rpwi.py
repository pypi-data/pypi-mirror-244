...
def langmir_probe_illumination(utc_start, utc_end, plot=False):
    """
    Calculate Langmir probe illumination percentages over a specified time range.
    ...
    list
        Percentage of surface illumination for Langmir Probe 1.
    list
        Percentage of surface illumination for Langmir Probe 2.
    list
        Percentage of surface illumination for Langmir Probe 3.
    list
        Percentage of surface illumination for Langmir Probe 4.
    """
    utcs, lp1_shadow = plot_shadow_timeline(utc0=utc_start, utcf=utc_end, n=1000, observer='JUICE_RPWI_LP1',
                                            observerframe='JUICE_RPWI_LP1')
    utcs, lp2_shadow = plot_shadow_timeline(utc0=utc_start, utcf=utc_end, n=1000, observer='JUICE_RPWI_LP2',
                                            observerframe='JUICE_RPWI_LP2')
    utcs, lp3_shadow = plot_shadow_timeline(utc0=utc_start, utcf=utc_end, n=1000, observer='JUICE_RPWI_LP3',
                                            observerframe='JUICE_RPWI_LP3')
    utcs, lp4_shadow = plot_shadow_timeline(utc0=utc_start, utcf=utc_end, n=1000, observer='JUICE_RPWI_LP4',
    ...
    if plot:
        ...
        fig.update_layout(
            title='RPWI Langmir Probe Illumination',
