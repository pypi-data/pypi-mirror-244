...
class FileSystemStorage(Storage):
    ...
    def iter_provider_directories(self, *, sort: bool = True) -> Iterator[Path]:
        child_directories_iter = self._iter_child_directories()
    ...
    def _iter_child_directories(self) -> Iterator[Path]:
        for child_dir in iter_child_directories(self.storage_dir):
