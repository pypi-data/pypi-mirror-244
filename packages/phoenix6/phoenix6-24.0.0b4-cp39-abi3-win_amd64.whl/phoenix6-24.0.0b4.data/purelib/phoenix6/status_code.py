...
class StatusCode(Enum):
    ...
    """
    Firm Vers could not be retrieved. Use Phoenix Tuner to check ID and
    ...
    """
    Firmware Too Old.  Use Phoenix Tuner to field upgrade your CTRE CAN device
    ...
    """
    Firmware is legacy non-FRC version.  Use Phoenix Tuner to field upgrade your
    ...
    """
    Firmware Too New.  Use Phoenix Tuner to field upgrade your CTRE CAN device
