...
class Squeeze(PetrelObject):
    ...
    def top_md(self, new_depth: float) -> None:
        ok = self._squeeze_object_link.SetTopMd(new_depth)
    ...
    def bottom_md(self, new_depth: float) -> None:
        ok = self._squeeze_object_link.SetBottomMd(new_depth)
    ...
    def start_date(self, new_date: datetime.datetime) -> None:
        ...
        ok = self._squeeze_object_link.SetStartDate(new_date)