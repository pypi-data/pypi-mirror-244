...
from anon.basemodel import AnonBase, MixinConfig
...
class Video(AnonBase):
    ...
    @staticmethod
    def _generate_video_url(video_id: str, client: "anon.client.BaseClient"):
    ...
    @classmethod
    def from_video_id(
        cls, video_id: str, client: "anon.client.BaseClient"
    ) -> "Video":
