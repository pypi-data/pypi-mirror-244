...
class MusicalFeaturesDTO(BaseModel):
    ...
    def use_case_validate_enum(cls, value):
        ...
        if value not in ('background', 'sport', 'focus', 'christmas', 'film', 'summer', 'adverts', 'party', 'relax', 'karaoke'):
