...
class FileSmallDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "id", "extension", "error_message", "folder", "objectKey", "uploadStartTime", "uploadEndTime", "fingerprintStatus", "fingerprintStartTime", "fingerprintEndTime", "inferenceStatus", "inferenceStartTime", "inferenceEndTime", "error_time"]
