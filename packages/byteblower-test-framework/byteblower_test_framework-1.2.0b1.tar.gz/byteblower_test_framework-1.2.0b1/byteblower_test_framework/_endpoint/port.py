...
class Port(Taggable, ABC):
    ...
    def discover_napt(
        ...
        This will resolve either the IP address of the ByteBlower port or
        the public IP address of the (IPv4 NAT) gateway when the ByteBlower
        port is using IPv4 and is located behind a NAT gateway.
