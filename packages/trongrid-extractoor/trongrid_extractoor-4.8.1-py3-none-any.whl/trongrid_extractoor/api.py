...
class Api:
    ...
    def iterate_contract_events(self, contract_address: str, event_name: Optional[str] = None) -> Iterator[TronEvent]:
        ...
        for events in self.contract_events(progress_tracker, event_name):
            for event in events:
                yield event
