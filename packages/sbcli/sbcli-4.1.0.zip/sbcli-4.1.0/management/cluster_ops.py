    ...
    if all_data:
        for d in all_data:
            out.append({
                "Node ID": d['id'],
                "Device Name": d['name'],
                "Provisioned": utils.humanbytes(d['total']),
                "Used": utils.humanbytes(d['used']),
        ...
        out.append({
            "Node ID": "Total",
            "Device Name": "Total",
            "Provisioned": utils.humanbytes(cluster_data['total']),
            "Util": utils.humanbytes(cluster_data['used']),
            "Util %": f"{utp}%",
        })
    if is_json:
