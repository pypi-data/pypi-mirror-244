...
from management import cluster_ops, utils
...
from management.controllers import pool_controller, lvol_controller, snapshot_controller, caching_node_controller
    ...
    def run(self):
        ...
        if args.command in ['storage-node', 'sn']:
            ...
            if sub_command in ['get-log-page-device', 'get-event-log',
                ...
                run_tests = args.test
                ret = storage_ops.restart_storage_node(node_id)
                ...
                if history:
                    ...
                    data = storage_ops.get_node_iostats(node_id)
                if data:
                    ret = utils.print_table(data)
                else:
                    return False
            ...
            if sub_command in ["add-dev-model", "rm-dev-model", "add-host-auth",
                ...
                if args.history:
                    ...
                    data = cluster_ops.get_iostats(args.cluster_id)
                if data:
                    ret = utils.print_table(data)
                else:
                    return False
            ...
            if sub_command == "deploy":
                ret = caching_node_controller.deploy()
