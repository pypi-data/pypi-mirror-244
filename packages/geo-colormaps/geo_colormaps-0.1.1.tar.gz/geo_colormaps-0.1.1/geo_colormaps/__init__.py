...
def render_colormap_list_doc(colormap_group_list: list, colormap_list_file: str) -> None:
    ...
    colormap_groups = [tupleii[1] for tupleii in colormap_group_list]
    try:
...
names = load_colormaps(DEFAULT_DEF_FOLDER, DEFAULT_IMG_FOLDER)

# render default colormap list markdown file
if IS_DEV:
    render_colormap_list_doc(names, DEFAULT_COLORMAP_LIST_FILE)
...
if not IS_DEV:
    render_colormap_list_doc(names, CUSTOM_COLORMAP_LIST_FILE)
