...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~loligram.types.InputMediaPhoto`, :obj:`~loligram.types.InputMediaVideo`, :obj:`~loligram.types.InputMediaAudio` and :obj:`~loligram.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~loligram.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from loligram.types import InputMediaPhoto, InputMediaVideo
