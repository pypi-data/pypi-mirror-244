...
class Object:
    def __init__(self, client: "loligram.Client" = None):
        self._client = client

    def bind(self, client: "loligram.Client"):
        """Bind a Client instance to this and to all nested Loligram objects.

        Parameters:
            client (:obj:`~loligram.types.Client`):
                The Client instance to bind this object with. Useful to re-enable bound methods after serializing and
                deserializing Loligram objects with ``repr`` and ``eval``.
        """
        self._client = client
    ...
    def default(obj: "Object"):
        ...
        # https://t.me/loligramchat/167281
