...
class InputMedia(Object):
    ...
    - :obj:`~loligram.types.InputMediaAnimation`
    - :obj:`~loligram.types.InputMediaDocument`
    - :obj:`~loligram.types.InputMediaAudio`
    - :obj:`~loligram.types.InputMediaPhoto`
    - :obj:`~loligram.types.InputMediaVideo`
    """
