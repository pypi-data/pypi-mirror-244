...
from loligram.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "loligram.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~loligram.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~loligram.handlers.MessageHandler` the *update* argument will be a :obj:`~loligram.types.Message`; in a :obj:`~loligram.handlers.CallbackQueryHandler` the *update* will be a :obj:`~loligram.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~loligram.filters.command` or :meth:`~loligram.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~loligram.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~loligram.types.Document` objects."""
...
"""Filter messages that contain :obj:`~loligram.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~loligram.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~loligram.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~loligram.types.Game` objects."""
...
"""Filter messages that contain :obj:`~loligram.types.Video` objects."""
...
"""Filter messages that contain :obj:`~loligram.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~loligram.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~loligram.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~loligram.types.Location` objects."""
...
"""Filter messages that contain :obj:`~loligram.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~loligram.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~loligram.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~loligram.types.Message`.
    ...
    async def func(flt, client: loligram.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~loligram.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~loligram.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~loligram.types.InlineQuery`: The filter will match ``query``.
