...
class OnInlineQuery:
    def on_inline_query(
        ...
        :obj:`~loligram.handlers.InlineQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, loligram.Client):
                self.add_handler(loligram.handlers.InlineQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        loligram.handlers.InlineQueryHandler(func, self),
