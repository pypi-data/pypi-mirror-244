...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <loligram.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <loligram.raw.base.PopularContact>`):
            N/A
