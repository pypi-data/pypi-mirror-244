...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <loligram.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <loligram.raw.base.Reaction>`, *optional*):
            N/A
