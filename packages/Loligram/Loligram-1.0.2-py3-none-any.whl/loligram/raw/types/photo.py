...
class Photo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.Photo`.
    ...
    Parameters:
        ...
        sizes (List of :obj:`PhotoSize <loligram.raw.base.PhotoSize>`):
            N/A
        ...
        video_sizes (List of :obj:`VideoSize <loligram.raw.base.VideoSize>`, *optional*):
            N/A
