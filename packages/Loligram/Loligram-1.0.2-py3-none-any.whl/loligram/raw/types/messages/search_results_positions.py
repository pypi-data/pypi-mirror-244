...
class SearchResultsPositions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.messages.SearchResultsPositions`.
    ...
    Parameters:
        ...
        positions (List of :obj:`SearchResultsPosition <loligram.raw.base.SearchResultsPosition>`):
            N/A
