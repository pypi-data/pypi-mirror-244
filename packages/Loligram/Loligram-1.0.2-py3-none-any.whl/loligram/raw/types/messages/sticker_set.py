...
class StickerSet(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.messages.StickerSet`.
    ...
    Parameters:
        set (:obj:`StickerSet <loligram.raw.base.StickerSet>`):
            N/A

        packs (List of :obj:`StickerPack <loligram.raw.base.StickerPack>`):
            N/A

        keywords (List of :obj:`StickerKeyword <loligram.raw.base.StickerKeyword>`):
            N/A

        documents (List of :obj:`Document <loligram.raw.base.Document>`):
            N/A
