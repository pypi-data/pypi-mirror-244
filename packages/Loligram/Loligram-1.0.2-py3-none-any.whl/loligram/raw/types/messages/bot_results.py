...
class BotResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.messages.BotResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`BotInlineResult <loligram.raw.base.BotInlineResult>`):
            N/A
        ...
        switch_pm (:obj:`InlineBotSwitchPM <loligram.raw.base.InlineBotSwitchPM>`, *optional*):
            N/A

        switch_webview (:obj:`InlineBotWebView <loligram.raw.base.InlineBotWebView>`, *optional*):
            N/A
