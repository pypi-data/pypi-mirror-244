...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <loligram.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <loligram.raw.base.PhoneConnection>`):
            N/A
