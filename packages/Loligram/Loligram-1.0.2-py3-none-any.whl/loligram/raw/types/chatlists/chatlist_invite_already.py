...
class ChatlistInviteAlready(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.chatlists.ChatlistInvite`.
    ...
    Parameters:
        ...
        missing_peers (List of :obj:`Peer <loligram.raw.base.Peer>`):
            N/A

        already_peers (List of :obj:`Peer <loligram.raw.base.Peer>`):
            N/A
