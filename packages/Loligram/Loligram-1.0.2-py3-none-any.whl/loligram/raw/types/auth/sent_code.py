...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <loligram.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <loligram.raw.base.auth.CodeType>`, *optional*):
            N/A
