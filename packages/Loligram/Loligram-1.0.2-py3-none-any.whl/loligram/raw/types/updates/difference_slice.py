...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages (List of :obj:`Message <loligram.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <loligram.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <loligram.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <loligram.raw.base.updates.State>`):
            N/A
