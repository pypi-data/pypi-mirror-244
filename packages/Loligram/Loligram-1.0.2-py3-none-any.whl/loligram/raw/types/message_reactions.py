...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <loligram.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <loligram.raw.base.MessagePeerReaction>`, *optional*):
            N/A
