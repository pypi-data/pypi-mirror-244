...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <loligram.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <loligram.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <loligram.raw.base.PremiumSubscriptionOption>`):
            N/A
