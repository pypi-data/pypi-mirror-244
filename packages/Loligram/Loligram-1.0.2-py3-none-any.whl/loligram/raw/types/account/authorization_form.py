...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <loligram.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <loligram.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <loligram.raw.base.SecureValueError>`):
            N/A
