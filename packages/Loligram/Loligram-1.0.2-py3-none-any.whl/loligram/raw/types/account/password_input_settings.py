...
class PasswordInputSettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.account.PasswordInputSettings`.
    ...
    Parameters:
        new_algo (:obj:`PasswordKdfAlgo <loligram.raw.base.PasswordKdfAlgo>`, *optional*):
            N/A
        ...
        new_secure_settings (:obj:`SecureSecretSettings <loligram.raw.base.SecureSecretSettings>`, *optional*):
            N/A
