...
class InputMediaUploadedDocument(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.InputMedia`.
    ...
    Parameters:
        file (:obj:`InputFile <loligram.raw.base.InputFile>`):
            N/A

        mime_type (``str``):
            N/A

        attributes (List of :obj:`DocumentAttribute <loligram.raw.base.DocumentAttribute>`):
            N/A
        ...
        thumb (:obj:`InputFile <loligram.raw.base.InputFile>`, *optional*):
            N/A

        stickers (List of :obj:`InputDocument <loligram.raw.base.InputDocument>`, *optional*):
            N/A
