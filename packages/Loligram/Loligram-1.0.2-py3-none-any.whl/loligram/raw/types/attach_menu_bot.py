...
class AttachMenuBot(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.AttachMenuBot`.
    ...
    Parameters:
        ...
        icons (List of :obj:`AttachMenuBotIcon <loligram.raw.base.AttachMenuBotIcon>`):
            N/A
        ...
        peer_types (List of :obj:`AttachMenuPeerType <loligram.raw.base.AttachMenuPeerType>`, *optional*):
            N/A
