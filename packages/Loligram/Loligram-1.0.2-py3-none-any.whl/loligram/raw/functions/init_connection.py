...
class InitConnection(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        query (Any function from :obj:`~loligram.raw.functions`):
            N/A

        proxy (:obj:`InputClientProxy <loligram.raw.base.InputClientProxy>`, *optional*):
            N/A

        params (:obj:`JSONValue <loligram.raw.base.JSONValue>`, *optional*):
            N/A

    Returns:
        Any object from :obj:`~loligram.raw.types`
    """
