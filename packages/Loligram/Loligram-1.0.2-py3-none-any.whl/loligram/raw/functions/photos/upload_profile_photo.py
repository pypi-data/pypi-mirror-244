...
class UploadProfilePhoto(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        bot (:obj:`InputUser <loligram.raw.base.InputUser>`, *optional*):
            N/A

        file (:obj:`InputFile <loligram.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <loligram.raw.base.InputFile>`, *optional*):
            N/A

        video_start_ts (``float`` ``64-bit``, *optional*):
            N/A

        video_emoji_markup (:obj:`VideoSize <loligram.raw.base.VideoSize>`, *optional*):
            N/A

    Returns:
        :obj:`photos.Photo <loligram.raw.base.photos.Photo>`
    """
