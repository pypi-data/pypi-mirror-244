...
class VerifyEmail(TLObject):  # type: ignore
    ...
    Parameters:
        purpose (:obj:`EmailVerifyPurpose <loligram.raw.base.EmailVerifyPurpose>`):
            N/A

        verification (:obj:`EmailVerification <loligram.raw.base.EmailVerification>`):
            N/A

    Returns:
        :obj:`account.EmailVerified <loligram.raw.base.account.EmailVerified>`
    """
