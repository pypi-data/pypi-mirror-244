...
class Search(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        filter (:obj:`MessagesFilter <loligram.raw.base.MessagesFilter>`):
            N/A
        ...
        from_id (:obj:`InputPeer <loligram.raw.base.InputPeer>`, *optional*):
            N/A
    ...
    Returns:
        :obj:`messages.Messages <loligram.raw.base.messages.Messages>`
    """
