...
class GetAdminLog(TLObject):  # type: ignore
    ...
    Parameters:
        channel (:obj:`InputChannel <loligram.raw.base.InputChannel>`):
            N/A
        ...
        events_filter (:obj:`ChannelAdminLogEventsFilter <loligram.raw.base.ChannelAdminLogEventsFilter>`, *optional*):
            N/A

        admins (List of :obj:`InputUser <loligram.raw.base.InputUser>`, *optional*):
            N/A

    Returns:
        :obj:`channels.AdminLogResults <loligram.raw.base.channels.AdminLogResults>`
    """
