...
class ValidateRequestedInfo(TLObject):  # type: ignore
    ...
    Parameters:
        invoice (:obj:`InputInvoice <loligram.raw.base.InputInvoice>`):
            N/A

        info (:obj:`PaymentRequestedInfo <loligram.raw.base.PaymentRequestedInfo>`):
            N/A
    ...
    Returns:
        :obj:`payments.ValidatedRequestedInfo <loligram.raw.base.payments.ValidatedRequestedInfo>`
    """
