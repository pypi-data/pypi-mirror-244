...
class OnDeletedMessages:
    def on_deleted_messages(
        ...
        :obj:`~loligram.handlers.DeletedMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, loligram.Client):
                self.add_handler(loligram.handlers.DeletedMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        loligram.handlers.DeletedMessagesHandler(func, self),
