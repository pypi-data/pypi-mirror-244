...
class BotCommandScope(Object):
    ...
    - :obj:`~loligram.types.BotCommandScopeDefault`
    - :obj:`~loligram.types.BotCommandScopeAllPrivateChats`
    - :obj:`~loligram.types.BotCommandScopeAllGroupChats`
    - :obj:`~loligram.types.BotCommandScopeAllChatAdministrators`
    - :obj:`~loligram.types.BotCommandScopeChat`
    - :obj:`~loligram.types.BotCommandScopeChatAdministrators`
    - :obj:`~loligram.types.BotCommandScopeChatMember`
