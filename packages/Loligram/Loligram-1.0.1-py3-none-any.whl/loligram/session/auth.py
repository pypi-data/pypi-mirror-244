...
from loligram.connection import Connection
from loligram.crypto import aes, rsa, prime
from loligram.errors import SecurityCheckMismatch
from loligram.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "loligram.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
