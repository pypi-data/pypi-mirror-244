...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~loligram.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, loligram.Client):
                self.add_handler(loligram.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        loligram.handlers.ChatJoinRequestHandler(func, self),
