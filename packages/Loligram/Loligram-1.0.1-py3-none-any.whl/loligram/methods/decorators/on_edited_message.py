...
class OnEditedMessage:
    def on_edited_message(
        ...
        :obj:`~loligram.handlers.EditedMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, loligram.Client):
                self.add_handler(loligram.handlers.EditedMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        loligram.handlers.EditedMessageHandler(func, self),
