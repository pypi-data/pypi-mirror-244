...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        This does the same thing as :meth:`~loligram.Client.add_handler` using the
        :obj:`~loligram.handlers.ChosenInlineResultHandler`.

        Parameters:
            filters (:obj:`~loligram.filters`, *optional*):
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, loligram.Client):
                self.add_handler(loligram.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        loligram.handlers.ChosenInlineResultHandler(func, self),
