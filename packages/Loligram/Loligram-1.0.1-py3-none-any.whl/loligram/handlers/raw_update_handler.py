...
class RawUpdateHandler(Handler):
    ...
    :meth:`~loligram.Client.add_handler`

    For a nicer way to register this handler, have a look at the
    :meth:`~loligram.Client.on_raw_update` decorator.
    ...
    Other Parameters:
        ...
        update (``Update``):
            ...
            :obj:`~loligram.raw.base.Update` base type.

        users (``dict``):
            Dictionary of all :obj:`~loligram.types.User` mentioned in the update.
            You can access extra info about the user (such as *first_name*, *last_name*, etc...) by using
            the IDs you find in the *update* argument (e.g.: *users[1768841572]*).

        chats (``dict``):
            Dictionary of all :obj:`~loligram.types.Chat` and
            :obj:`~loligram.raw.types.Channel` mentioned in the update.
    ...
    Note:
        ...
        - :obj:`~loligram.raw.types.UserEmpty`
        - :obj:`~loligram.raw.types.ChatEmpty`
        - :obj:`~loligram.raw.types.ChatForbidden`
        - :obj:`~loligram.raw.types.ChannelForbidden`
    """
