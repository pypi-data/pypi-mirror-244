...
class CheckedHistoryImportPeer:  # type: ignore
    ...
    Constructors:
        ...
        .. currentmodule:: loligram.raw.types
    ...
    QUALNAME = "loligram.raw.base.messages.CheckedHistoryImportPeer"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.loligram.org/telegram/base/checked-history-import-peer")
