...
class PeerDialogs(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.messages.PeerDialogs`.
    ...
    Parameters:
        dialogs (List of :obj:`Dialog <loligram.raw.base.Dialog>`):
            N/A

        messages (List of :obj:`Message <loligram.raw.base.Message>`):
            N/A
