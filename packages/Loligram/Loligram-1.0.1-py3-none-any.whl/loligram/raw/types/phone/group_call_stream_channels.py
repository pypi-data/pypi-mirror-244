...
class GroupCallStreamChannels(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.phone.GroupCallStreamChannels`.
    ...
    Parameters:
        channels (List of :obj:`GroupCallStreamChannel <loligram.raw.base.GroupCallStreamChannel>`):
            N/A
