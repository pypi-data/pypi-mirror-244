...
class GroupCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.phone.GroupCall`.
    ...
    Parameters:
        call (:obj:`GroupCall <loligram.raw.base.GroupCall>`):
            N/A

        participants (List of :obj:`GroupCallParticipant <loligram.raw.base.GroupCallParticipant>`):
            N/A
