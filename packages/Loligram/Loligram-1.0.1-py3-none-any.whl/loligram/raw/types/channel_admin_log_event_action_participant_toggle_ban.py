...
class ChannelAdminLogEventActionParticipantToggleBan(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.ChannelAdminLogEventAction`.
    ...
    Parameters:
        prev_participant (:obj:`ChannelParticipant <loligram.raw.base.ChannelParticipant>`):
            N/A

        new_participant (:obj:`ChannelParticipant <loligram.raw.base.ChannelParticipant>`):
            N/A
