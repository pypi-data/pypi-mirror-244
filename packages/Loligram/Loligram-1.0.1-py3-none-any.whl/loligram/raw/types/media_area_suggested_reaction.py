...
class MediaAreaSuggestedReaction(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.MediaArea`.
    ...
    Parameters:
        coordinates (:obj:`MediaAreaCoordinates <loligram.raw.base.MediaAreaCoordinates>`):
            N/A

        reaction (:obj:`Reaction <loligram.raw.base.Reaction>`):
            N/A
