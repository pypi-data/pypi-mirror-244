...
class Document(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.Document`.
    ...
    Parameters:
        ...
        thumbs (List of :obj:`PhotoSize <loligram.raw.base.PhotoSize>`, *optional*):
            N/A

        video_thumbs (List of :obj:`VideoSize <loligram.raw.base.VideoSize>`, *optional*):
            N/A
