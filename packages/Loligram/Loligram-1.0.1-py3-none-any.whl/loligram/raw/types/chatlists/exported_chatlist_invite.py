...
class ExportedChatlistInvite(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.chatlists.ExportedChatlistInvite`.
    ...
    Parameters:
        filter (:obj:`DialogFilter <loligram.raw.base.DialogFilter>`):
            N/A

        invite (:obj:`ExportedChatlistInvite <loligram.raw.base.ExportedChatlistInvite>`):
            N/A
