...
class ValidatedRequestedInfo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.payments.ValidatedRequestedInfo`.
    ...
    Parameters:
        ...
        shipping_options (List of :obj:`ShippingOption <loligram.raw.base.ShippingOption>`, *optional*):
            N/A
