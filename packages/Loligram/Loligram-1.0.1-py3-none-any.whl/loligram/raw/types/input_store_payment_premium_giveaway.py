...
class InputStorePaymentPremiumGiveaway(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.InputStorePaymentPurpose`.
    ...
    Parameters:
        boost_peer (:obj:`InputPeer <loligram.raw.base.InputPeer>`):
            N/A
        ...
        additional_peers (List of :obj:`InputPeer <loligram.raw.base.InputPeer>`, *optional*):
            N/A
