...
class PageBlockRelatedArticles(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.PageBlock`.
    ...
    Parameters:
        title (:obj:`RichText <loligram.raw.base.RichText>`):
            N/A

        articles (List of :obj:`PageRelatedArticle <loligram.raw.base.PageRelatedArticle>`):
            N/A
