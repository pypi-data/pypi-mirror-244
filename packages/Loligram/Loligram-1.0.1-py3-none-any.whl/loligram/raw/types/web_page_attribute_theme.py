...
class WebPageAttributeTheme(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~loligram.raw.base.WebPageAttribute`.
    ...
    Parameters:
        documents (List of :obj:`Document <loligram.raw.base.Document>`, *optional*):
            N/A

        settings (:obj:`ThemeSettings <loligram.raw.base.ThemeSettings>`, *optional*):
            N/A
