...
class JoinGroupCall(TLObject):  # type: ignore
    ...
    Parameters:
        call (:obj:`InputGroupCall <loligram.raw.base.InputGroupCall>`):
            N/A

        join_as (:obj:`InputPeer <loligram.raw.base.InputPeer>`):
            N/A

        params (:obj:`DataJSON <loligram.raw.base.DataJSON>`):
            N/A
