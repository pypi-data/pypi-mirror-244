...
class OnCallbackQuery:
    def on_callback_query(
        ...
        :obj:`~loligram.handlers.CallbackQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, loligram.Client):
                self.add_handler(loligram.handlers.CallbackQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        loligram.handlers.CallbackQueryHandler(func, self),
