...
import loligram
from loligram import __version__, __license__
from loligram import enums
from loligram import raw
from loligram import utils
from loligram.crypto import aes
from loligram.errors import CDNFileHashMismatch
from loligram.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    BadRequest
)
from loligram.handlers.handler import Handler
from loligram.methods import Methods
from loligram.session import Auth, Session
from loligram.storage import FileStorage, MemoryStorage
from loligram.types import User, TermsOfService
from loligram.utils import ainput
...
class Client(Methods):
    """Loligram Client, the main means for interacting with Telegram.
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~loligram.Client.export_session_string` before stopping the client to get a session string you can
        ...
        workdir (``str``, *optional*):
            ...
            The working directory is the location in the filesystem where Loligram will store the session files.
    ...
    APP_VERSION = f"Loligram {__version__}"
    ...
    async def authorize(self) -> User:
        ...
        print(f"Welcome to Loligram (version {__version__})")
        print(f"Loligram is free software and comes with ABSOLUTELY NO WARRANTY. Licensed\n"
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~loligram.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("The API key is required for new authorizations. "
                                     "More info: https://docs.loligram.org/start/auth")
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except loligram.StopTransmission:
                raise
            except Exception as e:
                log.exception(e)
            finally:
