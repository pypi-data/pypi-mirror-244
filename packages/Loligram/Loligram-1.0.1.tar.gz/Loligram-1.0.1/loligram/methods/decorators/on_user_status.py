...
class OnUserStatus:
    def on_user_status(
        ...
        :obj:`~loligram.handlers.UserStatusHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, loligram.Client):
                self.add_handler(loligram.handlers.UserStatusHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        loligram.handlers.UserStatusHandler(func, self),
