...
from loligram.errors import PhoneMigrate, NetworkMigrate
from loligram.session import Session, Auth
...
class SendCode:
    async def send_code(
        ...
        Returns:
            :obj:`~loligram.types.SentCode`: On success, an object containing information on the sent confirmation code
            is returned.
