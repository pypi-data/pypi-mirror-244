...
import loligram
from loligram import StopTransmission, enums
from loligram import raw
from loligram import types
from loligram import utils
from loligram.errors import FilePartMissing
from loligram.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~loligram.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~loligram.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~loligram.Client.stop_transmission`, None is returned.
