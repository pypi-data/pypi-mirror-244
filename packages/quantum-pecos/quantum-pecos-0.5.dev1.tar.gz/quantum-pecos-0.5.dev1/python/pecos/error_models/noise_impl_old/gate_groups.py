...
two_qubits = {'CNOT', 'CZ', 'SWAP', 'G', 'MS', 'SqrtXX', 'SqrtZZ', 'RXX', 'RYY', 'RZZ',
              "CX", "RXX", "RYY", "RZZ", "SXX", "SXXdg", "SYY", "SYYdg", "SZZ", "SZZdg"}

one_qubits = {'I', 'X', 'Y', 'Z', 'Q', 'Qd', 'R', 'Rd', 'S', 'Sd', 'H', 'H1', 'H2', 'H3', 'H4', 'H5', 'H6',
              'H+z+x', 'H-z-x', 'H+y-z', 'H-y-z', 'H-x+y', 'H-x-y',
              'F1', 'F1d', 'F2', 'F2d', 'F3', 'F3d', 'F4', 'F4d',
              'SqrtX', 'SqrtXd', 'SqrtY', 'SqrtYd', 'SqrtZ', 'SqrtZd', 'RZ',
              'U1q', 'RXY1Q',
              "SX", "SXdg", "SY", "SYdg", "SZ", "SZdg", "F", "Fdg", "R1XY"
              }
