    ...
    def run(self):
        ...
        try:
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource prodvana {PLUGIN_VERSION}`
                """)
            else:
                raise
...
def readme():
    try:
        ...
        return "prodvana Pulumi Package - Development Version"


setup(name='pulumi_prodvana',
      python_requires='>=3.7',
      version=VERSION,
