...
#if !defined( _LIBNK2_TYPES_H )
#define _LIBNK2_TYPES_H
...
#define __USE_UNIX98
#define LIBNK2_DEFINITION_UNIX98
#endif

#include <wchar.h>

#if defined( LIBNK2_DEFINITION_UNIX98 )
#undef __USE_UNIX98
#undef LIBNK2_DEFINITION_UNIX98
#endif
