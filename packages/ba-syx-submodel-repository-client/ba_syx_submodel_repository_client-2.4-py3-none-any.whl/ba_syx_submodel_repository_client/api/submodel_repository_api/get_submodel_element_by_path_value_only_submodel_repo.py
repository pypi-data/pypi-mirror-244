...
def _get_kwargs(
    ...
    *,
    client: Client,
    level: Union[
        Unset, None, GetSubmodelElementByPathValueOnlySubmodelRepoLevel
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        submodel_identifier (str):
        id_short_path (str):
        level (Union[Unset, None, GetSubmodelElementByPathValueOnlySubmodelRepoLevel]):  Default:
            GetSubmodelElementByPathValueOnlySubmodelRepoLevel.DEEP.
        extent (Union[Unset, None, GetSubmodelElementByPathValueOnlySubmodelRepoExtent]):
            Default: GetSubmodelElementByPathValueOnlySubmodelRepoExtent.WITHOUTBLOBVALUE.
