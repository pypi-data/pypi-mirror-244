...
class BBox(StrictJSONObject['BBox']):
    """
    A rectangular region in an image.
    """
    # The x-coordinate of the left side
    left: int = NumberProperty(integer_only=True)

    # The y-coordinate of the top
    top: int = NumberProperty(integer_only=True)

    # The x-coordinate of the right side
    right: int = NumberProperty(integer_only=True)

    # The y-coordinate of the bottom
    bottom: int = NumberProperty(integer_only=True)
