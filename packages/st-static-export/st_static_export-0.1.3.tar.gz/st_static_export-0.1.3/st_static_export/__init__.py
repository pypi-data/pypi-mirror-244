...
class StreamlitStaticExport:
    ...
    def export_altair_graph(self, id:str, html_content:alt.Chart, graph_class:str = None) -> None:
       
        soup = BeautifulSoup(html_content.to_html(output_div=id, fullhtml=True, ),"html.parser")
        body = soup.find("body")
