...
class FaceBlur(Scenario):
    def __init__(self, scenario_name='face-blur', camera_name=0, events=None, triton_url=TRITON_HTTP_URL):
        ...
        self.model = yolov5_triton(triton_url, 'face-blur')
    ...
    def start(self, camera_name=0, test=False):
        ...
        import cv2
        # camera_name = 'rtsp://admin:sumanth123@192.168.29.74:554/cam/realmonitor?channel=1&subtype=0&unicast=true&proto=Onvif'
