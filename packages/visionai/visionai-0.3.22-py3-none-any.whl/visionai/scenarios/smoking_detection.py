...
class SmokingDetection(Scenario):
    def __init__(self, scenario_name="smoking-detection", camera_name=0, events=None, triton_url=TRITON_HTTP_URL):
    ...
    def start(self, camera_name=0, test=False):
        ...
        while True:
            ...
            results.print()
            results.show()
            # if result contains people detected with smoking - then fire an event.
