...
from kadita.basemodels import SFace, DeepID
from kadita.extendedmodels import Race
from kadita.commons import realtime, distance as dst
from kadita.commons import functions
...
def analyze(
        img_path,
        actions="race",  # actions=("emotion", "age", "gender", "race"),
        enforce_detection=True,
        detector_backend="opencv",
        align=True,
        silent=False,
    ...
    for action in actions:
        if action not in "race": #if action not in ("emotion", "age", "gender", "race"):
            raise ValueError(
