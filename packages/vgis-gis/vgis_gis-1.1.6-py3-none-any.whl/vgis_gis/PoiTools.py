...
from baiduSetting import BaiduKeySetting


class POIOperater:

    def __init__(self):
        baidu_key_setting = BaiduKeySetting()
        self.baidu_key_list = baidu_key_setting.key_list
    ...
    def get_all_city_of_country(self):
        ...
        if (platform.system() == 'Windows'):
            baidu_city_code_file_path = os.getcwd() + "\\com\\vgis\qcn\\resouces\\BaiduMap_cityCode.vgis_txt"
        else:
            baidu_city_code_file_path = "/app/python/python/BaiduMap_cityCode.vgis_txt"
