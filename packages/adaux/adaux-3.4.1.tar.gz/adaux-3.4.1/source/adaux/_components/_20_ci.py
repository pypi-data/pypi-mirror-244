...
class CiMixin(PayloadMixin, MetaMixin):
    ...
    def _triggers_from_gitlab_ci(  # pylint: disable=too-many-branches,too-many-statements
        self,
    ) -> tp.Sequence[str]:
        triggers = []
