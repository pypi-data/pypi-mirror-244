...
class CziReader:
    ...
    def __init__(self, filepath: str, file_input_type: ReaderFileInputTypes = ReaderFileInputTypes.Standard) -> None:
        ...
        if file_input_type is ReaderFileInputTypes.Curl:
            if validators.url(filepath):
                self._czi_reader = _pylibCZIrw.czi_reader(ReaderFileInputTypes.Curl.value, filepath)
            else:
...
def open_czi(filepath: str, file_input_type: ReaderFileInputTypes = ReaderFileInputTypes.Standard) -> Generator:
    ...
    """
    reader = CziReader(filepath, file_input_type)
    try:
        yield reader
    finally:
        reader.close()
