...
def _get_kwargs(
    *,
    client: Client,
    json_body: AssetAdministrationShell,
) -> Dict[str, Any]:
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[AssetAdministrationShell, Result]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[AssetAdministrationShell, Result]]:
    return Response(
