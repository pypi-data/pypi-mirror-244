...
class RecoverHyperVVmStandaloneHostSourceConfig(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, source, volume, *args, **kwargs):  # noqa: E501
        """RecoverHyperVVmStandaloneHostSourceConfig - a model defined in OpenAPI
