...
class UpdateProtectionGroupsStateRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, action, ids, *args, **kwargs):  # noqa: E501
        """UpdateProtectionGroupsStateRequest - a model defined in OpenAPI
