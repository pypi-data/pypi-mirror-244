...
class CreateTenantParameters(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, tenant_id_suffix, *args, **kwargs):  # noqa: E501
        """CreateTenantParameters - a model defined in OpenAPI
        ...
        required_args = {
            'name': name,
            'tenant_id_suffix': tenant_id_suffix,
        }
        model_args = {}
