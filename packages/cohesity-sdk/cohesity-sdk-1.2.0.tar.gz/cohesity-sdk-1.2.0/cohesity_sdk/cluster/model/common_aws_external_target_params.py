...
class CommonAwsExternalTargetParams(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, bucket_name, region, *args, **kwargs):  # noqa: E501
        """CommonAwsExternalTargetParams - a model defined in OpenAPI
