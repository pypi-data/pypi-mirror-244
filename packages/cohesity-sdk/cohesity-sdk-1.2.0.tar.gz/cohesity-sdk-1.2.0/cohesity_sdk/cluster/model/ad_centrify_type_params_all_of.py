...
class AdCentrifyTypeParamsAllOf(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, fallback_option, *args, **kwargs):  # noqa: E501
        """AdCentrifyTypeParamsAllOf - a model defined in OpenAPI
