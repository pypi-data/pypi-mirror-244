...
class UpdateOdpRemoteClusterParams(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, cluster_name, *args, **kwargs):  # noqa: E501
        """UpdateOdpRemoteClusterParams - a model defined in OpenAPI
