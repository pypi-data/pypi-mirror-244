...
class RecoverKubernetesNamespaceParams(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """RecoverKubernetesNamespaceParams - a model defined in OpenAPI

        Args:

        Keyword Args:
            target_environment (str): Specifies the environment of the recovery target. The corresponding params below must be filled out.. defaults to "kKubernetes", must be one of ["kKubernetes", ]  # noqa: E501
