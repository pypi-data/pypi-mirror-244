...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.recover_exchange_dbs_snapshot_params_all_of import RecoverExchangeDbsSnapshotParamsAllOf
    globals()['CommonRecoverObjectSnapshotParams'] = CommonRecoverObjectSnapshotParams
    globals()['RecoverExchangeDbsSnapshotParamsAllOf'] = RecoverExchangeDbsSnapshotParamsAllOf


class RecoverExchangeDbsSnapshotParams(ModelComposed):
    ...
    def __init__(self, snapshot_id, *args, **kwargs):  # noqa: E501
        """RecoverExchangeDbsSnapshotParams - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            recovery_target_config ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): Specifies the recovery target configuration if the recovery is set to a different location which is different from the original source.. [optional]  # noqa: E501
        """
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'allOf': [
              ...
              RecoverExchangeDbsSnapshotParamsAllOf,
          ],
          'oneOf': [
          ],
        }
