...
class RdsConfig(ModelNormal):
    ...
    def __init__(self, db_instance_id, db_port, enable_auto_minor_version_upgrade, enable_copy_tags_to_snapshots, enable_iam_db_authentication, is_multi_az_deployment, *args, **kwargs):  # noqa: E501
        """RdsConfig - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            db_option_group ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): Specifies entity representing the RDS option group to use while restoring the DB.. [optional]  # noqa: E501
            db_parameter_group ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): Specifies the entity representing the RDS parameter group to use while restoring the DB.. [optional]  # noqa: E501
