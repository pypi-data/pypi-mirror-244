...
class CreateBifrostConnectorRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, connection_id, name, *args, **kwargs):  # noqa: E501
        """CreateBifrostConnectorRequest - a model defined in OpenAPI
