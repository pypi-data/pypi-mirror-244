...
class RecoverOracleAppParams(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'oracle_target_params': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'oracle_target_params': 'oracleTargetParams',  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """RecoverOracleAppParams - a model defined in OpenAPI

        Args:

        Keyword Args:
            target_environment (str): Specifies the environment of the recovery target. The corresponding params below must be filled out.. defaults to "kOracle", must be one of ["kOracle", ]  # noqa: E501
            ...
            oracle_target_params ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): Specifies the params for recovering to a oracle host. Provided oracle backup should be recovered to same type of target host. For Example: If you have oracle backup taken from a physical host then that should be recovered to physical host only.. [optional]  # noqa: E501
        ...
        target_environment = kwargs.get('target_environment', "kOracle")
