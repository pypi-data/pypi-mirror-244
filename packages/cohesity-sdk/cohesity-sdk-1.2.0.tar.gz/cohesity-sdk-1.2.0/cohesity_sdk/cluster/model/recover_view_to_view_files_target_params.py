...
class RecoverViewToViewFilesTargetParams(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, recover_to_new_view, *args, **kwargs):  # noqa: E501
        """RecoverViewToViewFilesTargetParams - a model defined in OpenAPI
