...
class VmwareTargetParamsForRecoverVApp(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'rename_recovered_v_apps_params': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'rename_recovered_v_apps_params': 'renameRecoveredVAppsParams',  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """VmwareTargetParamsForRecoverVApp - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            rename_recovered_v_apps_params ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): Specifies params to rename the vApps that are recovered. If not specified, the original names of the vApps are preserved.. [optional]  # noqa: E501
