...
class RecoverSfdcObjectParams(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, include_deleted_objects, *args, **kwargs):  # noqa: E501
        """RecoverSfdcObjectParams - a model defined in OpenAPI
