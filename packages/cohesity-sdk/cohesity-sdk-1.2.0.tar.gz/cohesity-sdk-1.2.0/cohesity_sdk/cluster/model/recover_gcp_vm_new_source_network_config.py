...
class RecoverGcpVmNewSourceNetworkConfig(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, subnet, *args, **kwargs):  # noqa: E501
        """RecoverGcpVmNewSourceNetworkConfig - a model defined in OpenAPI
