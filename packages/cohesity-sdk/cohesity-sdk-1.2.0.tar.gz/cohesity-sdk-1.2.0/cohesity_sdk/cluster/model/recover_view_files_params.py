...
class RecoverViewFilesParams(ModelNormal):
    ...
    def __init__(self, files_and_folders, *args, **kwargs):  # noqa: E501
        """RecoverViewFilesParams - a model defined in OpenAPI

        Args:
            files_and_folders ([ViewRecoverFileAndFolderInfo], none_type): Specifies the list of info about the view files and folders to be recovered.
