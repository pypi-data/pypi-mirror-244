...
class UpdateNodeBondInterfaceParams(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, members, node_type, *args, **kwargs):  # noqa: E501
        """UpdateNodeBondInterfaceParams - a model defined in OpenAPI
