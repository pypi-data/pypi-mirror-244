...
from cohesity_sdk.helios import rest
from cohesity_sdk.helios.configuration import Configuration
from cohesity_sdk.helios.exceptions import ApiTypeError, ApiValueError, ApiException
from cohesity_sdk.helios.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        try:
            ...
            msg = str(e)
            msg += '. Also make sure you specify specific optional arguments by name for a SDK call'
            raise ApiException(422, reason=msg) from None
