...
def lazy_import():
    from cohesity_sdk.helios.model.archival_oracle_external_target_params_all_of import ArchivalOracleExternalTargetParamsAllOf
...
class ArchivalOracleExternalTargetParams(ModelComposed):
