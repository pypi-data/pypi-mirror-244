...
def lazy_import():
    from cohesity_sdk.helios.model.application_details_all_of import ApplicationDetailsAllOf
    from cohesity_sdk.helios.model.common_application_properties import CommonApplicationProperties
    from cohesity_sdk.helios.model.http_params import HttpParams
    from cohesity_sdk.helios.model.operation import Operation
    from cohesity_sdk.helios.model.quorum_member_decision import QuorumMemberDecision
    from cohesity_sdk.helios.model.user_info import UserInfo
    globals()['ApplicationDetailsAllOf'] = ApplicationDetailsAllOf
    globals()['CommonApplicationProperties'] = CommonApplicationProperties
    globals()['HttpParams'] = HttpParams
    globals()['Operation'] = Operation
    globals()['QuorumMemberDecision'] = QuorumMemberDecision
    globals()['UserInfo'] = UserInfo


class ApplicationDetails(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'action_after_expiry': (str, none_type,),  # noqa: E501
            'quorum_decisions': ([QuorumMemberDecision], none_type,),  # noqa: E501
            'operation': (Operation,),  # noqa: E501
            'key_info': (str, none_type,),  # noqa: E501
            'http_params': (HttpParams,),  # noqa: E501
            'pre_value': (str, none_type,),  # noqa: E501
            'new_value': (str, none_type,),  # noqa: E501
            'requester': (UserInfo,),  # noqa: E501
            'initiated_time': (int, none_type,),  # noqa: E501
            'status': (str, none_type,),  # noqa: E501
            'expiration_period_days': (int, none_type,),  # noqa: E501
            'final_decision_made_time': (int, none_type,),  # noqa: E501
            'approval_count': (int, none_type,),  # noqa: E501
            'required_approval_count': (int, none_type,),  # noqa: E501
    ...
    attribute_map = {
        'id': 'id',  # noqa: E501
        'action_after_expiry': 'actionAfterExpiry',  # noqa: E501
        'quorum_decisions': 'quorumDecisions',  # noqa: E501
        'operation': 'operation',  # noqa: E501
        'key_info': 'keyInfo',  # noqa: E501
        'http_params': 'httpParams',  # noqa: E501
        'pre_value': 'preValue',  # noqa: E501
    ...
    def __init__(self, id, *args, **kwargs):  # noqa: E501
        """ApplicationDetails - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            action_after_expiry (str, none_type): Action performed after application expired.. [optional]  # noqa: E501
            quorum_decisions ([QuorumMemberDecision], none_type): List of decisions made by quorum group members.. [optional]  # noqa: E501
            operation (Operation): [optional]  # noqa: E501
            key_info (str, none_type): Application used key.. [optional]  # noqa: E501
            http_params (HttpParams): [optional]  # noqa: E501
            pre_value (str, none_type): Previous value for this application info.. [optional]  # noqa: E501
            new_value (str, none_type): New value for this application info.. [optional]  # noqa: E501
