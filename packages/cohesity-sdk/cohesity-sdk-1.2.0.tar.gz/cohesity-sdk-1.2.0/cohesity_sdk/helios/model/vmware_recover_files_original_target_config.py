...
class VmwareRecoverFilesOriginalTargetConfig(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, recover_method, recover_to_original_path, *args, **kwargs):  # noqa: E501
        """VmwareRecoverFilesOriginalTargetConfig - a model defined in OpenAPI
