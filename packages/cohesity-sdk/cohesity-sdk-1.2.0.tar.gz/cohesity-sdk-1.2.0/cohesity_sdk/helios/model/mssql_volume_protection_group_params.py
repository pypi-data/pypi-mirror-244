...
def lazy_import():
    from cohesity_sdk.helios.model.common_mssql_protection_group_params import CommonMSSQLProtectionGroupParams
    from cohesity_sdk.helios.model.filter import Filter
    from cohesity_sdk.helios.model.indexing_policy import IndexingPolicy
    from cohesity_sdk.helios.model.mssql_volume_protection_group_host_params import MSSQLVolumeProtectionGroupHostParams
    from cohesity_sdk.helios.model.mssql_volume_protection_group_object_params import MSSQLVolumeProtectionGroupObjectParams
    from cohesity_sdk.helios.model.mssql_volume_protection_group_params_all_of import MSSQLVolumeProtectionGroupParamsAllOf
...
class MSSQLVolumeProtectionGroupParams(ModelComposed):
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        """MSSQLVolumeProtectionGroupParams - a model defined in OpenAPI

        Args:
            objects ([MSSQLVolumeProtectionGroupObjectParams], none_type): Specifies the list of object ids to be protected.
