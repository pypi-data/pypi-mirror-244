...
def lazy_import():
    from cohesity_sdk.helios.model.backup_policy import BackupPolicy
    from cohesity_sdk.helios.model.blackout_window import BlackoutWindow
    from cohesity_sdk.helios.model.extended_retention_policy import ExtendedRetentionPolicy
    from cohesity_sdk.helios.model.protection_policy import ProtectionPolicy
    from cohesity_sdk.helios.model.protection_policy_request_all_of import ProtectionPolicyRequestAllOf
    from cohesity_sdk.helios.model.retry_options import RetryOptions
    from cohesity_sdk.helios.model.targets_configuration import TargetsConfiguration
...
class ProtectionPolicyRequest(ModelComposed):
