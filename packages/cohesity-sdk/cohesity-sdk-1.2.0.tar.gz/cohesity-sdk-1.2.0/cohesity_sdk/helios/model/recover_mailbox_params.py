...
def lazy_import():
    from cohesity_sdk.helios.model.object_mailbox_param import ObjectMailboxParam
...
class RecoverMailboxParams(ModelNormal):
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        """RecoverMailboxParams - a model defined in OpenAPI

        Args:
            objects ([ObjectMailboxParam], none_type): Specifies a list of Mailbox params associated with the objects to recover.
