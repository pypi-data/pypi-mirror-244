...
def lazy_import():
    from cohesity_sdk.helios.model.aws_aurora_protection_group_object_params import AwsAuroraProtectionGroupObjectParams
    globals()['AwsAuroraProtectionGroupObjectParams'] = AwsAuroraProtectionGroupObjectParams


class AwsAuroraProtectionGroupParams(ModelNormal):
