...
def lazy_import():
    from cohesity_sdk.helios.model.iam_role_aws_credentials import IamRoleAwsCredentials
    from cohesity_sdk.helios.model.iam_user_aws_credentials import IamUserAwsCredentials
    globals()['IamRoleAwsCredentials'] = IamRoleAwsCredentials
    globals()['IamUserAwsCredentials'] = IamUserAwsCredentials


class StandardParams(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, auth_method_type, *args, **kwargs):  # noqa: E501
        """StandardParams - a model defined in OpenAPI
