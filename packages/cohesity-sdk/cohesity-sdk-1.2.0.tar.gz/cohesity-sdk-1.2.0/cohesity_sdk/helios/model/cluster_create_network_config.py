...
def lazy_import():
    from cohesity_sdk.helios.model.cluster_dhcp_network_config import ClusterDhcpNetworkConfig
    from cohesity_sdk.helios.model.cluster_manual_network_config import ClusterManualNetworkConfig
    globals()['ClusterDhcpNetworkConfig'] = ClusterDhcpNetworkConfig
    globals()['ClusterManualNetworkConfig'] = ClusterManualNetworkConfig


class ClusterCreateNetworkConfig(ModelNormal):
