...
def lazy_import():
    from cohesity_sdk.helios.model.protection_group_archival_run_filter_params import ProtectionGroupArchivalRunFilterParams
    globals()['ProtectionGroupArchivalRunFilterParams'] = ProtectionGroupArchivalRunFilterParams


class GetMcmProtectionGroupsActivityReqParams(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'protection_group_identifiers': ([str], none_type,),  # noqa: E501
            ...
            'include_object_details': (bool, none_type,),  # noqa: E501
            'backup_run_params': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type,),  # noqa: E501
            'archival_run_params': (ProtectionGroupArchivalRunFilterParams,),  # noqa: E501
        }
    ...
    attribute_map = {
        'protection_group_identifiers': 'protectionGroupIdentifiers',  # noqa: E501
        ...
        'include_object_details': 'includeObjectDetails',  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """GetMcmProtectionGroupsActivityReqParams - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            protection_group_identifiers ([str], none_type): Specifies the list of Protection Group identifiers to filter the activity.. [optional]  # noqa: E501
            ...
            run_start_time_usecs (int, none_type): Specifies the time in Unix timestamp epoch in microsecond which filters all the activity started at this time.. [optional]  # noqa: E501
            ...
            include_object_details (bool, none_type): Specifies whether to include details for objects in response. By default this is false.. [optional]  # noqa: E501
            backup_run_params ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): Specifies the additional filters in case activity type is set to 'BackupRun'. This does not apply to RPaaS.. [optional]  # noqa: E501
            archival_run_params (ProtectionGroupArchivalRunFilterParams): [optional]  # noqa: E501
        """
