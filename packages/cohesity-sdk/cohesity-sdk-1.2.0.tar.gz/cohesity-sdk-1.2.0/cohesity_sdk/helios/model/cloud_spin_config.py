...
def lazy_import():
    from cohesity_sdk.helios.model.cloud_spin_config_all_of import CloudSpinConfigAllOf
    from cohesity_sdk.helios.model.cloud_spin_target import CloudSpinTarget
...
class CloudSpinConfig(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, schedule, retention, target, *args, **kwargs):  # noqa: E501
        """CloudSpinConfig - a model defined in OpenAPI

        Args:
            schedule (TargetSchedule):
            retention (Retention):
            target (CloudSpinTarget):
