...
def lazy_import():
    from cohesity_sdk.helios.model.downtiered_data_location import DowntieredDataLocation
    globals()['DowntieredDataLocation'] = DowntieredDataLocation


class UptieringTarget(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, storage_domain_id, *args, **kwargs):  # noqa: E501
        """UptieringTarget - a model defined in OpenAPI
