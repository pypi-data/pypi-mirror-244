...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.hdfs_source_registration_params_all_of import HdfsSourceRegistrationParamsAllOf
...
class HdfsSourceRegistrationParams(ModelComposed):
