...
def lazy_import():
    from cohesity_sdk.helios.model.common_tdm_refresh_task_response_params import CommonTdmRefreshTaskResponseParams
    from cohesity_sdk.helios.model.oracle_clone_refresh_task import OracleCloneRefreshTask
    from cohesity_sdk.helios.model.tdm_refresh_task_response_params_all_of import TdmRefreshTaskResponseParamsAllOf
...
class TdmRefreshTaskResponseParams(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """TdmRefreshTaskResponseParams - a model defined in OpenAPI

        Args:

        Keyword Args:
            environment (str, none_type): Specifies the environment of the TDM refresh task.. defaults to "kOracle", must be one of ["kOracle", ]  # noqa: E501
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'allOf': [
              ...
              TdmRefreshTaskResponseParamsAllOf,
          ],
          'oneOf': [
          ],
        }
