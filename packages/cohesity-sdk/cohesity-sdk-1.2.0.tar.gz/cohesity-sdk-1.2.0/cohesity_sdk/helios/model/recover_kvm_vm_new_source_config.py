...
class RecoverKvmVmNewSourceConfig(ModelNormal):
    ...
    def __init__(self, source, cluster, data_center, storage_domain, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            network_config ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Specifies the networking configuration to be applied to the recovered VMs.. [optional]  # noqa: E501
        """
