...
def lazy_import():
    from cohesity_sdk.helios.model.no_sql_object_property import NoSqlObjectProperty
    globals()['NoSqlObjectProperty'] = NoSqlObjectProperty


class RecoverMongodbNoSqlObjectParams(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, object_name, *args, **kwargs):  # noqa: E501
        """RecoverMongodbNoSqlObjectParams - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            rename_to (str, none_type): Specifies the new name to which the object should be renamed. at the time of recovery.. [optional]  # noqa: E501
