...
def lazy_import():
    from cohesity_sdk.helios.model.aws_agent_protection_group_object_params import AwsAgentProtectionGroupObjectParams
...
class AwsAgentProtectionGroupParams(ModelNormal):
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        """AwsAgentProtectionGroupParams - a model defined in OpenAPI

        Args:
            objects ([AwsAgentProtectionGroupObjectParams]): Specifies the objects to be included in the Protection Group.
