...
def lazy_import():
    from cohesity_sdk.helios.model.clone_action_cleanup_cloud_resources_cleanup_params import CloneActionCleanupCloudResourcesCleanupParams
    from cohesity_sdk.helios.model.clone_action_cleanup_power_off_vm_params import CloneActionCleanupPowerOffVmParams
...
class CloneActionCleanupParams(ModelNormal):
    ...
    allowed_values = {
        ('cleanup_type',): {
            ...
            'CLOUDRESOURCESCLEANUP': "CloudResourcesCleanup",
        },
    }
    ...
    @convert_js_args_to_python_args
    def __init__(self, cleanup_type, *args, **kwargs):  # noqa: E501
        """CloneActionCleanupParams - a model defined in OpenAPI
