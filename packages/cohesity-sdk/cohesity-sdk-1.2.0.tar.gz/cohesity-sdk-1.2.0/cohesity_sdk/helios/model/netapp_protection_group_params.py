...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.netapp_protection_group_object_params import NetappProtectionGroupObjectParams
    from cohesity_sdk.helios.model.snap_mirror_config import SnapMirrorConfig
...
class NetappProtectionGroupParams(ModelNormal):
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        """NetappProtectionGroupParams - a model defined in OpenAPI

        Args:
            objects ([NetappProtectionGroupObjectParams]): Specifies the objects to be included in the Protection Group.
