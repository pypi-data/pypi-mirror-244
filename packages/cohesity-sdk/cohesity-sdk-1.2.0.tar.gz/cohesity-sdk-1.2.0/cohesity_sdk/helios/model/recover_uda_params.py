...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.recover_uda_snapshot_params import RecoverUdaSnapshotParams
    globals()['KeyValuePair'] = KeyValuePair
    globals()['RecoverUdaSnapshotParams'] = RecoverUdaSnapshotParams


class RecoverUdaParams(ModelNormal):
    ...
    def __init__(self, snapshots, *args, **kwargs):  # noqa: E501
        """RecoverUdaParams - a model defined in OpenAPI

        Args:
            snapshots ([RecoverUdaSnapshotParams], none_type): Specifies the local snapshot ids and other details of the objects to be recovered.
