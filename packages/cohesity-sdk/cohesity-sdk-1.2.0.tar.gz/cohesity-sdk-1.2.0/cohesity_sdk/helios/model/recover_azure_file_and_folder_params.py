...
class RecoverAzureFileAndFolderParams(ModelNormal):
    ...
    attribute_map = {
        ...
        'azure_target_params': 'azureTargetParams',  # noqa: E501
    }
    ...
    def __init__(self, files_and_folders, *args, **kwargs):  # noqa: E501
        """RecoverAzureFileAndFolderParams - a model defined in OpenAPI
        ...
        Keyword Args:
            target_environment (str): Specifies the environment of the recovery target. The corresponding params below must be filled out.. defaults to "kAzure", must be one of ["kAzure", ]  # noqa: E501
