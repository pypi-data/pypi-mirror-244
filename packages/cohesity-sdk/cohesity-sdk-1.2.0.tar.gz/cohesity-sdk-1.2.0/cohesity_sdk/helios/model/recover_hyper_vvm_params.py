...
class RecoverHyperVVmParams(ModelNormal):
    ...
    attribute_map = {
        ...
        'hyperv_target_params': 'hypervTargetParams',  # noqa: E501
    }
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """RecoverHyperVVmParams - a model defined in OpenAPI

        Args:

        Keyword Args:
            target_environment (str): Specifies the environment of the recovery target. The corresponding params below must be filled out.. defaults to "kHyperV", must be one of ["kHyperV", ]  # noqa: E501
            ...
            hyperv_target_params ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): Specifies the params for recovering to a HyperV target.. [optional]  # noqa: E501
        """
