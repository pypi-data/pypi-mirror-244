...
def lazy_import():
    from cohesity_sdk.helios.model.node_free_disks import NodeFreeDisks
    globals()['NodeFreeDisks'] = NodeFreeDisks


class ClusterFreeDisks(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, node_free_disks, *args, **kwargs):  # noqa: E501
