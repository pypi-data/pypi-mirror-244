...
def lazy_import():
    from cohesity_sdk.helios.model.share_all_of import ShareAllOf
...
class Share(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, view_name, view_path, *args, **kwargs):  # noqa: E501
