...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.kvm_protection_group_object_params import KvmProtectionGroupObjectParams
    globals()['IndexingPolicy'] = IndexingPolicy
    globals()['KvmProtectionGroupObjectParams'] = KvmProtectionGroupObjectParams


class KvmProtectionGroupParams(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'objects': ([KvmProtectionGroupObjectParams],),  # noqa: E501
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        """KvmProtectionGroupParams - a model defined in OpenAPI

        Args:
            objects ([KvmProtectionGroupObjectParams]): Specifies the objects to be included in the Protection Group.
