...
class RecoverIsilonFilesParams(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, files_and_folders, target_environment, *args, **kwargs):  # noqa: E501
        """RecoverIsilonFilesParams - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            isilon_target_params ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): Specifies the params for a Isilon recovery target.. [optional]  # noqa: E501
