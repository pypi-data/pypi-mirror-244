...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.mssql_file_object_protection import MssqlFileObjectProtection
    from cohesity_sdk.helios.model.mssql_file_object_protection_params_all_of import MssqlFileObjectProtectionParamsAllOf
...
class MssqlFileObjectProtectionParams(ModelComposed):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'objects': ([MssqlFileObjectProtection], none_type,),  # noqa: E501
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        """MssqlFileObjectProtectionParams - a model defined in OpenAPI

        Args:
            objects ([MssqlFileObjectProtection], none_type): Specifies the list of objects to be protected.
