...
def lazy_import():
    from cohesity_sdk.helios.model.azure_agent_protection_group_object_params import AzureAgentProtectionGroupObjectParams
...
class AzureAgentProtectionGroupParams(ModelNormal):
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        """AzureAgentProtectionGroupParams - a model defined in OpenAPI

        Args:
            objects ([AzureAgentProtectionGroupObjectParams]): Specifies the objects to be included in the Protection Group.
