...
def lazy_import():
    from cohesity_sdk.helios.model.kubernetes_filter_params import KubernetesFilterParams
    from cohesity_sdk.helios.model.kubernetes_protection_group_object_params import KubernetesProtectionGroupObjectParams
