...
def lazy_import():
    from cohesity_sdk.helios.model.oracle_object_based_protection_params import OracleObjectBasedProtectionParams
    from cohesity_sdk.helios.model.oracle_object_protection_info import OracleObjectProtectionInfo
    from cohesity_sdk.helios.model.vlan_params import VlanParams
    globals()['OracleObjectBasedProtectionParams'] = OracleObjectBasedProtectionParams
    globals()['OracleObjectProtectionInfo'] = OracleObjectProtectionInfo
    globals()['VlanParams'] = VlanParams


class OracleObjectProtectionUpdateRequestParams(ModelComposed):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'objects': ([OracleObjectProtectionInfo], none_type,),  # noqa: E501
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        """OracleObjectProtectionUpdateRequestParams - a model defined in OpenAPI

        Args:
            objects ([OracleObjectProtectionInfo], none_type): Specifies the list of object ids to be protected.
