...
class SupportChannelConfig(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, is_enabled, end_time_usecs, *args, **kwargs):  # noqa: E501
        """SupportChannelConfig - a model defined in OpenAPI
