...
def lazy_import():
    from cohesity_sdk.helios.model.common_no_sql_recovery_options import CommonNoSqlRecoveryOptions
    from cohesity_sdk.helios.model.recover_hdfs_params_all_of import RecoverHdfsParamsAllOf
    from cohesity_sdk.helios.model.recover_hdfs_snapshot_params import RecoverHdfsSnapshotParams
...
class RecoverHdfsParams(ModelComposed):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'snapshots': ([RecoverHdfsSnapshotParams], none_type,),  # noqa: E501
            ...
            'target_directory': (str, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'target_directory': 'targetDirectory',  # noqa: E501
    }
    ...
    def __init__(self, snapshots, *args, **kwargs):  # noqa: E501
        """RecoverHdfsParams - a model defined in OpenAPI

        Args:
            snapshots ([RecoverHdfsSnapshotParams], none_type): Specifies the local snapshot ids of the Objects to be recovered.
        ...
        Keyword Args:
            ...
            target_directory (str, none_type): Specifies the target directory where files and folders are to be recovered. If not set, this will be taken as '/'. [optional]  # noqa: E501
        """
