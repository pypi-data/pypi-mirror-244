...
def lazy_import():
    from cohesity_sdk.helios.model.oracle_protection_group_object_params import OracleProtectionGroupObjectParams
...
class OracleProtectionGroupParams(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'objects': ([OracleProtectionGroupObjectParams], none_type,),  # noqa: E501
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        """OracleProtectionGroupParams - a model defined in OpenAPI

        Args:
            objects ([OracleProtectionGroupObjectParams], none_type): Specifies the list of object ids to be protected.
