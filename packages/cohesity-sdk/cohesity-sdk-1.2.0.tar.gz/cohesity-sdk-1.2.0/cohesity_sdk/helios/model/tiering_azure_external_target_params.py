...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.common_tiering_azure_external_target_params import CommonTieringAzureExternalTargetParams
    from cohesity_sdk.helios.model.tiering_azure_external_target_params_all_of import TieringAzureExternalTargetParamsAllOf
...
class TieringAzureExternalTargetParams(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, container_name, storage_account_name, *args, **kwargs):  # noqa: E501
        """TieringAzureExternalTargetParams - a model defined in OpenAPI
        ...
        Keyword Args:
            storage_class (str, none_type): Specifies the Azure External Target class.. defaults to "AzureHotBlob", must be one of ["AzureHotBlob", ]  # noqa: E501
        ...
        storage_class = kwargs.get('storage_class', "AzureHotBlob")
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'allOf': [
              ...
              TieringAzureExternalTargetParamsAllOf,
          ],
          'oneOf': [
          ],
        }
