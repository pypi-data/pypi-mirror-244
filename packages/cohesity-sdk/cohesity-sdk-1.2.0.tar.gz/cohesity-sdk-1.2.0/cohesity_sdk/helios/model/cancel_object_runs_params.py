...
def lazy_import():
    from cohesity_sdk.helios.model.cancel_object_run_params import CancelObjectRunParams
    globals()['CancelObjectRunParams'] = CancelObjectRunParams


class CancelObjectRunsParams(ModelNormal):
    ...
    def __init__(self, object_id, *args, **kwargs):  # noqa: E501
        """CancelObjectRunsParams - a model defined in OpenAPI
