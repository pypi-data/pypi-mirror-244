...
def lazy_import():
    from cohesity_sdk.helios.model.mounted_volume_mapping import MountedVolumeMapping
    globals()['MountedVolumeMapping'] = MountedVolumeMapping


class PhysicalTargetParamsForMountVolume(ModelNormal):
    ...
    def __init__(self, mount_to_original_target, *args, **kwargs):  # noqa: E501
        """PhysicalTargetParamsForMountVolume - a model defined in OpenAPI
