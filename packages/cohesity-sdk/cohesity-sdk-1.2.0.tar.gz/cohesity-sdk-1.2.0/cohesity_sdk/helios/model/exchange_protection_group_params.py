...
def lazy_import():
    from cohesity_sdk.helios.model.exchange_protection_group_object_params import ExchangeProtectionGroupObjectParams
...
class ExchangeProtectionGroupParams(ModelNormal):
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        """ExchangeProtectionGroupParams - a model defined in OpenAPI

        Args:
            objects ([ExchangeProtectionGroupObjectParams]): Specifies the list of object ids to be protected.
