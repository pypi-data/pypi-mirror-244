...
class MSSQLVolumeProtectionGroupHostParams(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, host_id, *args, **kwargs):  # noqa: E501
        """MSSQLVolumeProtectionGroupHostParams - a model defined in OpenAPI
