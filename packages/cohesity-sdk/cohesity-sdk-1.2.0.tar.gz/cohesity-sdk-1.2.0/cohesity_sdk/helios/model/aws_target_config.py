...
class AWSTargetConfig(ModelNormal):
    ...
    def __init__(self, source_id, region, *args, **kwargs):  # noqa: E501
        """AWSTargetConfig - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            name (str, none_type): Specifies the name of the AWS Replication target.. [optional]  # noqa: E501
            region_name (str, none_type): Specifies name of the AWS region in which to replicate the Snapshot to. Applicable if replication target is AWS target.. [optional]  # noqa: E501
        """
