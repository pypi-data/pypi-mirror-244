...
def lazy_import():
    from cohesity_sdk.helios.model.object_site_param import ObjectSiteParam
...
class RecoverSiteParams(ModelNormal):
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        """RecoverSiteParams - a model defined in OpenAPI

        Args:
            objects ([ObjectSiteParam], none_type): Specifies a list of site params associated with the objects to recover.
