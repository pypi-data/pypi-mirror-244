...
def lazy_import():
    from cohesity_sdk.helios.model.trusted_domain import TrustedDomain
    globals()['TrustedDomain'] = TrustedDomain


class TrustedDomainParams(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'trusted_domains': ([TrustedDomain], none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'trusted_domains': 'trustedDomains',  # noqa: E501
    ...
    def __init__(self, enabled, *args, **kwargs):  # noqa: E501
        """TrustedDomainParams - a model defined in OpenAPI
