...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.mcm_common_source_registration_reponse_params import McmCommonSourceRegistrationReponseParams
    from cohesity_sdk.helios.model.mcm_source_registration_all_of import McmSourceRegistrationAllOf
    ...
    globals()['McmCommonSourceRegistrationReponseParams'] = McmCommonSourceRegistrationReponseParams
    globals()['McmSourceRegistrationAllOf'] = McmSourceRegistrationAllOf
...
class McmSourceRegistration(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """McmSourceRegistration - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            id (str, none_type): Source Registration ID. This can be used to retrieve, edit or delete the source registration.. [optional]  # noqa: E501
            connection_id (int, none_type): Specifies the id of the connection from where this source is reachable.. [optional]  # noqa: E501
