...
class VcdRegistrationParamsAllOf(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, vcenter_credential_info_list, *args, **kwargs):  # noqa: E501
        """VcdRegistrationParamsAllOf - a model defined in OpenAPI
