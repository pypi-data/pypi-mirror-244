...
def lazy_import():
    from cohesity_sdk.helios.model.standard_params import StandardParams
    globals()['StandardParams'] = StandardParams


class AwsSourceRegistrationParams(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, subscription_type, *args, **kwargs):  # noqa: E501
        """AwsSourceRegistrationParams - a model defined in OpenAPI
