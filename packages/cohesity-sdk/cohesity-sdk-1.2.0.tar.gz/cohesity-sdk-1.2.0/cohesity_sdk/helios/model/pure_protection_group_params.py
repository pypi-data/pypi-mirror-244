...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.pure_protection_group_object_params import PureProtectionGroupObjectParams
...
class PureProtectionGroupParams(ModelNormal):
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        """PureProtectionGroupParams - a model defined in OpenAPI

        Args:
            objects ([PureProtectionGroupObjectParams]): Specifies the objects to be included in the Protection Group.
