...
class CreateMcmSignupRequestAllOf(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, accept_terms, *args, **kwargs):  # noqa: E501
        """CreateMcmSignupRequestAllOf - a model defined in OpenAPI
