...
class RecoverAcropolisFileAndFolderParams(ModelNormal):
    ...
    def __init__(self, files_and_folders, *args, **kwargs):  # noqa: E501
        """RecoverAcropolisFileAndFolderParams - a model defined in OpenAPI
        ...
        Keyword Args:
            target_environment (str): Specifies the environment of the recovery target. The corresponding params below must be filled out.. defaults to "kAcropolis", must be one of ["kAcropolis", ]  # noqa: E501
