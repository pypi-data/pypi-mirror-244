...
def lazy_import():
    from cohesity_sdk.helios.model.view_options import ViewOptions
    globals()['ViewOptions'] = ViewOptions


class ExchangeRecoverDatabaseParams(ModelNormal):
    ...
    attribute_map = {
        'database_source': 'databaseSource',  # noqa: E501
        'recover_to_new_source': 'recoverToNewSource',  # noqa: E501
        'restore_type': 'restoreType',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, database_source, recover_to_new_source, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            restore_type (str, none_type): Specifies the type of exchange restore.. defaults to "RestoreView", must be one of ["RestoreView", ]  # noqa: E501
        ...
        restore_type = kwargs.get('restore_type', "RestoreView")
