...
def lazy_import():
    from cohesity_sdk.helios.model.helios_common_cloud_tier_settings import HeliosCommonCloudTierSettings
    from cohesity_sdk.helios.model.helios_oracle_tier_all_of import HeliosOracleTierAllOf
    globals()['HeliosCommonCloudTierSettings'] = HeliosCommonCloudTierSettings
    globals()['HeliosOracleTierAllOf'] = HeliosOracleTierAllOf


class HeliosOracleTier(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, tier_type, *args, **kwargs):  # noqa: E501
        """HeliosOracleTier - a model defined in OpenAPI
