...
class RecoverAzureVmNewSourceNetworkConfig(ModelNormal):
    ...
    def __init__(self, virtual_network, subnet, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            network_resource_group ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): Specifies id of the resource group for the selected virtual network.. [optional]  # noqa: E501
        """
