...
def lazy_import():
    from cohesity_sdk.helios.model.custom_tag_params import CustomTagParams
    globals()['CustomTagParams'] = CustomTagParams


class AwsCloudSpinParams(ModelNormal):
    ...
    def __init__(self, region, *args, **kwargs):  # noqa: E501
        """AwsCloudSpinParams - a model defined in OpenAPI
