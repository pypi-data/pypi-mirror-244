...
def lazy_import():
    from cohesity_sdk.helios.model.recover_oracle_db_snapshot_params import RecoverOracleDbSnapshotParams
    globals()['RecoverOracleDbSnapshotParams'] = RecoverOracleDbSnapshotParams


class RecoverOracleParams(ModelNormal):
    ...
    def __init__(self, objects, recovery_action, *args, **kwargs):  # noqa: E501
        """RecoverOracleParams - a model defined in OpenAPI

        Args:
            objects ([RecoverOracleDbSnapshotParams], none_type): Specifies the list of parameters for list of objects to be recovered.
