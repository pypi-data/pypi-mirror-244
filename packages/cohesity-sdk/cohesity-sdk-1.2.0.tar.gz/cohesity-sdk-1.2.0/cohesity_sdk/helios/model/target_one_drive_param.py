...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.target_mailbox_param_all_of import TargetMailboxParamAllOf
    globals()['RecoveryObjectIdentifier'] = RecoveryObjectIdentifier
    globals()['TargetMailboxParamAllOf'] = TargetMailboxParamAllOf


class TargetOneDriveParam(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, target_folder_path, *args, **kwargs):  # noqa: E501
        """TargetOneDriveParam - a model defined in OpenAPI
