...
def lazy_import():
    from cohesity_sdk.helios.model.aag_info import AAGInfo
    from cohesity_sdk.helios.model.common_recover_object_snapshot_params import CommonRecoverObjectSnapshotParams
    from cohesity_sdk.helios.model.host_information import HostInformation
    from cohesity_sdk.helios.model.mssql_object_entity_params import MssqlObjectEntityParams
    from cohesity_sdk.helios.model.recover_sql_app_params_all_of import RecoverSqlAppParamsAllOf
    from cohesity_sdk.helios.model.sql_target_params_for_recover_sql_app import SqlTargetParamsForRecoverSqlApp
...
class RecoverSqlAppParams(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, snapshot_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            target_environment (str): Specifies the environment of the recovery target. The corresponding params below must be filled out.. defaults to "kSQL", must be one of ["kSQL", ]  # noqa: E501
