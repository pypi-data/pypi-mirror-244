...
def lazy_import():
    from cohesity_sdk.helios.model.helios_cassandra_objects import HeliosCassandraObjects
    from cohesity_sdk.helios.model.helios_common_search_indexed_objects_response_params import HeliosCommonSearchIndexedObjectsResponseParams
    from cohesity_sdk.helios.model.helios_couchbase_objects import HeliosCouchbaseObjects
    from cohesity_sdk.helios.model.helios_emails import HeliosEmails
    from cohesity_sdk.helios.model.helios_exchange_objects import HeliosExchangeObjects
    from cohesity_sdk.helios.model.helios_files import HeliosFiles
    from cohesity_sdk.helios.model.helios_hbase_objects import HeliosHbaseObjects
    from cohesity_sdk.helios.model.helios_hdfs_objects import HeliosHdfsObjects
    from cohesity_sdk.helios.model.helios_hive_objects import HeliosHiveObjects
    from cohesity_sdk.helios.model.helios_mongo_objects import HeliosMongoObjects
    from cohesity_sdk.helios.model.helios_public_folder_items import HeliosPublicFolderItems
    from cohesity_sdk.helios.model.helios_search_indexed_objects_cluster_error import HeliosSearchIndexedObjectsClusterError
    from cohesity_sdk.helios.model.helios_search_indexed_objects_response_body_all_of import HeliosSearchIndexedObjectsResponseBodyAllOf
