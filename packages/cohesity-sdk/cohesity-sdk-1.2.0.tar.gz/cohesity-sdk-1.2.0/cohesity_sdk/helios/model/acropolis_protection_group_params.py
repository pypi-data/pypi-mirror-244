...
def lazy_import():
    from cohesity_sdk.helios.model.acropolis_protection_group_object_params import AcropolisProtectionGroupObjectParams
...
class AcropolisProtectionGroupParams(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'objects': ([AcropolisProtectionGroupObjectParams],),  # noqa: E501
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        """AcropolisProtectionGroupParams - a model defined in OpenAPI

        Args:
            objects ([AcropolisProtectionGroupObjectParams]): Specifies the objects included in the Protection Group.
        ...
        Keyword Args:
            ...
            exclude_object_ids ([int], none_type): Specifies the object ids to be excluded in the Protection Group.. [optional]  # noqa: E501
