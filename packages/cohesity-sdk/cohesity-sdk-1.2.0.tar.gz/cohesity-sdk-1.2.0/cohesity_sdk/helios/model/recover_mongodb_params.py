...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.recover_mongodb_params_all_of import RecoverMongodbParamsAllOf
    from cohesity_sdk.helios.model.recover_mongodb_snapshot_params import RecoverMongodbSnapshotParams
...
class RecoverMongodbParams(ModelComposed):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'snapshots': ([RecoverMongodbSnapshotParams], none_type,),  # noqa: E501
    ...
    def __init__(self, snapshots, *args, **kwargs):  # noqa: E501
        """RecoverMongodbParams - a model defined in OpenAPI

        Args:
            snapshots ([RecoverMongodbSnapshotParams], none_type): Specifies the local snapshot ids of the Objects to be recovered.
