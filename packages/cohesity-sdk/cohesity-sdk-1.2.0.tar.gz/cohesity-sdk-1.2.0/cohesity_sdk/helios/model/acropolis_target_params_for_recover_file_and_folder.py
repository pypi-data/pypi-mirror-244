...
class AcropolisTargetParamsForRecoverFileAndFolder(ModelNormal):
    ...
    def __init__(self, recover_to_original_target, *args, **kwargs):  # noqa: E501
        """AcropolisTargetParamsForRecoverFileAndFolder - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            overwrite_existing (bool, none_type): Specifies whether to overwrite the existing files. Default is true.. [optional]  # noqa: E501
            preserve_attributes (bool, none_type): Specifies whether to preserve original file/folder attributes. Default is true.. [optional]  # noqa: E501
            continue_on_error (bool, none_type): Specifies whether to continue recovering other files if one of the objects encounters an error. Default is false.. [optional]  # noqa: E501
