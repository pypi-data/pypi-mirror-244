...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.helios_on_prem_ssh_config import HeliosOnPremSSHConfig
    from cohesity_sdk.helios.model.helios_on_prem_vm_node import HeliosOnPremVMNode
...
class HeliosOnPremConfig(ModelNormal):
