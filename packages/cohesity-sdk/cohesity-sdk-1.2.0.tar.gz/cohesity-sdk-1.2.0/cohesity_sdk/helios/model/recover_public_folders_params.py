...
def lazy_import():
    from cohesity_sdk.helios.model.root_public_folder_param import RootPublicFolderParam
    globals()['RootPublicFolderParam'] = RootPublicFolderParam


class RecoverPublicFoldersParams(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, root_public_folders, *args, **kwargs):  # noqa: E501
        """RecoverPublicFoldersParams - a model defined in OpenAPI

        Args:
            root_public_folders ([RootPublicFolderParam], none_type): Specifies a list of RootPublicFolder params associated with the objects to recover.
