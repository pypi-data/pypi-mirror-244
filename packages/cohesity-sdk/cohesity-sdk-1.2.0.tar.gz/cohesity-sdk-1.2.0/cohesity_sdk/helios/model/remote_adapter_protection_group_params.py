...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.remote_adapter_host import RemoteAdapterHost
    from cohesity_sdk.helios.model.remote_adapter_protection_group_replication_params import RemoteAdapterProtectionGroupReplicationParams
...
class RemoteAdapterProtectionGroupParams(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, hosts, view_id, *args, **kwargs):  # noqa: E501
        """RemoteAdapterProtectionGroupParams - a model defined in OpenAPI

        Args:
            hosts ([RemoteAdapterHost], none_type): Specifies a list of hosts to protected in this protection group.
