...
def lazy_import():
    from cohesity_sdk.helios.model.common_generic_nas_protection_params import CommonGenericNasProtectionParams
    ...
    from cohesity_sdk.helios.model.generic_nas_protection_group_extra_params import GenericNasProtectionGroupExtraParams
    from cohesity_sdk.helios.model.generic_nas_protection_group_params_all_of import GenericNasProtectionGroupParamsAllOf
...
class GenericNasProtectionGroupParams(ModelComposed):
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        """GenericNasProtectionGroupParams - a model defined in OpenAPI

        Args:
            objects ([ProtectionObjectInput]): Specifies the objects to be included in the Protection Group.
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'allOf': [
              ...
              GenericNasProtectionGroupParamsAllOf,
          ],
          'oneOf': [
          ],
        }
