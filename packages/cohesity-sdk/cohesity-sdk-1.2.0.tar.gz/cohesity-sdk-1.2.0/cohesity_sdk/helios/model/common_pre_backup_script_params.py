...
def lazy_import():
    from cohesity_sdk.helios.model.common_pre_backup_script_params_all_of import CommonPreBackupScriptParamsAllOf
    from cohesity_sdk.helios.model.common_pre_post_script_params import CommonPrePostScriptParams
...
class CommonPreBackupScriptParams(ModelComposed):
    ...
    def __init__(self, path, *args, **kwargs):  # noqa: E501
        """CommonPreBackupScriptParams - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            continue_on_error (bool, none_type): Specifies if the script needs to continue even if there is an occurence of an error. If this flag is set to true, then Backup Run will start even if the pre backup script fails. If not specified or false, then backup run will not start when script fails.. [optional]  # noqa: E501
        """
