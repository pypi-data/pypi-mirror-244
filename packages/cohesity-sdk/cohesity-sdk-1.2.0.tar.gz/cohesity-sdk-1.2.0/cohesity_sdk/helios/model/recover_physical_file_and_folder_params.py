...
class RecoverPhysicalFileAndFolderParams(ModelNormal):
    ...
    attribute_map = {
        ...
        'physical_target_params': 'physicalTargetParams',  # noqa: E501
    }
    ...
    def __init__(self, files_and_folders, *args, **kwargs):  # noqa: E501
        """RecoverPhysicalFileAndFolderParams - a model defined in OpenAPI

        Args:
            files_and_folders ([CommonRecoverFileAndFolderInfo], none_type): Specifies the information about the files and folders to be recovered.

        Keyword Args:
            target_environment (str): Specifies the environment of the recovery target. The corresponding params below must be filled out.. defaults to "kPhysical", must be one of ["kPhysical", ]  # noqa: E501
