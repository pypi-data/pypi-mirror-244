...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.flashblade_protection_group_object_params import FlashbladeProtectionGroupObjectParams
...
class FlashbladeProtectionGroupParams(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'objects': ([FlashbladeProtectionGroupObjectParams],),  # noqa: E501
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        """FlashbladeProtectionGroupParams - a model defined in OpenAPI

        Args:
            objects ([FlashbladeProtectionGroupObjectParams]): Specifies the objects to be included in the Protection Group.
