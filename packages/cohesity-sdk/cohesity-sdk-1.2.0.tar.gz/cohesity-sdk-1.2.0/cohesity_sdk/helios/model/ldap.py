...
def lazy_import():
    from cohesity_sdk.helios.model.create_ldap_params import CreateLdapParams
    from cohesity_sdk.helios.model.ldap_all_of import LdapAllOf
...
class Ldap(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, preferred_ldap_servers, base_distinguished_name, auth_type, *args, **kwargs):  # noqa: E501
