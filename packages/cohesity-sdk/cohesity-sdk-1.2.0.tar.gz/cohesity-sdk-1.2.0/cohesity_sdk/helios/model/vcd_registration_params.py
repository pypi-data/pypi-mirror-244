...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.vcd_registration_params_all_of import VcdRegistrationParamsAllOf
...
class VcdRegistrationParams(ModelComposed):
