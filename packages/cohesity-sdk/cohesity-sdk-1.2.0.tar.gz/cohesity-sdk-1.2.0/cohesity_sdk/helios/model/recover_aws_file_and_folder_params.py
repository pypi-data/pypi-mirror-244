...
class RecoverAwsFileAndFolderParams(ModelNormal):
    ...
    attribute_map = {
        ...
        'aws_target_params': 'awsTargetParams',  # noqa: E501
    }
    ...
    def __init__(self, files_and_folders, *args, **kwargs):  # noqa: E501
        """RecoverAwsFileAndFolderParams - a model defined in OpenAPI
        ...
        Keyword Args:
            target_environment (str): Specifies the environment of the recovery target. The corresponding params below must be filled out.. defaults to "kAWS", must be one of ["kAWS", ]  # noqa: E501
