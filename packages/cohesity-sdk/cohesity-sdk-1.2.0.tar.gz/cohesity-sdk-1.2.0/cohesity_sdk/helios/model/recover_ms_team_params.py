...
def lazy_import():
    from cohesity_sdk.helios.model.object_ms_team_param import ObjectMsTeamParam
...
class RecoverMsTeamParams(ModelNormal):
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        """RecoverMsTeamParams - a model defined in OpenAPI

        Args:
            objects ([ObjectMsTeamParam], none_type): Specifies a list of Microsoft 365 Teams params associated with objects to recover.
