...
def lazy_import():
    from cohesity_sdk.helios.model.couchbase_source_registration_params_all_of import CouchbaseSourceRegistrationParamsAllOf
...
class CouchbaseSourceRegistrationParams(ModelComposed):
