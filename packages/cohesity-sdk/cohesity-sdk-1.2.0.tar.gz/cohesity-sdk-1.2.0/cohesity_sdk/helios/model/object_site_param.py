...
def lazy_import():
    from cohesity_sdk.helios.model.one_drive_param import OneDriveParam
    globals()['OneDriveParam'] = OneDriveParam


class ObjectSiteParam(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, owner_info, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            document_library_params ([OneDriveParam], none_type): Specifies the parameters to recover a document library. [optional]  # noqa: E501
        """
