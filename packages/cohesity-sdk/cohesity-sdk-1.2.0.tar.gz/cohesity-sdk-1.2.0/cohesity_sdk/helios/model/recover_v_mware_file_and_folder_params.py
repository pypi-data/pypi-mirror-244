...
class RecoverVMwareFileAndFolderParams(ModelNormal):
    ...
    def __init__(self, files_and_folders, *args, **kwargs):  # noqa: E501
        """RecoverVMwareFileAndFolderParams - a model defined in OpenAPI
        ...
        Keyword Args:
            target_environment (str): Specifies the environment of the recovery target. The corresponding params below must be filled out.. defaults to "kVMware", must be one of ["kVMware", ]  # noqa: E501
