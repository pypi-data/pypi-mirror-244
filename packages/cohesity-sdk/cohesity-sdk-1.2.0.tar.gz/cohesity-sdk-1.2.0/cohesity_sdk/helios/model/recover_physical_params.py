...
class RecoverPhysicalParams(ModelNormal):
    ...
    def __init__(self, objects, recovery_action, *args, **kwargs):  # noqa: E501
        """RecoverPhysicalParams - a model defined in OpenAPI

        Args:
            objects ([CommonRecoverObjectSnapshotParams], none_type): Specifies the list of Recover Object parameters. For recovering files, specifies the object contains the file to recover.
