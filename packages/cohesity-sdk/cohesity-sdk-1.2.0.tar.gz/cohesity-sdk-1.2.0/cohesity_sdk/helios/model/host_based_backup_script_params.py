...
def lazy_import():
    from cohesity_sdk.helios.model.common_post_backup_script_params import CommonPostBackupScriptParams
    from cohesity_sdk.helios.model.common_pre_backup_script_params import CommonPreBackupScriptParams
    from cohesity_sdk.helios.model.script_host import ScriptHost
...
class HostBasedBackupScriptParams(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, host, *args, **kwargs):  # noqa: E501
        """HostBasedBackupScriptParams - a model defined in OpenAPI
