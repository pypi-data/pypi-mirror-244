...
class VmwareRecoverOriginalSourceDiskParams(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, disk_uuid, *args, **kwargs):  # noqa: E501
        """VmwareRecoverOriginalSourceDiskParams - a model defined in OpenAPI
