...
def lazy_import():
    from cohesity_sdk.helios.model.ms_group_param import MsGroupParam
...
class RecoverMsGroupParams(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, ms_groups, *args, **kwargs):  # noqa: E501
        """RecoverMsGroupParams - a model defined in OpenAPI

        Args:
            ms_groups ([MsGroupParam], none_type): Specifies a list of groups getting restored.
