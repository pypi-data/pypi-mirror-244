...
def lazy_import():
    from cohesity_sdk.helios.model.recovery_vlan_config import RecoveryVlanConfig
    globals()['RecoveryVlanConfig'] = RecoveryVlanConfig


class RecoverOtherNasToGenericNasVolumeTargetParams(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, volume, *args, **kwargs):  # noqa: E501
        """RecoverOtherNasToGenericNasVolumeTargetParams - a model defined in OpenAPI
