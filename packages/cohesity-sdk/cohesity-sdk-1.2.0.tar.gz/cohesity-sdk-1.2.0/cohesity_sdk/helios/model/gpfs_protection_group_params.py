...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.gpfs_protection_group_object_params import GpfsProtectionGroupObjectParams
...
class GpfsProtectionGroupParams(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'objects': ([GpfsProtectionGroupObjectParams],),  # noqa: E501
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        """GpfsProtectionGroupParams - a model defined in OpenAPI

        Args:
            objects ([GpfsProtectionGroupObjectParams]): Specifies the objects to be included in the Protection Group.
