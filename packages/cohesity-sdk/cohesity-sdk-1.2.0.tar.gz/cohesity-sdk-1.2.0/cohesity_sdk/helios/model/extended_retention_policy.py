...
def lazy_import():
    from cohesity_sdk.helios.model.extended_retention_schedule import ExtendedRetentionSchedule
...
class ExtendedRetentionPolicy(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'schedule': (ExtendedRetentionSchedule,),  # noqa: E501
    ...
    def __init__(self, schedule, retention, *args, **kwargs):  # noqa: E501
        """ExtendedRetentionPolicy - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            config_id (str, none_type): Specifies the unique identifier for the target getting added. This field need to be passed olny when policies are updated.. [optional]  # noqa: E501
        """
