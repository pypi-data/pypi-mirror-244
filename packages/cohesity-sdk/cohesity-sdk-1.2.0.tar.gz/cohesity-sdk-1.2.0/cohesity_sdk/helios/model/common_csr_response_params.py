...
def lazy_import():
    from cohesity_sdk.helios.model.common_csr_request_params import CommonCsrRequestParams
    from cohesity_sdk.helios.model.common_csr_response_params_all_of import CommonCsrResponseParamsAllOf
