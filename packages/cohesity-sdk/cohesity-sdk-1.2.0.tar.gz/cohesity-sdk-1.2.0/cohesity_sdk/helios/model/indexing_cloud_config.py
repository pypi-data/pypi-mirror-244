...
def lazy_import():
    from cohesity_sdk.helios.model.es_config_for_indexing import ESConfigForIndexing
    from cohesity_sdk.helios.model.s3_config_for_indexing import S3ConfigForIndexing
    globals()['ESConfigForIndexing'] = ESConfigForIndexing
    globals()['S3ConfigForIndexing'] = S3ConfigForIndexing


class IndexingCloudConfig(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, tenant_id, region, es_config, s3_config, *args, **kwargs):  # noqa: E501
