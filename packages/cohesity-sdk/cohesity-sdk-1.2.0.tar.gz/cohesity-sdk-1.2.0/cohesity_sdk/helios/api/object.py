...
class ObjectApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_mcm_objects_activity_by_id(
            self,
            id,
            **kwargs
        ):
            ...
            Get object activity on Helios by ID. Activity includes Protection Group Runs and Recoveries.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_mcm_objects_activity_by_id(id, async_req=True)
            >>> result = thread.get()
        ...
        self.get_mcm_objects_activity_by_id = _Endpoint(
            settings={
                'response_type': (McmObjectActivity,),
                'auth': [
                    'TokenHeader',
                    'ClusterId',
                    'APIKeyHeader'
                ],
                'endpoint_path': '/mcm/data-protect/objects/activity/{id}',
                'operation_id': 'get_mcm_objects_activity_by_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_mcm_objects_activity_by_id
        )

        def __get_mcm_objects_last_run_activity(
            self,
            **kwargs
        ):
            """Get last protection run of objects.  # noqa: E501

            Get last protection run activity of objects.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_mcm_objects_last_run_activity(async_req=True)
            >>> result = thread.get()
            ...
            Keyword Args:
                ...
                region_ids ([str]): Specifies a list of region ids. Only records from clusters having these region ids will be returned.. [optional]
                cluster_identifiers ([str]): Specifies the list of cluster identifiers. Format is clusterId:clusterIncarnationId. Only records from clusters having these identifiers will be returned.. [optional]
                body (GetMcmObjectsLastRunReqParams): Request parameters to filter object last runs.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        self.get_mcm_objects_last_run_activity = _Endpoint(
            settings={
                'response_type': (McmObjectLastRunActivities,),
                'auth': [
                    'TokenHeader',
                    'ClusterId',
                    'APIKeyHeader'
                ],
                'endpoint_path': '/mcm/data-protect/objects/last-run-activity',
                'operation_id': 'get_mcm_objects_last_run_activity',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_mcm_objects_last_run_activity
        )

        def __get_object_archival_run_stats(
            self,
            **kwargs
        ):
            """Get the object archival run stats.  # noqa: E501

            Get the stats for objects in archival runs.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_object_archival_run_stats(async_req=True)
            >>> result = thread.get()
        ...
        self.get_object_archival_run_stats = _Endpoint(
            settings={
                'response_type': (ObjectArchivalRunStats,),
                'auth': [
                    'TokenHeader',
                    'ClusterId',
                    'APIKeyHeader'
                ],
                'endpoint_path': '/mcm/data-protect/objects/stats/archival-runs',
                'operation_id': 'get_object_archival_run_stats',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_object_archival_run_stats
        )
        ...
        def __mcm_get_tenant_object_protections(
            self,
            body,
            **kwargs
        ):
            """GetTenantObjectProtections  # noqa: E501

            Get the protected objects for a given DMaaS tenant.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.mcm_get_tenant_object_protections(body, async_req=True)
            >>> result = thread.get()

            Args:
                body (McmTenantProtectedObjectsParams): Specifies the parameters to fetch protected objects.
        ...
        self.mcm_get_tenant_object_protections = _Endpoint(
            settings={
                'response_type': (McmTenantObjectProtections,),
                'auth': [
                    'TokenHeader',
                    'ClusterId',
                    'APIKeyHeader'
                ],
                'endpoint_path': '/mcm/tenants/protected-objects',
                'operation_id': 'mcm_get_tenant_object_protections',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__mcm_get_tenant_object_protections
        )
