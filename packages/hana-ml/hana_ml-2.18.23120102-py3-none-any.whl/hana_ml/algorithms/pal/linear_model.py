...
class LinearRegression(PALBase):
    ...
    **Biased Linear Model with Elastic-net Regularization**
    ...
    Create a LinearRegression instance and perform fit():
...
class OnlineLinearRegression(PALBase):
    ...
    >>> onlinelr.partial_fit(data=df_1, key='ID',
                             label='Y', features=['X1', 'X2'])
    ...
    >>> onlinelr.partial_fit(data=df_2, key='ID',
                             label='Y', features=['X1', 'X2'])
    ...
    >>> onlinelr.partial_fit(data=df_3, key='ID',
                             label='Y', features=['X1', 'X2'])
...
class LogisticRegression(PALBase):#pylint:disable=too-many-instance-attributes
    ...
    Create a LogisticRegression instance and call fit():
...
class OnlineMultiLogisticRegression(PALBase):
    ...
    Examples
    --------
    Initialize an OnlineMultiLogisticRegression instance:
    ...
    >>> omlr.partial_fit(data=df_2, label='Y', features=['X1', 'X2'])
    ...
    >>> omlr.partial_fit(data=df_3, label='Y', features=['X1', 'X2'])
    ...
    >>> omlr.partial_fit(data=df_4, label='Y', features=['X1', 'X2'])
    ...
    Invoke predict() and obtain the result:

    >>> res = onlinelr.predict(df_predict, key='ID', features=['X1', 'X2'])
    >>> res.collect()
       ID CLASS  PROBABILITY
    0   1     0     0.539350
    1   2     2     0.830026
