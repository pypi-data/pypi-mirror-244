...
class SVC(_SVMBase):
    ...
    Create a SVC instance and call the fit():
...
class SVR(_SVMBase):
    ...
    >>> svr = SVR(kernel='linear', scale_info='standardization',
...
class OneClassSVM(_SVMBase):
    ...
    Create a OneClassSVM instance and call fit():

    >>> svc_one = OneClassSVM(scale_info='no', category_weight=1)
    >>> svc_one.fit(data=df_fit, key='ID',
                    features=['ATTRIBUTE1', 'ATTRIBUTE2', 'ATTRIBUTE3', 'ATTRIBUTE4'])

    Predict data df_predict:
    ...
    >>> svc_one.predict(data=df_predict, key='ID',
                        features=['ATTRIBUTE1', 'ATTRIBUTE2', 'ATTRIBUTE3', 'ATTRIBUTE4']).head(10).collect()
       ID SCORE PROBABILITY
    0   0    -1        None
    1   1     1        None
    2   2     1        None
