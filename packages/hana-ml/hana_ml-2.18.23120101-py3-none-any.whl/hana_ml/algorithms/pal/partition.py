...
def train_test_val_split(data, id_column=None, random_seed=None, thread_ratio=None,
    ...
    >>> train_df, test_df, valid_df = train_test_val_split(data=df,
    ...
    if training_percentage is not None and testing_percentage is not None\
        ...
        if round(training_percentage + testing_percentage + validation_percentage, 2) != 1.0:
            ## error message
    ...
    # create dictionary with the column name/ data type as key/values for all columns
