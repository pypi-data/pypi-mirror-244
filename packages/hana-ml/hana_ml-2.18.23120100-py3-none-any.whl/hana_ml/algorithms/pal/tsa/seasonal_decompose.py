...
def seasonal_decompose(data,
                       ...
                       periods=None):
    r"""
    seasonal decompose function tests whether a time series has a seasonality or not. If it does, the corresponding additive or multiplicative seasonality model is identified, and the series is decomposed into three components: seasonal, trend, and random.
