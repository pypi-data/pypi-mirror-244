...
global_kuki_q_framework = Path.joinpath(
    config_util.global_kuki_root,
    "kuki",
    kuki_version.__version__,
    "src",
)
...
def link_kuki_q_framework():
    global_kuki_q_framework.parent.mkdir(parents=True, exist_ok=True)
    os.symlink(
        Path.joinpath(Path(__file__).parent, "q"),
        global_kuki_q_framework,
        True,
    )
