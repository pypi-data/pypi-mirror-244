...
def get_slug(contract_address: str, blockchain: str, api_key: str) -> str:
...
def get_sales(contract_address: str, blockchain: str, api_key: str, slug: str = None) -> Iterable[dict]:
    check_str(contract_address, "openseaio.contract_address")
    check_str(blockchain, "openseaio.blockchain")
...
def get_listings(contract_address: str, blockchain: str, api_key: str, slug: str = None) -> Iterable[dict]:
    check_str(contract_address, "openseaio.contract_address")
    check_str(blockchain, "openseaio.blockchain")
