...
from ivette.supabase_module import get_job_data
...
def setUp() -> (str, str):
    ...
    interval = 30  # seconds
    print(f">  Checking for jobs every {interval} seconds.")

    while True:
        id = get_job_data("id")
        package = get_job_data("package")
        operation = get_job_data("operation")
