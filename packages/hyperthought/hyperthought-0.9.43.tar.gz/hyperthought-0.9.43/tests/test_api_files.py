...
class TestFiles(unittest.TestCase):
    def setUp(self):
        ...
        self.move_destination_workspace_id = (
            config_data['api']['files']['move_destination_workspace_id'])
    ...
    def test_move(self):
        ...
        self.files_api.move(
            ...
            destination_space_id=self.move_destination_workspace_id,
        ...
        # Backwards move.
        self.files_api.move(
            source_space_id=self.move_destination_workspace_id,
