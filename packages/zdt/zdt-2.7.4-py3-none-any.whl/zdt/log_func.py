...
def log_wrapper_outer(folder_name):
    ...
    def log_wrapper_inner(func):
        ...
        def wrapper(args,*kwargs):
            ...
            logger = logging.getLogger(func._name_)
            
            # Add a file handler to the logger
            file_handler = logging.FileHandler(f'{folder_name}/{func._name_}_log.txt')
            ...
            logger.info(f'{func._name_} ran at {begin_func_time} with inputs {args}, {kwargs}')
            ...
            try:
                ...
                logger.info(f'{func._name_}, started: {begin_func_time}, ,inputs: {args}, {kwargs}, total_run_time: {total_time}, ended: {dt.datetime.now()}')
    ...
    #from module_test import log_wrapper_outer
