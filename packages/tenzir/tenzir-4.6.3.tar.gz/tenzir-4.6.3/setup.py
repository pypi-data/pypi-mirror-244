...
packages = \
['tenzir', 'tenzir.apps', 'tenzir.tenzir', 'tenzir.tools', 'tenzir.utils']
...
{'module': ['numpy>=1.24,<2.0'],
 ...
 'thehive': ['aiohttp>=3.8,<4.0']}

entry_points = \
{'console_scripts': ['app-thehive-count-alerts = '
                     'tenzir.apps.thehive:count_alerts',
                     'app-thehive-run = tenzir.apps.thehive:run']}
