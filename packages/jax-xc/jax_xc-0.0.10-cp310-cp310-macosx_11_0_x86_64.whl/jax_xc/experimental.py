...
def mgga_x_scanl(
  ...
  *,
  ...
  Mixing of the following functionals:
    mgga_x_scan (coefficient: 2.0)
    mgga_k_pc07_opt (coefficient: 2.0)
  Parameters
  ----------
  rho: the density function
  _c1 : Optional[float], default: 0.667
...
def mgga_x_revscanl(
  ...
  *,
  ...
  Mixing of the following functionals:
    mgga_x_revscan (coefficient: 2.0)
    mgga_k_pc07_opt (coefficient: 2.0)
  Parameters
  ----------
  rho: the density function
