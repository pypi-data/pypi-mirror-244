...
def plot_feature_matrices(input,showit=True,figsize=(10,10)):
    """
...
def plot_signifant_regression_covariations(input,choose_celltypes=[],saveas='pdf',transparent_mode=False,showit=True,figsize=(6,1.25)):
...
def find_LR_interactions_in_interacting_cell_types(input,choose_celltypes=[],pvalueCutoff=0.05, pathway_and_LR_analysis_with_spearman=True, LR_plot_NMF_Fa_thres=0.2, LR_plot_Exp_thres=0.2,saveas='pdf',transparent_mode=False,showit=True,figsize=(12,10)):
    """
    Inputs:
...
def pathway_analysis(input,NOG_pathway=50, pathway_and_LR_analysis_with_spearman=True,saveas='pdf',savefigure=False,
...
def plot_top_selected_genes_as_dotplot(input,choose_celltypes=[],top_NOG=20,rps_rpl_mt_genes_included=True,pathway_and_LR_analysis_with_spearman=True,saveas='pdf',transparent_mode=False,showit=True,figsize=(12, 10)):
    """
    Inputs:
...
quepath='./inputSP/',msna=0.1,ms=5,cmap=plt.cm.get_cmap('Spectral'),saveas='pdf',transparent_mode=False,showit=True,figsize=(8,3.5)):
