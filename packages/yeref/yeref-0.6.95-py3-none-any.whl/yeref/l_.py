...
l_usr_welcome = {
    'ru': "🌱 <b>{0}</b>, добро пожаловать в <i>лендинг-бот</i> нейро-автоматизации <b>Telegram</b>-аккаунтов:\n\n▪️<b>авто</b>-перевод/транскрибация\n▪️<b>нейро-генерация</b> бота\n▪️<b>мониторинг</b> гео/слов\n▪️<b>авто-формат/подкасты</b>\n▪️<b>веб-апп/нейро</b>-постинг\n\n❗️<b>Регулярно</b>-обновляемый /content",
...
l_top_hashtags = {
    'ru': "\n<b>Топ #хэштеги</b>:\n{0}\n",
    'en': "\n<b>Top #хэштеги </b>:\n{0}\n",
    'es': "\n<b> #хэштеги principales </b>:\n{0}\n",
    'fr': "\n<b>Meilleurs #хэштеги </b> :\n{0}\n",
    'zh': "\n<b>热门#хэштеги </b>：\n{0}\n",
    'ar': "\n<b>أهم #хэштеги </b>:\n{0}\n",
}
...
l_cdecor_text = {
    ...
    'en': "🪄 <b>Click</b> on ✅/☑️ to <b>On/Off</b> auto-decoration of the published post: <i><b>pagination</b> (post serial number)/creative < b>format</b> (<b>bold</b>/<i>italic</i>/<u>underlined</u>/<code>mono</code>/<tg-spoiler>spoiler </tg-spoiler>/ #хэштег /$cashtag/<a href='{0}'>link</a>)/<b>footer</b> (text end of post)</i>\n\ n👩🏽‍💻 Click <b>[✅☑On format]</b> to enable creative modification of the post using 8 styles",
    'es': "🪄 <b>Haz clic</b> en ✅/☑️ para <b>activar/desactivar</b> la decoración automática de la publicación publicada: <i><b>paginación</b> (número de serie de la publicación)/creatividad. < b>formato</b> (<b>negrita</b>/<i>cursiva</i>/<u>subrayado</u>/<code>mono</code>/<tg-spoiler> spoiler </tg-spoiler>/ #хэштег /$cashtag/<a href='{0}'>link</a>)/<b>pie de página</b> (texto al final de la publicación)</i>\ n\ n👩🏽‍💻 Haga clic en <b>[✅☑En formato]</b> para habilitar la modificación creativa de la publicación usando 8 estilos.",
    'fr': "🪄 <b>Cliquez</b> sur ✅/☑️ pour <b>Activer/Désactiver</b> la décoration automatique du post publié : <i><b>pagination</b> (numéro de série du post)/création < b>format</b> (<b>gras</b>/<i>italique</i>/<u>souligné</u>/<code>mono</code>/<tg-spoiler> spoiler </tg-spoiler>/ #хэштег /$cashtag/<a href='{0}'>link</a>)/<b>pied de page</b> (texte de fin du message)</i>\ n\ n👩🏽‍💻 Cliquez sur <b>[✅☑Sur le format]</b> pour activer la modification créative de la publication en utilisant 8 styles",
    'zh': "🪄 <b>点击</b> ✅/☑️ 可以<b>开启/关闭</b>已发布帖子的自动装饰：<i><b>分页</b>（帖子序列号）/创意<b>格式</b>（<b>粗体</b>/<i>斜体</i>/<u>下划线</u>/<code>单色</code>/<tg-spoiler>剧透 </tg-spoiler>/ #хэштег /$cashtag/<a href='{0}'>link</a>)/<b>页脚</b>（帖子文本结尾）</i>\ n\ n👩🏽‍💻 点击<b>[✅☑格式]</b>即可使用8种样式对帖子进行创意修改",
    'ar': "🪄 <b>انقر</b> على ✅/☑️ من أجل <b>تشغيل/إيقاف</b> الزخرفة التلقائية للمنشور المنشور: <i><b>ترقيم الصفحات</b> (الرقم التسلسلي للمنشور)/الإبداع < b>التنسيق</b> (<b>غامق</b>/<i>مائل</i>/<u>مسطر</u>/<code>أحادي</code>/<tg-spoiler> المفسد </tg-spoiler>/ #хэштег /$cashtag/<a href='{0}'>link</a>)/<b>footer</b> (نهاية نص التدوينة)</i>\n\n👩🏽‍💻 انقر على <b>[✅☑على التنسيق]</b> لتمكين التعديل الإبداعي للمنشور باستخدام 8 أنماط",
}
...
l_cdecor_footer_config = {
    ...
    'en': "🪄 <b>Enter</b> a short <b>text</b> that will be added to the end of channel posts (for example, frequently used #хэштеги )",
    ...
    'fr': "🪄 <b>Saisissez</b> un court <b>texte</b> qui sera ajouté à la fin des publications de la chaîne (par exemple, #хэштеги fréquemment utilisés)",
    'zh': "🪄 <b>输入</b>一个简短的<b>文本</b>，该文本将添加到频道帖子的末尾（例如，常用的#хэштеги ）",
...
l_kind_2 = {
    ...
    'en': "<b>👩🏽‍💻 @FereyBotBot </b>-#конструктор\n\n▪️<b>collection/ban/analytics</b> subscribers\n▪️auto-<b>translation/alerts</b>\n▪️<b>integration</b>and payments\n▪️neuro-<b>generation/clone</b>bot\n▪️<b>web-app/neuro</b>-posting",
    'es': "<b>👩🏽‍💻 @FereyBotBot </b>-#конструктор\n\n▪️<b>colección/ban/analítica</b> suscriptores\n▪️auto-<b>traducción/alertas</b>\n▪️<b>integración</b>y pagos\n▪️neuro-<b>generación/clon</b>bot\n▪️<b>aplicación web/neuro</b>-publicación",
    'fr': "<b>👩🏽‍💻 @FereyBotBot </b>-#конструктор\n\nnoyer<b>collection/ban/analytics</b> abonnés\nnoyerauto-<b>traduction/alertes</b>\nְ️<b>intégration</b>et paiements\n▪️neuro-<b>génération/clone</b>bot\nnouncement<b>web-app/neuro</b>-posting",
    'zh': "<b>👩🏽‍💻 @FereyBotBot </b>-#конструктор\n\n▪️<b>集合/禁止/分析</b>订阅者\n▪️auto-<b>翻译/警报</b>\n▪️<b>集成</b>和支付\n▪️neuro-<b>生成/克隆</b>机器人\n▪️<b>网络应用/神经</b>-发布",
    'ar': "<b>👩🏽‍💻 @FereyBotBot </b>-#конструктор\n\n▪️<b>التجميع/الحظر/التحليلات</b> المشتركين\n▪️auto-<b>الترجمة/التنبيهات</b>\n▪️<b>التكامل</b>والمدفوعات\n▪️neuro-<b>الجيل/الاستنساخ</b>bot\n▪️<b>web-app/neuro</b>-النشر",
}
l_kind_3 = {
    'ru': "<b>👩🏽‍💻@FereyChannelBot</b> - #администрирование каналов\n\n▪️<b>сбор/бан/аналитика</b> подписчиков\n▪️<b>авто-декор/подкасты</b> поста\n▪️кнопочный <b>счетчик</b>\n▪️<b>веб-апп/нейро</b>-постинг",
    'en': "<b>👩🏽‍💻 @FereyChannelBot </b>-#администрирование\n\n▪️<b>collection/ban/analytics</b> subscribers\n▪️<b>auto-decor/podcasts</b> post\n▪️button <b>counter</b>\n▪️<b>web app/neuro</b>-posting",
    'es': "<b>👩🏽‍💻 @FereyChannelBot </b>-#администрирование\n\n▪️<b>colección/ban/análisis</b> suscriptores\n▪️<b>autodecoración/podcasts</b> publicación\n▪️botón <b>contador</b>\n▪️<b>aplicación web/neuro</b>-publicación",
    'fr': "<b>👩🏽‍💻 @FereyChannelBot </b>-#администрирование\n\n▪️<b>collection/ban/analytics</b> abonnés\n▪️<b>décoration automatique/podcasts</b> post\n▪️bouton <b>compteur</b>\n▪️<b>application web/neuro</b>-posting",
    'zh': "<b>👩🏽‍💻 @FereyChannelBot </b>-#администрирование\n\n▪️<b>集合/禁止/分析</b>订阅者\n▪️<b>自动装饰/播客</b>发布\n▪️按钮<b>计数器</b>\n▪️<b>网络应用/神经</b>-发布",
    'ar': "<b>👩🏽‍💻 @FereyChannelBot </b>-#администрирование\n\n▪️<b>جمع/حظر/تحليلات</b> المشتركين\n▪️<b>ديكور تلقائي/بودكاست</b> نشر\n▪️زر <b>عداد</b>\n▪️<b>تطبيق ويب/عصبي</b>-النشر",
}
l_kind_4 = {
    'ru': "<b>👩🏽‍💻@FereyGroupBot</b> - #модерация групп\n\n▪️<b>защита</b> группы от шпионов\n▪️ограничение прав до <b>подписки</b>\n▪️<b>организация</b> бана/анти-флуда\n▪️аналитика и <b>вовлеченность</b>\n▪️<b>авто-ответы</b> и стоп-слова\n▪️кнопочный <b>счетчик</b>\n▪️<b>веб-апп/нейро</b>-постинг",
    'en': "<b>👩🏽‍💻 @FereyGroupBot </b>-#модерация\n\n▪️<b>protection</b> of the group from spies\n▪️limiting rights to <b>subscription</b>\n▪️ <b>organization</b> ban/anti-flood\n▪️analytics and <b>engagement</b>\n▪️<b>auto-responses</b> and stop words\n▪️button <b> counter</b>\n▪️<b>web app/neuro</b>-posting",
    'es': "<b>👩🏽‍💻 @FereyGroupBot </b>-#модерация\n\n▪️<b>protección</b> del grupo contra espías\n▪️limitación de derechos a la <b>suscripción</b>\ n▪️ <b>organización</b> prohibición/anti-inundación\n▪️análisis y <b>compromiso</b>\n▪️<b>respuestas automáticas</b> y palabras vacías\n▪️botón <b > contador</b>\n▪️<b>aplicación web/publicación neuro</b>",
    'fr': "<b>👩🏽‍💻 @FereyGroupBot </b>-#модерация\n\nlessly<b>protection</b> du groupe contre les espions\nnoyerlimitant les droits à <b>abonnement</b>\ nְ️ Interdiction de l'<b>organisation</b>/anti-inondation\n▪️analyses et <b>engagement</b>\nnoyance<b>réponses automatiques</b> et mots vides\nnoyer️bouton <b > compteur</b>\n▪️<b>web app/neuro</b>-posting",
    'zh': "<b>👩🏽‍💻 @FereyGroupBot </b>-#модерация\n\n▪️<b>保护</b>群组免受间谍侵害\n▪️限制<b>订阅</b>的权利\ n▪️<b>组织</b>禁止/反泛洪\n▪️分析和<b>参与度</b>\n▪️<b>自动回复</b>和停用词\n▪️按钮<b > 计数器</b>\n▪️<b>网络应用/神经</b>-发布",
    'ar': "<b>👩🏽‍💻 @FereyGroupBot </b>-#модерация\n\n▪️<b>حماية</b> المجموعة من الجواسيس\n▪️تقييد حقوق <b>الاشتراك</b>\n▪️ <b>المنظمة</b> الحظر/مكافحة الفيضانات\n▪️التحليلات و<b>المشاركة</b>\n▪️<b>الردود التلقائية</b> وكلمات الإيقاف\n▪️زر <b > العداد</b>\n▪️<b>تطبيق الويب/العصبي</b>-النشر",
}
l_kind_5 = {
    'ru': "<b>👩🏽‍💻@FereyUserBot</b> - #автоматизация аккаунтов\n\n▪️<b>авто</b>-перевод/транскрибация\n▪️<b>нейро-генерация</b> бота\n▪️<b>мониторинг</b> гео/слов\n▪️<b>авто-формат</b> и подкасты\n▪️<b>веб-апп/нейро</b>-постинг",
    'en': "<b>👩🏽‍💻 @FereyUserBot </b>-#автоматизация\n\n▪️<b>auto</b>-translation/transcription\n▪️<b>neuro-generation</b> bot\n▪️<b>monitoring</b>geo/words\n▪️<b>auto-format</b> and podcasts\n▪️<b>web app/neuro</b>-posting",
    'es': "<b>👩🏽‍💻 @FereyUserBot </b>-#автоматизация\n\n▪️<b>auto</b>-traducción/transcripción\n▪️<b>bot de neurogeneración</b>\n▪️<b>monitoreo</b>geo/words\n▪️<b>formato automático</b> y podcasts\n▪️<b>aplicación web/neuro</b>-publicación",
    'fr': "<b>👩🏽‍💻 @FereyUserBot </b>-#автоматизация\n\nnoyance<b>auto</b>-traduction/transcription\nnoyer️<b>bot de neuro-génération</b>\n▪️<b>surveillance</b>géo/mots\nnoyer️<b>formatage automatique</b> et podcasts\nnoyer️<b>application web/neuro</b>-publication",
    'zh': "<b>👩🏽‍💻 @FereyUserBot </b>-#автоматизация\n\n▪️<b>自动</b>-翻译/转录\n▪️<b>神经生成</b>机器人\n▪️<b>监控</b>地理/单词\n▪️<b>自动格式</b>和播客\n▪️<b>网络应用/神经</b>-发布",
    'ar': "<b>👩🏽‍💻 @FereyUserBot </b>-#автоматизация\n\n▪️<b>تلقائي</b>-الترجمة/النسخ\n▪️<b>التوليد العصبي</b> بوت\n▪️<b>مراقبة</b>الموقع الجغرافي/الكلمات\n▪️<b>التنسيق التلقائي</b> والبودكاست\n▪️<b>تطبيق الويب/العصبية</b>-النشر",
}
l_kind_6 = {
    'ru': "<b>👩🏽‍💻@FereyPostBot</b> - приватные #посты\n\n▪️<b>кнопочный</b> счетчик\n▪️инлайн-<b>телескопы</b>\n▪️парсинг/уведомления о <b>кликах</b>\n▪️<b>шёпот</b>-сообщения",
    'en': "<b>👩🏽‍💻 @FereyPostBot </b>-private #посты\n\n▪️<b>button</b> counter\n▪️inline-<b>telescopes</b>\n▪️parsing/notifications about <b>clicks</b>\n▪️<b>whisper</b>-messages",
    'es': "<b>👩🏽‍💻 @FereyPostBot </b>-#посты privadas\n\n▪️<b>contador de botones</b>\n▪️en línea-<b>telescopios</b>\n▪️análisis/notificaciones acerca de <b>clics</b>\n▪️<b>mensajes susurrados</b>",
    'fr': "<b>👩🏽‍💻 @FereyPostBot </b>-#посты privés\n\n▪️Compteur de <b>bouton</b>\n▪️inline-<b>télescopes</b>\n▪️analyse/notifications à propos des <b>clics</b>\nnounced️<b>chuchotements</b>-messages",
    'zh': "<b>👩🏽‍💻 @FereyPostBot </b>-私人#посты\n\n▪️<b>按钮</b>计数器\n▪️内联-<b>望远镜</b>\n▪️解析/通知关于<b>点击</b>\n▪️<b>耳语</b>-消息",
    'ar': "<b>👩🏽‍💻 @FereyPostBot </b>-#посты الخاصة\n\n▪️<b>زر</b> عداد\n▪️inline-<b>تلسكوبات</b>\n▪️parsing/notifications حول <b>النقرات</b>\n▪️<b>الهمس</b>-الرسائل",
}
l_kind_7 = {
    'ru': "<b>👩🏽‍💻@FereyMediaBot</b> - публичные #медиа-заметки\n\n▪️<b>стикеры</b> из текста и фото\n▪️<b>аудио-тренды</b>\n▪️<b>видео-заметки</b>\n▪️инлайн-<b>телескопы</b>\n▪️<b>кнопочные</b> медиа",
    'en': "<b>👩🏽‍💻 @FereyMediaBot </b>-public #медиа notes\n\n▪️<b>stickers</b> from text and photos\n▪️<b>audio trends</b>\ n▪️<b>video notes</b>\n▪️online<b>telescopes</b>\n▪️<b>button</b> media",
    'es': "<b>👩🏽‍💻 @FereyMediaBot </b>-notas #медиа públicas\n\n▪️<b>pegatinas</b> de texto y fotos\n▪️<b>tendencias de audio</b>\ n▪️ <b>notas de vídeo</b>\n▪️online<b>telescopios</b>\n▪️<b>botón</b> medios",
    'fr': "<b>👩🏽‍💻 @FereyMediaBot </b>-notes #медиа publiques\n\nnounced<b>autocollants</b> à partir de textes et de photos\nnounced️<b>tendances audio</b>\ ncyclical <b>notes vidéo</b>\nƒ️en ligne<b>télescopes</b>\nƒ️<b>bouton</b> média",
    'zh': "<b>👩🏽‍💻 @FereyMediaBot </b>-公共#медиа笔记\n\n▪️来自文本和照片的<b>贴纸</b>\n▪️<b>音频趋势</b>\ n▪️ <b>视频笔记</b>\n▪️在线<b>望远镜</b>\n▪️<b>按钮</b>媒体",
    'ar': "<b>👩🏽‍💻 @FereyMediaBot </b>-ملاحظات #медиа العامة\n\n▪️<b>ملصقات</b> من النصوص والصور\n▪️<b>الاتجاهات الصوتية</b>\n▪️ <b>ملاحظات الفيديو</b>\n▪️على الإنترنت<b>التلسكوبات</b>\n▪️<b>زر</b> الوسائط",
}
l_kind_8 = {
    'ru': "<b>👩🏽‍💻@FereyFindBot</b> - премиум #поиск\n\n▪️<b>top</b> каналы/группы\n▪️<b>vip</b> пользователи/боты\n▪️<b>geo</b> парсинг\n▪️<b>smm</b> пассивный маркетинг",
    'en': "<b>👩🏽‍💻 @FereyFindBot </b>-premium #поиск\n\n▪️<b>top</b> channels/groups\n▪️<b>vip</b> users/bots\n▪️ <b>geo</b> parsing\n▪️<b>smm</b> passive marketing",
    'es': "<b>👩🏽‍💻 @FereyFindBot </b>-# #поиск premium\n\n▪️<b>principales</b> canales/grupos\n▪️<b>vip</b> usuarios/bots\n▪️ Análisis <b>geo</b>\n▪️<b>smm</b> marketing pasivo",
    'fr': "<b>👩🏽‍💻 @FereyFindBot </b>-#поиск premium\n\nnoyer<b>meilleurs</b> canaux/groupes\nnoyer</b> utilisateurs/bots vip</b>\nnoyer Analyse <b>géo</b>\n▪️<b>smm</b> marketing passif",
    'zh': "<b>👩🏽‍💻 @FereyFindBot </b>-高级#поиск\n\n▪️<b>顶级</b> 频道/群组\n▪️<b>vip</b> 用户/机器人\n▪️ <b>geo</b>解析\n▪️<b>smm</b>被动营销",
    'ar': "<b>👩🏽‍💻 @FereyFindBot </b>-#поиск متميز\n\n▪️<b>أهم</b> القنوات/المجموعات\n▪️<b>vip</b> المستخدمون/الروبوتات\n▪️ <b>الجغرافي</b> التحليل\n▪️<b>smm</b> التسويق السلبي",
}
l_kind_9 = {
    'ru': "<b>👩🏽‍💻@FereyAIBot</b> - #нейро-генерация контента\n\n▪️<b>текст/изображение</b>\n▪️<b>нейро-анализ</b> @telegram-канала\n▪️<b>распознавание</b> речи\n▪️<b>очистка ⁰истории</b> /start",
    'en': "<b>👩🏽‍💻 @FereyAIBot </b>-#нейро-content generation\n\n▪️<b>text/image</b>\n▪️<b>neuro-analysis</b> @telegram-channel\n▪️<b>speech recognition</b>\n▪️<b>clearing ⁰history</b> /start",
    'es': "<b>👩🏽‍💻 @FereyAIBot </b>-#нейро\n\n▪️<b>texto/imagen</b>\n▪️<b>neuroanálisis</b> @telegram-canal\n▪️<b>reconocimiento de voz</b>\n▪️<b>borrando ⁰historial</b> /inicio",
    'fr': "<b>👩🏽‍💻 @FereyAIBot </b>-#нейро-génération de contenu\n\nnoyer<b>texte/image</b>\nnoyam<b>neuro-analyse</b> @telegram-canal\n▪️<b>reconnaissance vocale</b>\n▪️<b>effacer l'⁰historique</b> /start",
    'zh': "<b>👩🏽‍💻 @FereyAIBot </b>-#нейро-内容生成\n\n▪️<b>文本/图像</b>\n▪️<b>神经分析</b> @telegram-频道\n▪️<b>语音识别</b>\n▪️<b>清除⁰历史记录</b> /start",
    'ar': "<b>👩🏽‍💻 @FereyAIBot </b>-#нейро-content Generation\n\n▪️<b>نص/صورة</b>\n▪️<b>تحليل عصبي</b> @telegram-القناة\n▪️<b>التعرف على الكلام</b>\n▪️<b>مسح ⁰السجل</b> /بدء",
}
l_kind_10 = {
    'ru': "<b>👩🏽‍💻@FereyVPNBot</b> - #vpn настройки\n\n▪️<b>open vpn</b>\n▪️<b>wire guard</b>\n▪️<b>shadow socks</b>",
    'en': "<b>👩🏽‍💻@FereyVPNBot</b>-#vpn настройки\n\n▪️<b>open vpn</b>\n▪️<b>wire guard</b>\n▪️<b>shadow socks</b>",
    'es': "<b>👩🏽‍💻 @FereyVPNBot </b>-#vpn настройки\n\n▪️<b>vpn abierto</b>\n▪️<b>protección de cables</b>\n▪️<b>sombra calcetines</b>",
    'fr': "<b>👩🏽‍💻 @FereyVPNBot </b>-#vpn настройки\n\nnoyam<b>open vpn</b>\nnoyer<b>wire guard</b>\nnoyance<b>shadow chaussettes</b>",
    'zh': "<b>👩🏽‍💻 @FereyVPNBot </b>-#vpn настройки\n\n▪️<b>开放VPN</b>\n▪️<b>线卫</b>\n▪️<b>阴影袜子</b>",
    'ar': "<b>👩🏽‍💻 @FereyVPNBot </b>-#vpn настройки\n\n▪️<b>open vpn</b>\n▪️<b>wire Guard</b>\n▪️<b>shadow الجوارب</ب>",
}
l_kind_11 = {
    'ru': "<b>👩🏽‍💻@FereyTargetBot</b> - телеграмм #таргет\n\n▪️парсинг\n▪️гео-мониторинг\n▪️проверка номеров",
    'en': "<b>👩🏽‍💻 @FereyTargetBot </b>-telegram #таргет\n\n▪️parsing\n▪️geo-monitoring\n▪️checking numbers",
    'es': "<b>👩🏽‍💻 @FereyTargetBot </b>-telegram #таргет\n\n▪️análisis\n▪️geo-monitoreo\n▪️comprobación de números",
    'fr': "<b>👩🏽‍💻 @FereyTargetBot </b>-télégramme #таргет\n\n▪️parsing\n▪️géo-surveillance\n▪️vérification des numéros",
    'zh': "<b>👩🏽‍💻 @FereyTargetBot </b>-电报#таргет\n\n▪️解析\n▪️地理监控\n▪️检查数字",
    'ar': "<b>👩🏽‍💻 @FereyTargetBot </b>-telegram #таргет\n\n▪️parsing\n▪️geo-monitoring\n▪️التحقق من الأرقام",
}
l_kind_12 = {
    'ru': "<b>👩🏽‍💻@FereyToolsBot</b> - телеграм #инструменты\n\n▪️<b>преобразование</b> контента\n▪️<b>/json</b> информация о сообщ\n▪️<b>удаление</b> фона\n▪️<b>/id</b> группы/канала/бота\n▪️конвертация в <b>телескопы</b>\n▪️<b>/telegraph</b> фото/видео-ссылка\n▪️пустое сообщение <b>0-длины</b>",
    'en': "<b>👩🏽‍💻 @FereyToolsBot </b>-telegram #инструменты\n\n▪️<b>conversion</b> of content\n▪️<b>/json</b> message information\n▪️< b>removal</b> background\n▪️<b>/id</b> group/channel/bot\n▪️conversion to <b>telescopes</b>\n▪️<b>/telegraph</b> photo/video link\n▪️empty message <b>0-length</b>",
    'es': "<b>👩🏽‍💻 @FereyToolsBot </b>-telegram #инструменты\n\n▪️<b>conversión</b> de contenido\n▪️<b>/json</b> información del mensaje\n▪️< b>eliminación</b> fondo\n▪️<b>/id</b> grupo/canal/bot\n▪️conversión a <b>telescopios</b>\n▪️<b>/telegraph</b> enlace de foto/vídeo\n▪️mensaje vacío <b>0 longitud</b>",
    'fr': "<b>👩🏽‍💻 @FereyToolsBot </b>-#инструменты de télégramme\n\nnoyance<b>conversion</b> du contenu\nproducex️<b>/json</b> informations sur les messages\nfacturés ️< b>suppression</b> de l'arrière-plan\nproducer<b>/id</b> groupe/canal/bot\nwithout lien photo/vidéo\n▪️message vide <b>longueur 0</b>",
    'zh': "<b>👩🏽‍💻 @FereyToolsBot </b>-telegram #инструменты\n\n▪️<b>内容转换</b>\n▪️<b>/json</b>消息信息\n▪️< b>移除</b>背景\n▪️<b>/id</b>组/频道/机器人\n▪️转换为<b>望远镜</b>\n▪️<b>/telegraph</b>照片/视频链接\n▪️空消息<b>0长度</b>",
    'ar': "<b>👩🏽‍💻 @FereyToolsBot </b>-#инструменты telegram\n\n▪️<b>تحويل</b> المحتوى\n▪️<b>/json</b> معلومات الرسالة\n▪️< b>إزالة</b> الخلفية\n▪️<b>/id</b> المجموعة/القناة/bot\n▪️التحويل إلى <b>التلسكوبات</b>\n▪️<b>/telegraph</b> رابط الصورة/الفيديو\n▪️رسالة فارغة <b>0-الطول</b>",
}
l_kind_13 = {
    'ru': "<b>👩🏽‍💻@FereyAdsBot</b> - ferey #реклама\n\n▪️️реклама в ferey-проектах\n▪️️заказ рекламы на канале",
    'en': "<b>👩🏽‍💻 @FereyAdsBot </b>-ferey #реклама\n\n▪️️advertising in ferey-projects\n▪️️ordering advertising on the channel",
    'es': "<b>👩🏽‍💻 @FereyAdsBot </b>-ferey #реклама\n\n▪️️publicidad en ferey-projects\n▪️️pedido de publicidad en el canal",
    'fr': "<b>👩🏽‍💻 @FereyAdsBot </b>-ferey #реклама\n\n▪️️publicité dans les projets ferey\n▪️️commander de la publicité sur la chaîne",
    'zh': "<b>👩🏽‍💻 @FereyAdsBot </b>-ferey #реклама\n\n▪️️ferey-projects 中的广告\n▪️️在频道上订购广告",
    'ar': "<b>👩🏽‍💻 @FereyAdsBot </b>-Ferey #реклама\n\n▪️️advertising in frey-projects\n▪️️طلب اعلانات على القناة",
}
l_kind_14 = {
    'ru': "<b>👩🏽‍💻@FereyWorkBot</b> - #вакансии проекта\n\n▪️<b>вакансии</b> проекта\n▪️конкурсы и <b>задания</b>\n▪️<b>партнеры</b> и инвесторы\n▪️услуги и <b>пожертвования</b>",
    'en': "<b>👩🏽‍💻 @FereyWorkBot </b>-#вакансии\n\n▪️<b>vacancies</b> of the project\n▪️competitions and <b>tasks</b>\n▪️<b> partners</b>and investors\n▪️services and <b>donations</b>",
    'es': "<b>👩🏽‍💻 @FereyWorkBot </b>-#вакансии\n\n▪️<b>vacantes</b> del proyecto\n▪️concursos y <b>tareas</b>\n▪️< b> socios</b>e inversores\n▪️servicios y <b>donaciones</b>",
    'fr': "<b>👩🏽‍💻 @FereyWorkBot </b>-#вакансии\n\nnoyance<b>postes vacants</b> du projet\nnoyanceconcours et <b>tâches</b>\nnoyam< b> partenaires</b>et investisseurs\n▪️services et <b>dons</b>",
    'zh': "<b>👩🏽‍💻 @FereyWorkBot </b>-#вакансии\n\n▪️项目的<b>空缺</b>\n▪️竞赛和<b>任务</b>\n▪️< b> 合作伙伴</b>和投资者\n▪️服务和<b>捐赠</b>",
    'ar': "<b>👩🏽‍💻 @FereyWorkBot </b>-#вакансии\n\n▪️<b>وظائف شاغرة</b> للمشروع\n▪️المسابقات و<b>المهام</b>\n▪️< ب> الشركاء</b>والمستثمرون\n▪️الخدمات و<b>التبرعات</b>",
}
# endregion