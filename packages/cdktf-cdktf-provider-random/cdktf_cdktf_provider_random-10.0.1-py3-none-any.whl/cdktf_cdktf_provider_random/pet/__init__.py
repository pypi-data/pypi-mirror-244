...
class Pet(
    ...
    def __init__(
        ...
        *,
        ...
        :param keepers: Arbitrary map of values that, when changed, will trigger recreation of resource. See `the main provider documentation <../index.html>`_ for more information. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/random/3.6.0/docs/resources/pet#keepers Pet#keepers}
        :param length: The length (in words) of the pet name. Defaults to 2. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/random/3.6.0/docs/resources/pet#length Pet#length}
        :param prefix: A string to prefix the name with. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/random/3.6.0/docs/resources/pet#prefix Pet#prefix}
        :param separator: The character to separate words in the pet name. Defaults to "-". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/random/3.6.0/docs/resources/pet#separator Pet#separator}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__60dea99a1ee98a768319417b6131306669b4ee1a5cd91628027f2a1aff531d3d)
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing Pet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/random/3.6.0/docs/resources/pet#import import section} in the documentation of this resource for the id to use
        :param provider: ? Optional instance of the provider where the Pet to import is found.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f3964e3f5c2949511069cc77faef8afbea51c7d39a1b9b65e3a8678049a7c0ff)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
    ...
    def keepers(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__958cc7df6be7323d7594e734ce70f54559052f812a642c43451ffd3c65f0f033)
    ...
    def length(self, value: jsii.Number) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d17e0de5305c8d945e5fdeff70a6fb7eae38f41b271d6f3f88f357118fb23de7)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def prefix(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0075290c46b54cff05a1c0bf64698255d9cd10ff6f77b38bd56f43578671dacd)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def separator(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9de06bcbf9e45f0bd1c5a5fa074ff3dc2e13acb95c53883a6ea6c15449758dfd)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "separator", value)


@jsii.data_type(
    jsii_type="@cdktf/provider-random.pet.PetConfig",
...
def _typecheckingstub__60dea99a1ee98a768319417b6131306669b4ee1a5cd91628027f2a1aff531d3d(
    scope: _constructs_77d1e7e8.Construct,
    id: builtins.str,
    *,
    keepers: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
...
def _typecheckingstub__f3964e3f5c2949511069cc77faef8afbea51c7d39a1b9b65e3a8678049a7c0ff(
    scope: _constructs_77d1e7e8.Construct,
    import_to_id: builtins.str,
    import_from_id: builtins.str,
    provider: typing.Optional[_cdktf_9a9027ec.TerraformProvider] = None,
...
def _typecheckingstub__958cc7df6be7323d7594e734ce70f54559052f812a642c43451ffd3c65f0f033(
    value: typing.Mapping[builtins.str, builtins.str],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__d17e0de5305c8d945e5fdeff70a6fb7eae38f41b271d6f3f88f357118fb23de7(
    value: jsii.Number,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__0075290c46b54cff05a1c0bf64698255d9cd10ff6f77b38bd56f43578671dacd(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__9de06bcbf9e45f0bd1c5a5fa074ff3dc2e13acb95c53883a6ea6c15449758dfd(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
