...
class Bytes(
    ...
    jsii_type="@cdktf/provider-random.bytes.Bytes",
):
    ...
    def __init__(
        ...
        *,
        ...
        :param length: The number of bytes requested. The minimum value for length is 1. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/random/3.6.0/docs/resources/bytes#length Bytes#length}
        :param keepers: Arbitrary map of values that, when changed, will trigger recreation of resource. See `the main provider documentation <../index.html>`_ for more information. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/random/3.6.0/docs/resources/bytes#keepers Bytes#keepers}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__05862496236fec105d9bd0017b8ed0eeb3d2a71dd90a966177413bc58f2cf5dd)
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing Bytes that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/random/3.6.0/docs/resources/bytes#import import section} in the documentation of this resource for the id to use
        :param provider: ? Optional instance of the provider where the Bytes to import is found.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5176b49e11b2aee64802914415c88dd70bf80c5e2424e79ee1cae85a9fbcb17c)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
    ...
    def keepers(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f6d461a2e40edff79426b0113e6a3083b5f767e402e7a3fe7613f28fb8a4d9da)
    ...
    def length(self, value: jsii.Number) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__de05aef6b57c13c943209cef5c61c0ed11985ea77c1129c38b60baf675304fba)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "length", value)


@jsii.data_type(
    jsii_type="@cdktf/provider-random.bytes.BytesConfig",
...
class BytesConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a5419fd5a3711583f563e70f781aef8f0a5c634250ea46f9fb8f8de985890f61)
...
def _typecheckingstub__05862496236fec105d9bd0017b8ed0eeb3d2a71dd90a966177413bc58f2cf5dd(
    scope: _constructs_77d1e7e8.Construct,
    id: builtins.str,
    *,
    length: jsii.Number,
...
def _typecheckingstub__5176b49e11b2aee64802914415c88dd70bf80c5e2424e79ee1cae85a9fbcb17c(
    scope: _constructs_77d1e7e8.Construct,
    import_to_id: builtins.str,
    import_from_id: builtins.str,
    provider: typing.Optional[_cdktf_9a9027ec.TerraformProvider] = None,
...
def _typecheckingstub__f6d461a2e40edff79426b0113e6a3083b5f767e402e7a3fe7613f28fb8a4d9da(
    value: typing.Mapping[builtins.str, builtins.str],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__de05aef6b57c13c943209cef5c61c0ed11985ea77c1129c38b60baf675304fba(
    value: jsii.Number,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__a5419fd5a3711583f563e70f781aef8f0a5c634250ea46f9fb8f8de985890f61(
    *,
    connection: typing.Optional[typing.Union[typing.Union[_cdktf_9a9027ec.SSHProvisionerConnection, typing.Dict[builtins.str, typing.Any]], typing.Union[_cdktf_9a9027ec.WinrmProvisionerConnection, typing.Dict[builtins.str, typing.Any]]]] = None,
    count: typing.Optional[typing.Union[jsii.Number, _cdktf_9a9027ec.TerraformCount]] = None,
    depends_on: typing.Optional[typing.Sequence[_cdktf_9a9027ec.ITerraformDependable]] = None,
