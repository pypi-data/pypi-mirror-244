  ...
  'syms': { 'bellek.logging': {'bellek.logging.get_logger': ('logging.html#get_logger', 'bellek/logging.py')},
            ...
            'bellek.ml.experiment': { 'bellek.ml.experiment.main': ('ml.experiment.html#main', 'bellek/ml/experiment.py'),
                                      ...
                                      'bellek.ml.experiment.prepare_config': ( 'ml.experiment.html#prepare_config',
                                                                               'bellek/ml/experiment.py')},
            'bellek.ml.kg.cons': { 'bellek.ml.kg.cons.ERXFormatter': ('ml.kg.cons.html#erxformatter', 'bellek/ml/kg/cons.py'),
                                   'bellek.ml.kg.cons.ERXFormatter.__post_init__': ( 'ml.kg.cons.html#erxformatter.__post_init__',
                                                                                     'bellek/ml/kg/cons.py'),
                                   'bellek.ml.kg.cons.ERXFormatter._choose_few_shot_examples': ( 'ml.kg.cons.html#erxformatter._choose_few_shot_examples',
                                                                                                 'bellek/ml/kg/cons.py'),
                                   'bellek.ml.kg.cons.ERXFormatter.format_for_inference': ( 'ml.kg.cons.html#erxformatter.format_for_inference',
                                                                                            'bellek/ml/kg/cons.py'),
                                   'bellek.ml.kg.cons.ERXFormatter.format_for_train': ( 'ml.kg.cons.html#erxformatter.format_for_train',
                                                                                        'bellek/ml/kg/cons.py'),
                                   'bellek.ml.kg.cons.ERXFormatter.make_system_prompt': ( 'ml.kg.cons.html#erxformatter.make_system_prompt',
                                                                                          'bellek/ml/kg/cons.py'),
