...
setup(
    ...
    version="0.4",
    python_requires=">=3.8",
    description="A simple math chat, built on AutoGen framework. An integrated tool, developed in LetMeDoIt AI project.",
    ...
    keywords="ai autogen math gpt openai",
    url="https://letmedoit.ai",
    project_urls={
        "Source": "https://github.com/eliranwong/automath",
        "Tracker": "https://github.com/eliranwong/automath/issues",
        "Documentation": "https://github.com/eliranwong/automath/wiki",
