...
class FilterDataset(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FilterDataset from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in microscopies (list)
        _items = []
        if self.microscopies:
            for _item in self.microscopies:
                if _item:
                    _items.append(_item.to_dict())
            _dict['microscopies'] = _items
        ...
        # set to None if microscopies (nullable) is None
        # and model_fields_set contains the field
        if self.microscopies is None and "microscopies" in self.model_fields_set:
            _dict['microscopies'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of FilterDataset from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "mutations": [MutationModelJustRead.from_dict(_item) for _item in obj.get("mutations")] if obj.get("mutations") is not None else None,
            "brain_regions": [BrainRegionJustRead.from_dict(_item) for _item in obj.get("brain_regions")] if obj.get("brain_regions") is not None else None,
            "microscopies": [MicroscopyJustRead.from_dict(_item) for _item in obj.get("microscopies")] if obj.get("microscopies") is not None else None
        })
        return _obj
