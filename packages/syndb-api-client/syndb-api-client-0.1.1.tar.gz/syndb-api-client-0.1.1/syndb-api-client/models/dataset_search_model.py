...
class DatasetSearchModel(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "include": FilterDataset.from_dict(obj.get("include")) if obj.get("include") is not None else None,
            "exclude": FilterDataset.from_dict(obj.get("exclude")) if obj.get("exclude") is not None else None
        })
        return _obj
