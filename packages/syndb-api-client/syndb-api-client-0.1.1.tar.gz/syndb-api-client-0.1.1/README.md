...
import time
import syndb-api-client
from syndb-api-client.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to http://localhost
# See configuration.py for a list of all supported configuration parameters.
configuration = syndb-api-client.Configuration(
    host = "http://localhost"
)
...
with syndb-api-client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = syndb-api-client.AuthApi(api_client)
...
------------ | ------------- | ------------- | -------------
*AuthApi* | [**auth_database_login_user_auth_database_login_post**](docs/AuthApi.md#auth_database_login_user_auth_database_login_post) | **POST** /user/auth/database/login | Auth:Database.Login
...
*MetadataApi* | [**fetch_all_tags_endpoint_neurodata_metadata_tag_get_all_get**](docs/MetadataApi.md#fetch_all_tags_endpoint_neurodata_metadata_tag_get_all_get) | **GET** /neurodata/metadata/tag/get_all | Fetch All Tags Endpoint
...
*NeurodataApi* | [**fetch_all_tags_endpoint_neurodata_metadata_tag_get_all_get**](docs/NeurodataApi.md#fetch_all_tags_endpoint_neurodata_metadata_tag_get_all_get) | **GET** /neurodata/metadata/tag/get_all | Fetch All Tags Endpoint
...
*NeurodataApi* | [**upload_dataset_files_neurodata_upload_dataset_files_post**](docs/NeurodataApi.md#upload_dataset_files_neurodata_upload_dataset_files_post) | **POST** /neurodata/upload_dataset_files | Upload Dataset Files
*NeurodataApi* | [**upload_mesh_neurodata_s3_upload_mesh_post**](docs/NeurodataApi.md#upload_mesh_neurodata_s3_upload_mesh_post) | **POST** /neurodata/s3/upload/mesh | Upload Mesh
*NeurodataApi* | [**upload_swb_neurodata_s3_upload_swb_post**](docs/NeurodataApi.md#upload_swb_neurodata_s3_upload_swb_post) | **POST** /neurodata/s3/upload/swb | Upload Swb
*S3Api* | [**profile_from_scientist_tag_user_profile_scientist_tag_get**](docs/S3Api.md#profile_from_scientist_tag_user_profile_scientist_tag_get) | **GET** /user/profile/{scientist_tag} | Profile From Scientist Tag
*S3Api* | [**set_profile_picture_user_profile_current_upload_url_profile_picture_post**](docs/S3Api.md#set_profile_picture_user_profile_current_upload_url_profile_picture_post) | **POST** /user/profile/current/upload_url_profile_picture | Set Profile Picture
*S3Api* | [**upload_mesh_neurodata_s3_upload_mesh_post**](docs/S3Api.md#upload_mesh_neurodata_s3_upload_mesh_post) | **POST** /neurodata/s3/upload/mesh | Upload Mesh
*S3Api* | [**upload_mesh_neurodata_s3_upload_mesh_post_0**](docs/S3Api.md#upload_mesh_neurodata_s3_upload_mesh_post_0) | **POST** /neurodata/s3/upload/mesh | Upload Mesh
*S3Api* | [**upload_swb_neurodata_s3_upload_swb_post**](docs/S3Api.md#upload_swb_neurodata_s3_upload_swb_post) | **POST** /neurodata/s3/upload/swb | Upload Swb
*S3Api* | [**upload_swb_neurodata_s3_upload_swb_post_0**](docs/S3Api.md#upload_swb_neurodata_s3_upload_swb_post_0) | **POST** /neurodata/s3/upload/swb | Upload Swb
...
*TagApi* | [**fetch_all_tags_endpoint_neurodata_metadata_tag_get_all_get**](docs/TagApi.md#fetch_all_tags_endpoint_neurodata_metadata_tag_get_all_get) | **GET** /neurodata/metadata/tag/get_all | Fetch All Tags Endpoint
*UserApi* | [**auth_database_login_user_auth_database_login_post**](docs/UserApi.md#auth_database_login_user_auth_database_login_post) | **POST** /user/auth/database/login | Auth:Database.Login
*UserApi* | [**auth_database_login_user_auth_database_login_post_0**](docs/UserApi.md#auth_database_login_user_auth_database_login_post_0) | **POST** /user/auth/database/login | Auth:Database.Login
*UserApi* | [**auth_database_logout_user_auth_database_logout_post**](docs/UserApi.md#auth_database_logout_user_auth_database_logout_post) | **POST** /user/auth/database/logout | Auth:Database.Logout
*UserApi* | [**auth_database_logout_user_auth_database_logout_post_0**](docs/UserApi.md#auth_database_logout_user_auth_database_logout_post_0) | **POST** /user/auth/database/logout | Auth:Database.Logout
...
*UserApi* | [**profile_from_scientist_tag_user_profile_scientist_tag_get**](docs/UserApi.md#profile_from_scientist_tag_user_profile_scientist_tag_get) | **GET** /user/profile/{scientist_tag} | Profile From Scientist Tag
*UserApi* | [**register_register_user_register_post**](docs/UserApi.md#register_register_user_register_post) | **POST** /user/register | Register:Register
...
*UserApi* | [**verify_request_token_user_request_verify_token_post**](docs/UserApi.md#verify_request_token_user_request_verify_token_post) | **POST** /user/request-verify-token | Verify:Request-Token
*UserApi* | [**verify_verify_user_verify_post**](docs/UserApi.md#verify_verify_user_verify_post) | **POST** /user/verify | Verify:Verify


## Documentation For Models

 - [AllTagsJustRead](docs/AllTagsJustRead.md)
 ...
 - [BodyVerifyRequestTokenUserRequestVerifyTokenPost](docs/BodyVerifyRequestTokenUserRequestVerifyTokenPost.md)
 - [BodyVerifyVerifyUserVerifyPost](docs/BodyVerifyVerifyUserVerifyPost.md)
 ...
 - [FilterDataset](docs/FilterDataset.md)
 ...
 - [MicroscopyJustRead](docs/MicroscopyJustRead.md)
