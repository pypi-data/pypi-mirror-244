...
class CreateDataset(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of microscopy
        if self.microscopy:
            _dict['microscopy'] = self.microscopy.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "label": obj.get("label"),
            "notes": obj.get("notes"),
            "animal": AnimalModelCreateRead.from_dict(obj.get("animal")) if obj.get("animal") is not None else None,
            "mutations": [MutationModelCreateRead.from_dict(_item) for _item in obj.get("mutations")] if obj.get("mutations") is not None else None,
            "brain_region": BrainRegionCreateRead.from_dict(obj.get("brain_region")) if obj.get("brain_region") is not None else None,
            "microscopy": MicroscopyCreateRead.from_dict(obj.get("microscopy")) if obj.get("microscopy") is not None else None
        })
        return _obj
