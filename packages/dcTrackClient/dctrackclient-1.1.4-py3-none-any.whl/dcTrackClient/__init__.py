...
class Client:
    """Sunbird dcTrack API client version 1.1.4 in Python"""
    ...
    def deleteTicketAssignment(self, assignmentId: int):
        ...
        return self.__request('DELETE', '/api/v2/tickets/assignment/' + str(assignmentId) + '/?')
    ...
    def deleteCustomFields(self, customFieldId: int, proceedOnWarning: bool):
