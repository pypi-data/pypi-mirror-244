...
class TlgApp:
    ...
    def init_client(self):
        appvs = ['10.0.21','10.0.11','10.0.13','10.0.18']

        device_versions = ['119','118','117','116']
        
        device_version = choice(device_versions)
        appv = choice(appvs)
            
        extra = {
            'device_model': f'Chrome {device_version}',
            'app_version':appv,
