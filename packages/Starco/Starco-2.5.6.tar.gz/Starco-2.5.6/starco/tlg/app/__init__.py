...
from telethon.tl.functions.messages import GetMessagesViewsRequest,GetMessagesReactionsRequest,SendReactionRequest
...
class TlgApp:
    def __init__(self, number, key='17203958', hash='82cefc4001e057c9d1488ab90e23d54f', loop=None, debug_mode=True,country_diring=False,reset_json=False,auto_connect=True, **kwargs) -> None:
        '''
        relative_path='.'
