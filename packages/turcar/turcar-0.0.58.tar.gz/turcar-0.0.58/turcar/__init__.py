...
CONFIGURATION_FILE = os.path.join(turcar_USER_DIR, "configuration.ini")#'/Users/yubo/Library/turcar/configuration.ini'
...
def get_ipc_file_path():
    ...
    ipc_dir = os.path.join(base_dir, "turcar-%s" % username) #'/var/folders/7k/wf8jrd_506q1pw8hg21zvwm00000gn/T/turcar-yubo'
            ...
            if os.path.exists(file_path):
                ...
                with open(file_path, 'r') as file:
                    ...
                    if version == content.strip():
                        ...
                        return cheack.cheack_version(version)
        else:
            # 后端返回不等于两百的逻辑
            pass
