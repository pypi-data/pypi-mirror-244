...
class MetadataForm:
    ...
    def __init__(self, resource: Resource, fixed_values: bool = True) -> None:
    ...
    def defaults(self) -> None:
        ...
        """
        self.clear()
        for field_path, values in self.resource.fixed_values.items():
            try:
    ...
    def items(self) -> list[tuple[str, list[FormType]]]:
        """
