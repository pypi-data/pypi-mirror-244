...
ext_modules = [Extension(
                       ...
                       libraries=['libs\\win\\saxon-hec-12.4.1']
                        ),
                ]
setup(
    name='saxonche',
    version='12.4.1.0',
    description='Official Saxonica python package for the SaxonC-HE 12.4.1 processor: for XSLT 3.0, XQuery 3.1, XPath 3.1 and XML Schema processing.',
