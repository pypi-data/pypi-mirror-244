...
if __name__ == '__main__':
    from tkadw import *
    root = Adwite()
    designer = AdwDesigner(default_theme="metro")
    designer.row()
    root.mainloop()