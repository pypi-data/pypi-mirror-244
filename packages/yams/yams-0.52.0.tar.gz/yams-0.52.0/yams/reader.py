...
@deprecation.argument_renamed(
    old_name="erdefs", new_name="entity_relation_definitions", version="0.48"
)
@deprecation.argument_renamed(
    old_name="remove_unused_rtypes", new_name="remove_unused_relation_types", version="0.48"
)
def fill_schema(
...
@deprecation.attribute_renamed(old_name="schemacls", new_name="schema_class", version="0.48")
@deprecation.attribute_renamed(old_name="extrapath", new_name="extra_path", version="0.48")
class SchemaLoader:
    ...
    @deprecation.argument_renamed(old_name="modnames", new_name="module_names", version="0.48")
    def load(
        self,
    ...
    _load_modnames = deprecation.callable_renamed(
        old_name="_load_modnames", new_function=_load_module_names, version="0.48"
    )
    ...
    @deprecation.argument_renamed(old_name="filepath", new_name="file_path", version="0.48")
    @deprecation.argument_renamed(old_name="modname", new_name="module_name", version="0.48")
    ...
    @deprecation.argument_renamed(old_name="filepath", new_name="file_path", version="0.48")
    @deprecation.argument_renamed(
        old_name="defobject", new_name="definition_object", version="0.48"
    )
    def add_definition(
