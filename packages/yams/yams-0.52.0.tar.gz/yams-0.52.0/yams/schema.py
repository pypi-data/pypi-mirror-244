...
class ERSchema:
    ...
    @deprecation.argument_renamed(
        old_name="erdef", new_name="entity_relation_definition", version="0.48"
    )
    def __init__(
        self,
        schema: "Schema",
        entity_relation_definition: Optional[yams_types.RelationDefinition] = None,
    ) -> None:
        """
...
@deprecation.attribute_renamed(old_name="subjrels", new_name="subject_relations", version="0.48")
@deprecation.attribute_renamed(old_name="objrels", new_name="object_relations", version="0.48")
class EntitySchema(PermissionMixIn, ERSchema):
    ...
    def __init__(
        ...
        relation_definition: Optional[yams_types.EntityType] = None,
        *args,
        **kwargs,
    ) -> None:
    ...
    @deprecation.argument_renamed(old_name="rschema", new_name="relation_schema", version="0.48")
    ...
    @deprecation.argument_renamed(old_name="rtype", new_name="relation_schema", version="0.48")
    ...
    @deprecation.argument_renamed(old_name="rtype", new_name="relation_type", version="0.48")
    @deprecation.argument_renamed(old_name="targettype", new_name="target_type", version="0.48")
    @deprecation.argument_renamed(old_name="takefirst", new_name="take_first", version="0.48")
    def relation_definition(
        self,
        relation_type: yams_types.DefinitionName,
        role: str = "subject",
        target_type: Optional[yams_types.DefinitionName] = None,
    ...
    rdef = deprecation.callable_renamed(
        old_name="rdef", new_function=relation_definition, version="0.48"
    )
    ...
    @deprecation.argument_renamed(old_name="includefinal", new_name="include_final", version="0.48")
    ...
    @deprecation.argument_renamed(old_name="skiprels", new_name="skip_relations", version="0.48")
    def is_subobject(
        self,
        strict: bool = False,
...
@deprecation.attribute_renamed(old_name="rtype", new_name="relation_type", version="0.48")
class RelationDefinitionSchema(PermissionMixIn):
    ...
    @classmethod
    @deprecation.argument_renamed(old_name="desttype", new_name="destination_type", version="0.48")
    ...
    @deprecation.argument_renamed(old_name="cstrtype", new_name="constraint_type", version="0.48")
    ...
    @deprecation.argument_renamed(old_name="iface", new_name="interface", version="0.48")
...
@deprecation.attribute_renamed(old_name="rdefs", new_name="relation_definitions", version="0.48")
@deprecation.attribute_renamed(
    old_name="rdef_class", new_name="relation_definition_class", version="0.48"
)
@deprecation.attribute_renamed(
    old_name="_subj_schemas", new_name="_subject_schemas", version="0.48"
)
@deprecation.attribute_renamed(old_name="_obj_schemas", new_name="_object_schemas", version="0.48")
class RelationSchema(ERSchema):
    ...
    def __init__(
        self,
        schema: "Schema",
        relation_definition: Optional[yams_types.RelationType] = None,
        **kwargs,
    ) -> None:
    ...
    @deprecation.argument_renamed(old_name="subjschema", new_name="subject_schema", version="0.48")
    @deprecation.argument_renamed(old_name="objschema", new_name="object_schema", version="0.48")
    @deprecation.argument_renamed(old_name="rdef", new_name="relation_definition", version="0.48")
    def update(
        self,
    ...
    _add_rdef = deprecation.callable_renamed(
        old_name="_add_rdef", new_function=_add_relation_definition, version="0.48"
    )

    @deprecation.argument_renamed(
        old_name="subjectschema", new_name="subject_schema", version="0.48"
    )
    @deprecation.argument_renamed(old_name="objectschema", new_name="object_schema", version="0.48")
    ...
    @deprecation.argument_renamed(
        old_name="buildrdef", new_name="build_relation_definition", version="0.48"
    )
    ...
    @deprecation.argument_renamed(old_name="etype", new_name="entity_schema", version="0.48")
    def subjects(
    ...
    @deprecation.argument_renamed(old_name="ttype", new_name="target_type", version="0.48")
    ...
    role_rdef = deprecation.callable_renamed(
        old_name="role_rdef", new_function=role_relation_definition, version="0.48"
    )
...
class Schema:
    ...
    @deprecation.argument_renamed(old_name="edef", new_name="entity_definition", version="0.48")
    ...
    @deprecation.argument_renamed(old_name="oldname", new_name="old_name", version="0.48")
    @deprecation.argument_renamed(old_name="newname", new_name="new_name", version="0.48")
    ...
    @deprecation.argument_renamed(
        old_name="rtypedef", new_name="relation_type_definition", version="0.48"
    )
    ...
    @deprecation.argument_renamed(old_name="rtype", new_name="relation_type", version="0.48")
    @deprecation.argument_renamed(old_name="subjtype", new_name="subject_type", version="0.48")
    @deprecation.argument_renamed(old_name="objtype", new_name="object_type", version="0.48")
    def del_relation_def(
        self,
    ...
    eschema = deprecation.callable_renamed("eschema", entity_schema_for, version="0.48")
    ...
    rschema = deprecation.callable_renamed("rschema", relation_schema_for, version="0.48")
