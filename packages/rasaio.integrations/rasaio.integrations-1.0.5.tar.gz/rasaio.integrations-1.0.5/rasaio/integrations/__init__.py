...
class IntegrationBase(abc.ABC):
  ...
  def __get_persons_to_create_or_update(self):
    ...
    for mapped_person in mapped_persons:
      ...
      if rasa_person and not rasa_person[IS_SUBSCRIBED] and rasa_person[UNSUBSCRIBE_REASON] == ONE_CLICK_UNSUBSCRIBE and self.rasa_api_attrs.sync_direction == SyncDirection.TO_RASA:
