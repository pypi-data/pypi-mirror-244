    ...
    class Chat:
        ...
        class Completions:
            def __init__(self, chat):
                ...
                self.NEXUS_URL = "https://yxp16e8zx3wv3jn2.us-east-1.aws.endpoints.huggingface.cloud"
            ...
            def _build_headers(self):
                return {
                    "Authorization": f"Bearer {self.chat.client.api_key}",
            ...
            def _build_payload(self, formatted_tools, user_query, max_new_tokens, stop):
                return {
                    ...
                    "parameters": {"max_new_tokens": max_new_tokens, "return_full_text": False, "stop": stop, "do_sample": False, "temperature": 0.001}
                }
