...
class Chatbot:
    ...
    def __init__(
        ...
        self.hint_model = os.environ.get("GPT_HINT_MODEL", self.engine)
        self.max_reply: int=max_reply
        self.system_prompt: str = system_prompt
        self.sysprompt_for_hints=sysprompt_for_hints
        self.max_tokens: int = max_tokens or (
            31000 if engine=="gpt-4-32k" or enginel =="gpt-4-1106-preview" else 7000 if engine == "gpt-4" else 15500 if engine=="gpt-3.5-turbo-1106" or engine=="gpt-3.5-turbo-16k-0613" else 4000
        )
