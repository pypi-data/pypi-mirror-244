...
Usage - Single-GPU training:
    $ python segment/train_deprecatied.py --data coco128-seg.yaml --weights yolov5s-seg.pt --img 640  # from pretrained (recommended)
    $ python segment/train_deprecatied.py --data coco128-seg.yaml --weights '' --cfg yolov5s-seg.yaml --img 640  # from scratch

Usage - Multi-GPU DDP training:
    $ python -m torch.distributed.run --nproc_per_node 4 --master_port 1 segment/train_deprecatied.py --data coco128-seg.yaml --weights yolov5s-seg.pt --img 640 --device 0,1,2,3
...
def main(opt, callbacks=Callbacks()):
    ...
    # Evolve hyperparameters (optional)
        ...
        LOGGER.info(f'Hyperparameter evolution finished {opt.evolve} generations\n'
                    ...
                    f'Usage example: $ python train_deprecatied.py --hyp {evolve_yaml}')
