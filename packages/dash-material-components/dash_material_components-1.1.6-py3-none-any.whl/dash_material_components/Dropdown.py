...
- width (string | number; default '100%'):
    ...
    _type = 'Dropdown'
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, labelText=Component.UNDEFINED, helperText=Component.UNDEFINED, width=Component.UNDEFINED, margin=Component.UNDEFINED, options=Component.REQUIRED, multiple=Component.UNDEFINED, selected=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'helperText', 'labelText', 'margin', 'multiple', 'options', 'selected', 'width']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'helperText', 'labelText', 'margin', 'multiple', 'options', 'selected', 'width']
