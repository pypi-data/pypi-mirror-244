...
TIME_PATTERNS   = (
    # 5:06:07 PM PDT
    HOUR + TIMESEP + MINUTE + Optional(TIMESEP + SECOND) + OPTSPACE + Optional(AMPM) + OPTSPACE + Optional(TIMEZONE) + LOOKAHEADSEP,
    # 'T010203.456Z'
...
class CommonParser:
  ...
  def __init__(self, era=None, now=None, timezone=None):
    ...
    self.now        = now or base.utils.Now()
