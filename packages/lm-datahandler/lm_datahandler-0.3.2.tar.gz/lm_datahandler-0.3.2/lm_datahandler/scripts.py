...
if __name__ == '__main__':
    ...
    download_param = {
        ...
        # 下载保存路径
        'save_path': os.path.join('E:/dataset/x7_tail', day),
        # 分析结果保存路径（为None表示保存在数据下载路径中）
        'analysis_save_path': os.path.join('E:/dataset/x7_tail', day),
    }
    analyse_param = {
        # 设备类型：X7/X8
        'device_type': "X8",
    ...
    local_datas_full_analyse(r'E:\dataset\x7_tail\20231130',
                             ['6140'],
                             r'E:\dataset\x7_tail\20231130', analyse_param=analyse_param)
