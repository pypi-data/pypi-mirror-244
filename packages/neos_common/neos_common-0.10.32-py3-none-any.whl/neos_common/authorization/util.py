...
def create_openapi_info(action: base.Action, resource: str) -> typing.Dict[str, str]:
    ...
    def build(
        ...
        class DepAuthorization(SecurityBase):
            ...
            async def __call__(
                ...
                actions_: typing.List[typing.Union[base.Action, str]] = []
...
class DepAccessValidatorFactory:
    ...
    def build(
        cls,
        iam_client_dep: typing.Union[typing.Type[IAMClientDependency], typing.Type[HubClientDependency]],
        ...
        class DepAccessValidator(AccessValidatorDependency):
            async def __call__(
                self,
                iam_client: typing.Union[IAMClient, HubClient] = fastapi.Depends(iam_client_dep()),
...
class DepHubClientFactory:
    ...
    def build(
        cls,
        config_dep: typing.Type[ConfigDependency],
    ) -> typing.Type[HubClientDependency]:
