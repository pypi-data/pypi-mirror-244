...
class NomosTask:
    ...
    def llm(self, client: "Nomos"):
        if isinstance(self.task.parameters.actual_instance, OpenAIChatCompletionParams):
            ...
            return AzureOpenai(
                client=client.azure_openai_client,
                nomos_logger=NomosLogger(
                    nomos_api=client.nomos_api,
                ),
...
class TaskFunctionResponse(NomosTask):
    def __init__(
        ...
        super().__init__(project_id, project_version_id, task)
