...
def ALLIGATOR_timing(df, closename, highname, lowname, N1, N2, N3, N4, N5, N6, *args, **kwargs):
    ...
    df2['signalF'] = 0
    df2.loc[(df2[closename] > df2['alligator_jaw'])
            & (df2[closename] > df2['alligator_teeth'])
            & (df2[closename] > df2['alligator_lips']), 'signalF'] = 1
...
def ALLIGATOR1_timing(df, closename, highname, lowname, N1, N2, N3, N4, N5, N6, N7, N8, MA_df, *args, **kwargs):
    ...
    df_final['signalF'] = 0
    df_final.loc[(df_final[closename] > df_final['alligator_jaw'])
                 & (df_final[closename] > df_final['alligator_teeth'])
                 & (df_final[closename] > df_final['alligator_lips']) & (df_final['bull'] == 1), 'signalF'] = N7

    df_final.loc[(df_final[closename] > df_final['alligator_jaw'])
                 & (df_final[closename] > df_final['alligator_teeth'])
                 & (df_final[closename] > df_final['alligator_lips']) & (df_final['bull'] == 0), 'signalF'] = N8
...
def ALLIGATOR3_timing(df, closename, highname, lowname, N1, N2, N3, N4, N5, N6, N7, *args, **kwargs):
    ...
    df2['signalF'] = 0
    df2.loc[df2[closename] > df2['alligator_jaw'], 'signalF'] = 1
    df2.loc[df2['diff'] < df2['diffMA'], 'signalF'] = 0
...
def ALLIGATOR4_timing(df, closename, highname, lowname, N1, N2, N3, N4, N5, N6, N7, N8, N9, MA_df, *args, **kwargs):
    ...
    df_final.loc[(df_final[closename] > df_final['alligator_jaw'])
                 & (df_final[closename] > df_final['alligator_teeth'])
                 & (df_final[closename] > df_final['alligator_lips']) & (df_final['bull'] == 1), 'signalF'] = N8
    df_final.loc[(df_final[closename] > df_final['alligator_jaw'])
                 & (df_final[closename] > df_final['alligator_teeth'])
                 & (df_final[closename] > df_final['alligator_lips']) & (df_final['bull'] == 0), 'signalF'] = N9
