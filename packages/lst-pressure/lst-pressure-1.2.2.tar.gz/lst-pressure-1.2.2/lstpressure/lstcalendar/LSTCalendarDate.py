...
from ..sun import Sun
from perf import decorate_all, track_total_runtime
...
class LSTCalendarDate:
    ...
    def __init__(self, dt, cal) -> None:
        ...
        self.sun = Sun(dt, cal.latitude, cal.longitude, provider=conf.LOC_PROVIDER)
        self.tomorrow_sun = Sun(
            dt + timedelta(days=1), cal.latitude, cal.longitude, provider=conf.LOC_PROVIDER
        )
