...
class Observables(AppInterface):
    ...
    def build(self) -> Self:
        ...
        self.parser.add_argument(
            ...
            default="MEERKAT",
            help="Specify the location provider for calculating sun statistics and for calculating intervals. Defaults to use the Astral library, intervals using the dawn, sunrise, sunset, dusk events. Choose between: ASTRAL (default) or MEERKAT",
            metavar="",
        )
