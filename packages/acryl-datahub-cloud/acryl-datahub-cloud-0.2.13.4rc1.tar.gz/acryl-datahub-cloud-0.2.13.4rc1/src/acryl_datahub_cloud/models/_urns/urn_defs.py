...
class RecommendationModuleUrn(_SpecificUrn):
    ...
    def __init__(self, module_id: str, identifier: str, *, _allow_coercion: bool = True) -> None:
        ...
        # Validation logic.
        if not module_id:
            raise InvalidUrnError("module_id cannot be empty")
        assert not UrnEncoder.contains_reserved_char(module_id)
        if not identifier:
            raise InvalidUrnError("identifier cannot be empty")
        assert not UrnEncoder.contains_reserved_char(identifier)
...
class MonitorUrn(_SpecificUrn):
    ...
    def __init__(self, entity: str, id: str, *, _allow_coercion: bool = True) -> None:
        ...
        # Validation logic.
        if not entity:
            raise InvalidUrnError("entity cannot be empty")
        entity = str(entity)
