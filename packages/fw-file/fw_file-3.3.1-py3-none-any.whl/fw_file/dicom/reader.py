...
def DataElement_from_raw(
    ...
    # Fixers should assure that convert_value won't raise
...
class ReadContext:
    ...
    def from_callback_kwargs(cls) -> "ReadContext":
        ...
        return pydicom_config.data_element_callback_kwargs.get(READER) or cls()
    ...
    def __enter__(self):
        ...
        """
        callback_kwargs = pydicom_config.data_element_callback_kwargs
    ...
    def add_nonconforming_elem(
        ...
        try:
            self.modified_attrs[tag] = DataElement(tag, dictionary_VR(tag), "")
        except KeyError:
