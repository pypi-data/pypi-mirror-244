...
HEASERVER_REGISTRY_IMAGE = 'registry.gitlab.com/huntsman-cancer-institute/risr/hea/heaserver-registry:1.0.0b5'
HEASERVER_VOLUMES_IMAGE = 'registry.gitlab.com/huntsman-cancer-institute/risr/hea/heaserver-volumes:1.0.0b5'
HEASERVER_BUCKETS_IMAGE = 'registry.gitlab.com/huntsman-cancer-institute/risr/hea/heaserver-buckets:1.0.0b5'
...
if __name__ == '__main__':
    ...
    swaggerui.run(project_slug='heaserver-folders-aws-s3', desktop_objects=db_values,
                  ...
                  routes=[# Folders
                          ...
                          (get, '/volumes/{volume_id}/buckets/{bucket_id}/awss3projects/{id}/newproject',
                           service.projectservice.get_new_project_form),
                          (post, '/volumes/{volume_id}/buckets/{bucket_id}/awss3projects/{id}/newproject',
                           service.projectservice.post_new_project),
