            ...
            if IS_OCR_EXIST == 'false':
                ...
                if not ent_code and not ent_name:
                    ...
                    try:
                        ...
                        elif proc_mtd_value[0] == 'PO' or proc_mtd_value[0] == 'PPF' or proc_mtd_value[0] == 'PPO' :
                            logger.log(f"Loading 'tesseract' module for case 'PO' OR 'PPF' OR 'PPO'  ")
