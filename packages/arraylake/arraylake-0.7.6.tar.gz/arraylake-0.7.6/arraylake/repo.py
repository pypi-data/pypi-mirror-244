...
class ArraylakeStore(StoreV3):  # type: ignore  # no typying info for StoreV3
    ...
    def list_prefix(self, prefix: str) -> list[str]:
        ...
        Returns:
            A list of document paths
        """
        logger.debug("list_prefix", path=prefix, repo=self._repo.repo_name)
    ...
    def listdir(self, prefix: str) -> list[str]:
        ...
        Returns:
            A list of document paths
        """
        logger.debug("listdir", path=prefix, repo=self._repo.repo_name)
        return self._repo._wrap_async_iter(self._repo._arepo._list_dir, prefix)

    def getsize(self, prefix: str) -> int:
        logger.debug("getsize", path=prefix, repo=self._repo.repo_name)
    ...
    def rmdir(self, dir: str) -> None:
        logger.debug("rmdir", path=dir, repo=self._repo.repo_name)
    ...
    def getitems(self, keys, on_error="omit") -> Mapping[str, bytes]:
        ...
        """
        logger.debug("getitems", paths=keys, repo=self._repo.repo_name)
    ...
    def __setitem__(self, key, value: bytes) -> None:
        ...
        Returns:
            bytes (metadata or chunk)
        """
        logger.debug("__setitem__", path=key, repo=self._repo.repo_name)
    ...
    def setitems(self, items: Mapping[str, bytes]) -> None:
        ...
        Returns:
            Mapping where keys are paths and values are bytes (metadata or chunks)
        """
        logger.debug("setitems", paths=list(items), repo=self._repo.repo_name)
    ...
    def __delitem__(self, key):
        ...
        Args:
            key: path to delete
        """
        logger.debug("__delitem__", path=key, repo=self._repo.repo_name)
    ...
    def delitems(self, keys) -> None:
        ...
        """
        logger.debug("delitems", paths=keys, repo=self._repo.repo_name)
    ...
    def erase_prefix(self, prefix):
        ...
        logger.debug("erase_prefix", path=prefix, repo=self._repo.repo_name)
