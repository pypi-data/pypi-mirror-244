...
# inject native trust store certificates
truststore.inject_into_ssl()

# Run in python_pip directory.

package_version = environ.get("PACKAGE_VERSION", "1.0.0.34.16")
...
name = environ.get("PYPI_NAMESPACE", "test-dichen-proj")
...
setup(
    ...
    install_requires=["setuptools>=61.2", "truststore>=0.8.0"],
)
