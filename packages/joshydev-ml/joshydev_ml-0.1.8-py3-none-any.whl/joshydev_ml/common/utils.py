...
from joshydev_ml.common.logger import Logger, configure
from joshydev_ml.common.type_aliases import GymEnv, Schedule, TensorDict, TrainFreq, TrainFrequencyUnit
...
def polyak_update(
    ...
    params (in place).
    See https://github.com/DLR-RM/joshydev_ml/issues/93
