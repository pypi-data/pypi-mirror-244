...
class Space(object):
    ...
    `sample()` method), and batching functions (in `joshydev_ml.gym.vector.VectorEnv`), are
    only well-defined for instances of spaces provided in joshydev_ml.gym by default.
    ...
    def __setstate__(self, state):
        ...
        # See:
        #   https://github.com/openai/joshydev_ml.gym/pull/2397 -- shape
        #   https://github.com/openai/joshydev_ml.gym/pull/1913 -- np_random
        #
        if "shape" in state:
