...
from joshydev_ml.gym.vector.vector_env import VectorEnv
from joshydev_ml.gym.error import (
    AlreadyPendingCallError,
    NoAsyncCallError,
    ClosedEnvironmentError,
    CustomSpaceError,
)
from joshydev_ml.gym.vector.utils import (
...
class AsyncVectorEnv(VectorEnv):
    ...
    observation_space : `joshydev_ml.gym.spaces.Space` instance, optional
        Observation space of a single environment. If `None`, then the
        observation space of the first environment is taken.

    action_space : `joshydev_ml.gym.spaces.Space` instance, optional
        ...
        if self.shared_memory:
            try:
                ...
                raise ValueError(
                    ...
                    "(i.e. custom spaces inheriting from `joshydev_ml.gym.Space`), and is "
