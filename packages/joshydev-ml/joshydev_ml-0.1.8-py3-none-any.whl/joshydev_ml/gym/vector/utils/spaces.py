...
from joshydev_ml.gym.spaces import Space, Box, Discrete, MultiDiscrete, MultiBinary, Tuple, Dict
...
def batch_space(space, n=1):
    ...
    Returns
    -------
    batched_space : `joshydev_ml.gym.spaces.Space` instance
    ...
    if isinstance(space, _BaseGymSpaces):
        ...
        raise ValueError(
            ...
            "be a valid `joshydev_ml.gym.Space` instance.".format(type(space))
        )
