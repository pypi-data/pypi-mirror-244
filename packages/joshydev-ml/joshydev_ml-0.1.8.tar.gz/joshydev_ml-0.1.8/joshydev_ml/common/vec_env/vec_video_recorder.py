...
from joshydev_ml.gym.wrappers.monitoring import video_recorder

from joshydev_ml.common.vec_env.base_vec_env import VecEnv, VecEnvObs, VecEnvStepReturn, VecEnvWrapper
...
class VecVideoRecorder(VecEnvWrapper):
    ...
    def __init__(
        ...
        # that will be used by joshydev_ml.gym recorder
