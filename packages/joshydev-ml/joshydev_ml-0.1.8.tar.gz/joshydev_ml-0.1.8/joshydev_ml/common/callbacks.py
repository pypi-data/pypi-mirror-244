...
from joshydev_ml.common import base_class  # pytype: disable=pyi-error
from joshydev_ml.common.evaluation import evaluate_policy
from joshydev_ml.common.vec_env import DummyVecEnv, VecEnv, sync_envs_normalization
...
class BaseCallback(ABC):
    ...
    def __init__(self, verbose: int = 0):
        ...
        self.training_env = None  # type: Union[joshydev_ml.gym.Env, VecEnv, None]
...
class EvalCallback(EventCallback):
    ...
    def __init__(
        self,
        eval_env: Union[joshydev_ml.gym.Env, VecEnv],
            ...
            if self.model.get_vec_normalize_env() is not None:
                try:
                    ...
                    raise AssertionError(
                        ...
                        "see https://joshydev_ml.readthedocs.io/en/master/guide/callbacks.html#evalcallback "
                        "and warning above."
                    ) from e
