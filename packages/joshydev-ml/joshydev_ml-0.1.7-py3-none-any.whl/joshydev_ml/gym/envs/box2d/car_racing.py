...
python joshydev_ml.gym/envs/box2d/car_racing.py
...
from joshydev_ml.gym.envs.box2d.car_dynamics import Car
from joshydev_ml.gym.utils import seeding, EzPickle
...
class CarRacing(joshydev_ml.gym.Env, EzPickle):
    metadata = {
