...
from joshydev_ml.common.preprocessing import check_for_nested_spaces
from joshydev_ml.common.vec_env.base_vec_env import VecEnvObs
...
def obs_space_info(obs_space: spaces.Space) -> Tuple[List[str], Dict[Any, Tuple[int, ...]], Dict[Any, np.dtype]]:
    """
    Get dict-structured information about a joshydev_ml.gym.Space.
