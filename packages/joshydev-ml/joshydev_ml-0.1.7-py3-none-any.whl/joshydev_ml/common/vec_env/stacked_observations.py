...
from joshydev_ml.common.preprocessing import is_image_space, is_image_space_channels_first
...
class StackedDictObservations(StackedObservations):
    ...
    def __init__(
        ...
        for key, subspace in observation_space.spaces.items():
            assert isinstance(subspace, spaces.Box), "StackedDictObservations only works with nested joshydev_ml.gym.spaces.Box"
