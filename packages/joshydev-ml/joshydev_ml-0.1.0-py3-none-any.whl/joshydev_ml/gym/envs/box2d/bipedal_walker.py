...
from joshydev_ml.gym.utils import colorize, seeding, EzPickle
...
#
# python joshydev_ml.gym/envs/box2d/bipedal_walker.py
#
...
class BipedalWalker(joshydev_ml.gym.Env, EzPickle):
