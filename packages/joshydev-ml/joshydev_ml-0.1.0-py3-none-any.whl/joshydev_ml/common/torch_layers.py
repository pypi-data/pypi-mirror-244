...
from joshydev_ml.common.preprocessing import get_flattened_obs_dim, is_image_space
from joshydev_ml.common.type_aliases import TensorDict
...
class BaseFeaturesExtractor(nn.Module):
    ...
    def __init__(self, observation_space: joshydev_ml.gym.Space, features_dim: int = 0) -> None:
        super().__init__()
...
class FlattenExtractor(BaseFeaturesExtractor):
    ...
    def __init__(self, observation_space: joshydev_ml.gym.Space) -> None:
...
class NatureCNN(BaseFeaturesExtractor):
    ...
    def __init__(
        ...
        assert is_image_space(observation_space, check_channels=False, normalized_image=normalized_image), (
            ...
            "https://joshydev_ml.readthedocs.io/en/master/common/env_checker.html.\n"
            "If you are using `VecNormalize` or already normalized channel-first images "
            "you should pass `normalize_images=False`: \n"
            "https://joshydev_ml.readthedocs.io/en/master/guide/custom_env.html"
        )
