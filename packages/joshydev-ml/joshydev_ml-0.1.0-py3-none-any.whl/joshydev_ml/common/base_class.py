...
from joshydev_ml.common import utils
from joshydev_ml.common.callbacks import BaseCallback, CallbackList, ConvertCallback, ProgressBarCallback
from joshydev_ml.common.env_util import is_wrapped
from joshydev_ml.common.logger import Logger
from joshydev_ml.common.monitor import Monitor
from joshydev_ml.common.noise import ActionNoise
from joshydev_ml.common.policies import BasePolicy
from joshydev_ml.common.preprocessing import check_for_nested_spaces, is_image_space, is_image_space_channels_first
from joshydev_ml.common.save_util import load_from_zip_file, recursive_getattr, recursive_setattr, save_to_zip_file
from joshydev_ml.common.type_aliases import GymEnv, MaybeCallback, Schedule
from joshydev_ml.common.utils import (
...
from joshydev_ml.common.vec_env import (
    DummyVecEnv,
    VecEnv,
    VecNormalize,
    VecTransposeImage,
...
class BaseAlgorithm(ABC):
    ...
    def set_env(self, env: GymEnv, force_reset: bool = True) -> None:
        ...
        :param force_reset: Force call to ``reset()`` before training
            ...
            See issue https://github.com/DLR-RM/joshydev_ml/issues/597
        """
        ...
        # otherwise the wrong env may be used, see https://github.com/DLR-RM/joshydev_ml/issues/637
        self._vec_normalize_env = unwrap_vec_normalize(env)
    ...
    def set_random_seed(self, seed: Optional[int] = None) -> None:
        ...
        (python, numpy, pytorch, joshydev_ml.gym, action_space)
    ...
    def load(
        ...
        **kwargs,
        ...
        :param force_reset: Force call to ``reset()`` before training
            to avoid unexpected behavior.
            See https://github.com/DLR-RM/joshydev_ml/issues/597
        ...
        if env is not None:
            ...
            if force_reset and data is not None:
                data["_last_obs"] = None
            # `n_envs` must be updated. See issue https://github.com/DLR-RM/joshydev_ml/issues/1018
            if data is not None:
        ...
        try:
            ...
            # See https://github.com/DLR-RM/joshydev_ml/issues/1233
            if "pi_features_extractor" in str(e) and "Missing key(s) in state_dict" in str(e):
                ...
                warnings.warn(
                    ...
                    "(see https://github.com/DLR-RM/joshydev_ml/issues/1233 for more info). "
                    f"Original error: {e} \n"
        ...
        if pytorch_variables is not None:
            for name in pytorch_variables:
                ...
                # See https://github.com/DLR-RM/joshydev_ml/issues/391
