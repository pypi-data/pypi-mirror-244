...
from joshydev_ml.common.vec_env.base_vec_env import VecEnv, VecEnvWrapper
...
class VecFrameStack(VecEnvWrapper):
    ...
    def __init__(self, venv: VecEnv, n_stack: int, channels_order: Optional[Union[str, Dict[str, str]]] = None):
        ...
        if isinstance(wrapped_obs_space, spaces.Box):
            ...
            raise Exception("VecFrameStack only works with joshydev_ml.gym.spaces.Box and joshydev_ml.gym.spaces.Dict observation spaces")
