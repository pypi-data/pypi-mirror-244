...
from joshydev_ml.gym.vector.utils.spaces import batch_space

__all__ = ["VectorEnv"]


class VectorEnv(joshydev_ml.gym.Env):
    ...
    observation_space : `joshydev_ml.gym.spaces.Space` instance
        Observation space of a single environment.

    action_space : `joshydev_ml.gym.spaces.Space` instance
