...
def play(env, transpose=True, fps=30, zoom=None, callback=None, keys_to_action=None):
    ...
    To simply play the game use:
        ...
        play(joshydev_ml.gym.make("Pong-v4"))
    ...
    joshydev_ml.gym.utils.play.PlayPlot. Here's a sample code for plotting the reward
    for last 5 second of gameplay.
        ...
        env = joshydev_ml.gym.make("Pong-v4")
...
def main():
    ...
    env = joshydev_ml.gym.make(args.env)
