...
from joshydev_ml.gym.spaces import Box
from joshydev_ml.gym.spaces import Discrete
from joshydev_ml.gym.spaces import MultiDiscrete
from joshydev_ml.gym.spaces import MultiBinary
from joshydev_ml.gym.spaces import Tuple
from joshydev_ml.gym.spaces import Dict
...
def flatdim(space):
    ...
    the space is not defined in ``joshydev_ml.gym.spaces``.
    """
...
def unflatten(space, x):
    ...
    defined in ``joshydev_ml.gym.spaces``.
    """
    raise NotImplementedError(f"Unknown space: `{space}`")
