...
class OWVlsPgmCoefficientsCalculator(OWWidget):
    ...
    outputs = [{"name":"VLS-PGM PreProcessor Data",
                "type":VlsPgmPreProcessorData,
                "doc":"VLS-PGM PreProcessor Data",
                "id":"VLS-PGM PreProcessor Data"}]
    ...
    def compute(self):
        try:
            ...
            self.send("VLS-PGM PreProcessor Data", VlsPgmPreProcessorData(shadow_coeff_0 = self.shadow_coeff_0,
