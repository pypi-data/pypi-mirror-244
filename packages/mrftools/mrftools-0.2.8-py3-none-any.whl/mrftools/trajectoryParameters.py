...
class TrajectoryParameters:
    def __init__(self, trajectoryType:TrajectoryType, fov, matrixSize, gradientWaveform:GradientWaveform, kspaceTrajectory=None, densityCompensation=None, name="", version="dev"):
    ...
    def FromJson(inputJson):
        ...
        if(name != None and trajectoryJson != None):
            return TrajectoryParameters(trajectoryType, fov, matrixSize, gradientWaveform, kspaceTrajectory, densityCompensation, name, version)
        else:
    ...
    def FromCPPHeader(trajectoryType:TrajectoryType, headerFile):
        ...
        return TrajectoryParameters(trajectoryType, varDict["FOV"], varDict["MATRIX_SIZE"], gradientWaveform)
