...
class HTTPClient(object):
    ...
    def _request(
        ...
        )  # use gzip, urllib3 will decompress automatically
        ...
        try:
            ...
            raise LeapcellException(
                "http error, http code {}, error: {}".format(e.status, e)
            )
        except urllib3.exceptions.TimeoutError as e:
            raise LeapcellException(
                "timeout error, error: {}".format(e)
            )
        except urllib3.exceptions.ConnectionError as e:
            raise LeapcellException(
                "connection error, error: {}".format(e)
            )
        except Exception as e:
            raise LeapcellException(
                "unknown error, error: {}".format(e)
            )
