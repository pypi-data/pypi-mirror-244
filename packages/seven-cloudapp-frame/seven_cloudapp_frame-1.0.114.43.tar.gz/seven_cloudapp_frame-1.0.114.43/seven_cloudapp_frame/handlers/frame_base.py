...
@LastEditTime: 2023-10-27 11:24:30
    ...
    def prepare(self):
        ...
        try:
            ...
            if is_api_encrypt == True:
                ...
                encrypt_limit_time = int(share_config.get_value("encrypt_limit_time", 10))
                if self.request_params.__contains__("timestamp") and (now_time - int(self.request_params["timestamp"]) > int(1000 * encrypt_limit_time)):
