...
@LastEditTime: 2023-07-26 14:10:14
...
class UserBaseModel(FrameBaseModel):
    ...
    def __init__(self, context=None, logging_error=None, logging_info=None):
        ...
        self.db_connect_key = "db_user" if config.get_value("db_user") else "db_cloudapp"
        self.redis_config_dict = config.get_value("redis_user") if config.get_value("redis_user") else None
