...
class Command(BaseCommand):
    help = "Sync local devices with the Fortinet IAM API"
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            action="store_true",
            default="Fortinet",
            help="Manufacturer name (default: Fortinet)",
        )
    ...
    def logon(self):
        ...
        CISCO_CLIENT_ID = PLUGIN_SETTINGS.get("FORTINET_SUPPORT_API_CLIENT_ID", "")
        CISCO_CLIENT_SECRET = PLUGIN_SETTINGS.get("FORTINET_SUPPORT_API_CLIENT_SECRET", "")
        # Set the requests timeout for connect and read separatly
        self.REQUESTS_TIMEOUT = (3.05, 27)

        """
        token_url = "https://api.fortinet.com/api/v1/oauth2/token"
    ...
    def handle(self, *args, **kwargs):
        SYNC_FAILED = False
        PLUGIN_SETTINGS = settings.PLUGINS_CONFIG.get("netbox_device_support_plugin", dict())
        MANUFACTURER = PLUGIN_SETTINGS.get("FORTINET_MANUFACTURER", "Cisco")
