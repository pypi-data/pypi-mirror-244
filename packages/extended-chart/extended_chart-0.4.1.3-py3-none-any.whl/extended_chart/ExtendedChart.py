...
class ExtendedChart(Chart):
    ...
    def add_horizontal_line(self, data: DataFrame = None, price: float | int = None, color='rgba(252, 219, 3, 0.8)',
                            width=1, style='solid', label=''):
        return add_horizontal_line(self, data=data, price=price, color=color, width=width, style=style, label=label)
