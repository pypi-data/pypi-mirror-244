...
class Object:
    ...
    def calculate_cycle(self):
        ...
        self.EER = self.EVAP.Qevap / self.COMP.Qcomp
        self.QcondTot = self.COND.Qcond + self.DESURCH.Qdesurch
        self.COP = self.QcondTot / self.COMP.Qcomp

        self.df = pd.DataFrame({
            
            'Chiller': [self.EER,self.QcondTot,self.COP]
        }, index=[ 'EER', 'QcondTot', 'COP'])
