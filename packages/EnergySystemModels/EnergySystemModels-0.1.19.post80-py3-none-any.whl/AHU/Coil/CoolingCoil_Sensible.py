...
class Object:
    ...
    def calculate(self):
        ...
        self.ho=air_humide.Enthalpie(self.To_target,self.wi)
          #  print("ho=",self.ho)
        ...
        self.RH_out=air_humide.HR(air_humide.func_Pv_sat(self.To_target),self.wi,self.Outlet.P) #parametrer la pression
