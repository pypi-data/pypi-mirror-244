...
class Object:
    ...
    def calculate (self):
        ...
        if self.Qcomp is not None:
            self.F=self.Qcomp/(self.Ho_ref-self.Inlet.h)
        else: # self.Inlet.F is not None:
            self.F=self.Inlet.F
            self.Qcomp=self.F*(self.Ho_ref-self.Inlet.h)
        
        

        self.Qlosses=self.F*(self.Ho_ref-self.Ho)
