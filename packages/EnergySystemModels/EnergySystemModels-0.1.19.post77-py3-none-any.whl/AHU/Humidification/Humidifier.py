        ...
        if self.w_out_target>self.w_in:
            ...
            if self.HumidType=="adiabatique" :
                ...
                def syst(var): # définition du système
                    ...
                    eq3 =self.hi-air_humide.Enthalpie(self.T_out, self.w_out_target)
                    res = [eq1, eq2, eq3]
                    return res
                #self.ho=self.hi
            ...
            if self.HumidType=="vapeur" :
              #  print("hvap=",self.h_vap)
                def syst(var): # définition du système
                    ...
                    eq1 =self.Pv_sat_out-air_humide.func_Pv_sat(self.T_out)
                    eq2 =self.w_out_target-air_humide.HA(self.Pv_sat_out,self.RH_out,101325)
                    eq3 =self.ho-air_humide.Enthalpie(self.T_out, self.w_out_target)
                    eq4 =self.ho-self.hi-(self.w_out_target-self.w_in)/1000*self.h_vap
                    res = [eq1, eq2, eq3, eq4]
                    return res
                #self.ho=self.hi
