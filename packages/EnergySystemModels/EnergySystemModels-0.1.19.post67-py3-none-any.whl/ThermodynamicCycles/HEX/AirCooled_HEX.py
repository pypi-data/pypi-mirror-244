...
from ThermodynamicCycles.HEX import AirCooled_HEX
...
Fluide=Source.Object()
Fluide.Pi_bar=16
Fluide.fluid='water'
Fluide.Ti_degC=165
Fluide.F=180*2302/4347
Fluide.calculate()

HEX=AirCooled_HEX.Object()
HEX.nb_rangs=5
HEX.L_tube=10
HEX.d_vent=3.962
HEX.U=540
...
Fluid_connect(HEX.Air_Inlet,Air.Outlet)
Fluid_connect(HEX.Fluid_Inlet,Fluide.Outlet)
HEX.calculate()

print("-------------------------------",HEX.df)

#print(HEX.Fluid_Inlet.df)
#print(HEX.Air_Inlet.df)
#print(HEX.Air_Outlet.df)
# print(HEX.R)
# print(HEX.Eff)
# print(HEX.UA)