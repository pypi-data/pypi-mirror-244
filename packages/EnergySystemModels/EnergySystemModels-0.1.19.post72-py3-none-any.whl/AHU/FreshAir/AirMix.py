...
class Object:
    ...
    def calculate(self):
        ...
        # self.F = self.F_m3h * air_humide.func_rho_hum(self.T, self.RH, self.P)/3600 #kg/s
        # self.F = self.F/3600 #m3/s
        #Connecteur Inlet
                        
        self.Pv_sat=air_humide.func_Pv_sat(self.T)
       # print("Pvsat=",self.Pv_sat)
        self.w=air_humide.HA(self.Pv_sat,self.RH,self.P)
       # print("HA=",self.w)
      ...
      #  print("self.h=",self.h)
        ...
        self.F_dry1=self.Inlet1.F/(1+self.Inlet1.HA)
        self.F_dry2=self.Inlet2.F/(1+self.Inlet2.HA)

        #connecteur   
      
        #self.Inlet1.HA=self.w
        #self.Inlet.P=
        self.Outlet.w=(self.Inlet1.HA*self.F_dry1+self.Inlet2.HA*self.F_dry2)/(self.F_dry1+self.F_dry2)
