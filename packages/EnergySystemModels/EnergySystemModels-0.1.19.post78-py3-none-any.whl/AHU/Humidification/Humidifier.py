...
class Object:
    ...
    def calculate(self):
        ...
        if self.w_out_target>self.wi:
            # print("self.w_out_target>self.wi",self.w_out_target,self.wi)
            ...
            if self.HumidType=="adiabatique" :
               ...
               # print(x)
                ...
                self.F_water=self.F_dry*(self.w_out_target-self.wi)/1000 #débit d'eau en kgH2O/s
            ...
            if self.HumidType=="vapeur" :
              #  print("hvap=",self.h_vap)
                def syst(var): # définition du système
                    ...
                    eq4 =self.ho-self.hi-(self.w_out_target-self.wi)/1000*self.h_vap
                    res = [eq1, eq2, eq3, eq4]
                    return res
                #self.ho=self.hi
               ...
               # print(x)
                ...
                self.F_water=self.F_dry*(self.w_out_target-self.wi)/1000 #débit d'eau en kgH2O/s = [kg_air_sec/s] * kg_H20 /kg_air_sec
           ...
           # self.F_water=self.F_dry*(self.w_out_target-self.wi)/1000
