    ...
    """
{
    ...
    "package_data": {
        "aws_solutions_constructs.aws_kinesis_streams_kinesis_firehose_s3._jsii": [
            "aws-kinesisstreams-kinesisfirehose-s3@2.47.0.jsii.tgz"
        ],
        "aws_solutions_constructs.aws_kinesis_streams_kinesis_firehose_s3": [
            "py.typed"
        ]
    ...
    "python_requires": "~=3.8",
    "install_requires": [
        "aws-cdk-lib>=2.111.0, <3.0.0",
        "aws-solutions-constructs.aws-kinesis-firehose-s3==2.47.0",
        "aws-solutions-constructs.aws-kinesis-streams-lambda==2.47.0",
