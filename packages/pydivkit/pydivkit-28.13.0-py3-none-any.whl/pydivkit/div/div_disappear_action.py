...
class DivDisappearAction(BaseDiv):
    ...
    is_enabled: typing.Optional[typing.Union[Expr, bool]] = Field(
        description=(
            "This parameter allows you to disable the action for any "
            "reason. When an action isdisabled, it stops responding to "
            "the event associated with it (click, change invisibility, "
            "etc.)."
        ),
    )
